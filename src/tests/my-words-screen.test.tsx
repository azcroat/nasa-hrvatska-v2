...
describe('MyWordsScreen — empty state', () => {
  ...
  it('shows "+ Add your first word" button', () => {
    renderScreen();
    expect(screen.getAllByRole('button').find(b => b.textContent?.includes('Add your first word'))).toBeTruthy();
  });

  it('"Add your first word" navigates to add form', () => {
    renderScreen();
    const btn = screen.getAllByRole('button').find(b => b.textContent?.includes('Add your first word'))!;
    fireEvent.click(btn);
  ...
  it('does not show "Drill My Words" when empty', () => {
    renderScreen();
    expect(screen.queryAllByRole('button').find(b => b.textContent?.includes('Drill My Words'))).toBeFalsy();
  });
});
...
describe('MyWordsScreen — add word form', () => {
  ...
  it('shows "Add a New Word" title', () => {
    renderScreen();
    fireEvent.click(screen.getAllByRole('button').find(b => b.textContent?.includes('Add your first word'))!);
    expect(screen.getByText('Add a New Word')).toBeTruthy();
  });
  ...
  it('shows "Save Word" button', () => {
    renderScreen();
    fireEvent.click(screen.getAllByRole('button').find(b => b.textContent?.includes('Add your first word'))!);
    expect(screen.getAllByRole('button').find(b => b.textContent?.includes('Save Word'))).toBeTruthy();
  });
...
describe('MyWordsScreen — form validation', () => {
  ...
  it('empty Croatian word → error "Croatian word is required."', () => {
    renderScreen();
    fireEvent.click(screen.getAllByRole('button').find(b => b.textContent?.includes('Add your first word'))!);
    fireEvent.click(screen.getAllByRole('button').find(b => b.textContent?.includes('Save Word'))!);
...
describe('MyWordsScreen — list with words', () => {
  ...
  it('shows "Drill My Words" button', () => {
    seedWords([WORD_A]);
    renderScreen();
    expect(screen.getAllByRole('button').find(b => b.textContent?.includes('Drill My Words'))).toBeTruthy();
  });

  it('shows "+ Add Word" button', () => {
    seedWords([WORD_A]);
    renderScreen();
    expect(screen.getAllByRole('button').find(b => b.textContent?.includes('Add Word'))).toBeTruthy();
  });

  it('"+ Add Word" navigates to add form', () => {
    seedWords([WORD_A]);
    renderScreen();
    fireEvent.click(screen.getAllByRole('button').find(b => b.textContent?.includes('Add Word'))!);
    expect(screen.getByText('Add a New Word')).toBeTruthy();
  });
});
