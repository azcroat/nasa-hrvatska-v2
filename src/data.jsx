...
const MEDIA = [
  ...
  {name:"HRT 2 — Kultura & Sport",desc:"Arts, documentaries, sports coverage",web:"https://hrti.hrt.hr",icon:"📺",color:"#0284c7",cat:"tv",level:"B2",live:true,tip:"HRT 2 airs cultural programs and in-depth debates. Great for hearing formal, careful Croatian."},
  {name:"HRT 3 — Documentaries",desc:"Education, nature & travel docs",web:"https://hrti.hrt.hr",icon:"🎓",color:"#0369a1",cat:"tv",level:"B1",live:true,tip:"Documentary narration is slow, clear and well-pronounced. Perfect for intermediate learners."},
  ...
  // ─── MUSIC & RADIO ───────────────────────────────────────────────────────────
  {name:"HRT Radio 1",desc:"Croatian public radio — news, talk, music",web:"https://radio.hrt.hr",icon:"📻",color:"#0e7490",cat:"music",level:"B1",live:true,tip:"Leave HRT Radio 1 playing in the background while you cook or drive. Passive listening is powerful — your brain absorbs rhythm and pronunciation."},
  {name:"HRT Radio 2 — Classic",desc:"Classical music & cultural programs",web:"https://radio.hrt.hr",icon:"🎵",color:"#6d28d9",cat:"music",level:"B2",live:true,tip:"Cultural programs feature thoughtful, slow speech from educated speakers. Great for training your ear on formal Croatian."},
  ...
  {name:"CMC Radio Live",desc:"24/7 Croatian hits • all genres",web:"https://radio.cmc.com.hr",icon:"🎧",color:"#9333ea",cat:"music",level:"A1",live:true,tip:"Pop songs repeat the same phrases dozens of times — this is vocabulary acquisition without effort. Pick one song and look up the lyrics."},
