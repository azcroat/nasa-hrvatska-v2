...
// ═══════════════════════════════════════
const V = {
  "greetings":[["Bog","Hello/Hi"],["Dobar dan","Good day"],["Dobro jutro","Good morning"],["Dobra večer","Good evening"],["Laku noć","Good night"],["Doviđenja","Goodbye"],["Hvala","Thank you"],["Molim","Please/Welcome"],["Da","Yes"],["Ne","No"],["Oprosti","Sorry"],["Kako si?","How are you?"],["Kako ste?","How are you? (formal)"],["Dobro sam","I am fine"],["Tako-tako","So-so"],["Drago mi je","Nice to meet you"],["Nema na čemu","You're welcome"],["Vidimo se","See you"],["Zovem se...","My name is..."],["Živjeli!","Cheers!"],["Sretan rođendan","Happy birthday"],["Čestitam","Congratulations"],["Naravno","Of course"],["Izvoli","Here you go"],["Idemo","Let's go"]],
