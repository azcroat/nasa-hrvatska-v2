...
const READ = {
  ...
  c1: [
    {title:"Kratka Priča — Jutro na Hvaru",tEn:"Short Story — Morning on Hvar",text:"Probudio se prije svitanja. More je ležalo nepomično ispod njega, tamno kao tuš, jedva nazirući crtu obzora. Stavio je stopala na hladni kamen terase i udahnuo zrak koji je još nosio trag noći — sol, kadulja, nešto od borovih smola. Otok je spavao. Jedino je daleko neka ribarska svjetlost titrala na vodi kao da se i sama pita treba li još biti budna.\n\nMarko je sjeo na brod tek sutradan, ali tu jutarnju tišinu — tu specifičnu prazninu koja nije praznina nego punoća svega — nosio je sa sobom cijeli ostatak życia. Ponekad, usred zimskog Zagreba, zatvorenom bi očima i gotovo čuo: more, kadulja, jutarnje zvono u daljini.",vocab:[["svitanje","dawn"],["nepomično","motionless"],["obzor","horizon"],["titrala","flickered"],["punoća","fullness"]],qs:[{q:"What does Marko smell at dawn?",o:["Coffee and bread","Salt, sage and pine resin","Fish and sea weed"],c:1},{q:"How does the narrator describe the morning silence?",o:["As emptiness","As fullness of everything","As loneliness"],c:1},{q:"When does he remember the morning later?",o:["In Split","In winter Zagreb","On another island"],c:1}]},
