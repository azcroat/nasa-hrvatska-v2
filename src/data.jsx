...
const GRAM = {
  ...
  advanced: [
    ...
    {title:"da + Present Clause",desc:"Croatian uses 'da + present tense' in subordinate clauses — after impersonal expressions (važno je, moguće je), verbs of thinking, fearing, and hoping. After verbs of wanting (htjeti, željeti) and needing (trebati, morati), use the infinitive — NOT 'da + present'. That pattern is a Serbism.",exs:[["Važno je da govoriš.","It's important that you speak."],["Hoću ići.","I want to go. (NOT: Hoću da idem)"],["Treba jesti.","We need to eat. (NOT: Treba da jedemo)"],["Nadam se da će doći.","I hope that he'll come."]],qs:[{q:"'I want to go' — correct Croatian?",o:["Hoću da idem.","Hoću ići.","Da idem hoću."],c:1},{q:"'It is important that she knows' =",o:["Važno je da zna.","Važno je znati.","Važno je ona znala."],c:0}]},
    {title:"Clitic Pronouns (me/te/ga/je)",desc:"Short unstressed pronouns. Accusative: me, te, ga (m.) / je/ju (f.), nas, vas, ih. Dative: mi, ti, mu/joj, nam, vam, im. Chain order: [auxiliary] [dative] [accusative] [se]. Note: je (3rd sg past auxiliary) may appear sentence-finally — 'Dao mi ga je' is standard spoken Croatian.",exs:[["Vidim te.","I see you."],["Daj mi to.","Give me that."],["Rekao sam mu.","I told him."],["Dala joj ga je.","She gave it to her."]],qs:[{q:"Dative clitic of 'on' (he) is:",o:["ga","mu","se"],c:1},{q:"Correct clitic chain order:",o:["[acc] [dat] [se]","[se] [dat] [acc]","[dat] [acc] [se]"],c:2}]}
  ]
};
// ═══ PLACEMENT TEST ═══
const PLACE = [
...
const FOOTBALL = {
  ...
  commentary:[["zabiti gol","to score a goal"],["šutirati","to shoot"],["driblati","to dribble"],["blokirati","to block"],["asistirati","to assist"],["izgubiti loptu","to lose the ball"],["slobodni udarac","free kick"],["žuti karton","yellow card"],["crveni karton","red card"],["ofsajd","offside"],["VAR","video assistant referee"],["penali","penalty shootout"],["produžeci","extra time"],["navijačka pjesma","supporter song"],["baklja","flare (at matches)"],["Kauboji","The Cowboys (handball team nickname)"],["rukomet","handball — Croatia 2003 & 2023 World Champions"]]
};
...
const RECIPES = [
  ...
  {name:"Ćevapi",en:"Grilled Meat Sausages",time:30,servings:4,
    ...
    steps:["Pomiješaj sve sastojke. (Mix all ingredients.)","Stavi u hladnjak 2 sata. (Refrigerate 2 hours.)","Oblikuj ćevape — 8cm dugi. (Shape into 8cm rolls.)","Peči na roštilju 3-4 min po strani. (Grill 3-4 min per side.)","Posluži u lepinji s lukom i ajvarom! (Serve in flatbread with onion & ajvar!)"]},
...
const ROLEPLAY = [
  ...
  {title:"Na Razgovoru za Posao",en:"Job Interview",
    lines:[
      {speaker:"Voditelj HR-a",text:"Dobar dan! Sjednite. Hvala što ste došli.",en:"Good day! Have a seat. Thank you for coming."},
      {speaker:"Ti",text:"Hvala na pozivu. Drago mi je što sam ovdje.",en:"Thank you for the invitation. I'm glad to be here.",you:true},
      {speaker:"Voditelj HR-a",text:"Recite mi nešto o sebi i svom iskustvu.",en:"Tell me something about yourself and your experience."},
      {speaker:"Ti",text:"Imam tri godine iskustva u marketingu. Radio/la sam na nekoliko velikih projekata.",en:"I have three years of experience in marketing. I have worked on several large projects.",you:true},
      {speaker:"Voditelj HR-a",text:"Zašto ste zainteresirani za ovu poziciju?",en:"Why are you interested in this position?"},
      {speaker:"Ti",text:"Vaša tvrtka ima odličnu reputaciju i posao odgovara mojim vještinama.",en:"Your company has an excellent reputation and the job matches my skills.",you:true},
      {speaker:"Voditelj HR-a",text:"Koje su vaše snage i slabosti?",en:"What are your strengths and weaknesses?"},
      {speaker:"Ti",text:"Snaga mi je organiziranost. Slabost — ponekad sam perfekcionist.",en:"My strength is organisation. Weakness — I'm sometimes a perfectionist.",you:true},
      {speaker:"Voditelj HR-a",text:"Kakva su vaša očekivanja po pitanju plaće?",en:"What are your salary expectations?"},
      {speaker:"Ti",text:"Tražim između 1.500 i 1.800 eura neto.",en:"I'm asking for between 1,500 and 1,800 euros net.",you:true},
      {speaker:"Voditelj HR-a",text:"Odlično. Javit ćemo vam se sljedeći tjedan.",en:"Excellent. We'll get back to you next week."},
      {speaker:"Ti",text:"Hvala lijepa. Jedva čekam vašu povratnu informaciju.",en:"Thank you very much. I look forward to your feedback.",you:true}]},
  {title:"Iznajmljivanje Stana",en:"Renting an Apartment",
    lines:[
      {speaker:"Vlasnik",text:"Dobar dan! Vi ste zainteresirani za stan?",en:"Good day! You're interested in the apartment?"},
      {speaker:"Ti",text:"Da, vidio/vidjela sam oglas. Mogu li ga pogledati?",en:"Yes, I saw the listing. May I view it?",you:true},
      {speaker:"Vlasnik",text:"Naravno. Stan ima 50 kvadrata, dvije sobe i balkon.",en:"Of course. The apartment is 50 square metres, two rooms and a balcony."},
      {speaker:"Ti",text:"Kolika je stanarina na mjesec?",en:"What is the monthly rent?",you:true},
      {speaker:"Vlasnik",text:"700 eura plus režije. Režije su otprilike 100 eura.",en:"700 euros plus utilities. Utilities are about 100 euros."},
      {speaker:"Ti",text:"Je li dopušteno imati kućnog ljubimca?",en:"Is it allowed to have a pet?",you:true},
      {speaker:"Vlasnik",text:"Imam mačku. To bi bio problem.",en:"I have a cat. That would be a problem."},
      {speaker:"Ti",text:"Razumijem. Kolika je kaucija?",en:"I understand. What is the deposit?",you:true},
      {speaker:"Vlasnik",text:"Dvije stanarine unaprijed.",en:"Two months' rent upfront."},
      {speaker:"Ti",text:"Mogu li razmisliti do sutra i javiti vam se?",en:"May I think about it until tomorrow and get back to you?",you:true}]},
  {title:"Planiranje Izlaska",en:"Planning a Night Out",
    lines:[
      {speaker:"Prijatelj",text:"Ej! Što radimo u petak navečer?",en:"Hey! What are we doing Friday evening?"},
      {speaker:"Ti",text:"Nemam planova. Što predlažeš?",en:"I have no plans. What do you suggest?",you:true},
      {speaker:"Prijatelj",text:"Moglo bi se izaći na večeru negdje u centru.",en:"We could go out for dinner somewhere in the centre."},
      {speaker:"Ti",text:"Dobra ideja! Ima li neko dobro novo mjesto?",en:"Good idea! Is there a good new place?",you:true},
      {speaker:"Prijatelj",text:"Da, otvorio se novi restoran s dalmatinskom hranom na Tkalči.",en:"Yes, a new restaurant with Dalmatian food opened on Tkalča street."},
      {speaker:"Ti",text:"Odlično! Treba li rezervacija?",en:"Excellent! Do we need a reservation?",you:true},
      {speaker:"Prijatelj",text:"Vjerojatno da. Mogu ja rezervirati ako hoćeš.",en:"Probably yes. I can make the reservation if you want."},
      {speaker:"Ti",text:"Super, hvala! U koliko sati?",en:"Great, thanks! What time?",you:true},
      {speaker:"Prijatelj",text:"Recimo u osam. A poslije bi mogli na piće.",en:"Let's say at eight. And afterwards we could go for drinks."},
      {speaker:"Ti",text:"Savršeno! Vidimo se u petak.",en:"Perfect! See you Friday.",you:true}]}
];
// ═══ POVIJESNE ČINJENICE ═══
const HIST_FACTS = [
...
const LEARN_PATH = [
  ...
  {level:6,title:"Virtuoz",desc:"Months 7-12",items:[
    ...
    {id:"lp54",name:"Grammar Constellation",diff:3,dur:"~15 min",ck:function(s){return s.gc>=7},go:"grammarconstellation"},
...
const CONVMATCH = [
  ...
  {title:"O poslu",pairs:[
    ...
    {q:"Mogu li koristiti računalo?",a:"Dobro, ali samo kad sam na sastanku.",wrong:"Išla sam na otok."},
...
const PHONOLOGY = {
  ...
  letters: [
    ...
    },
    {
      ...
      examples: [{ hr:"ćevapi", en:"grilled meat rolls" }, { hr:"noć", en:"night" }, { hr:"doći", en:"to come" }],
...
const ASPECT_PAIRS = [
  ...
  {impf:"slušati",pf:"poslušati",en:"to listen",rule:"po- prefix for completing a listen",ctx:"Slušam glazbu svaki dan. / Poslušao sam njegov savjet."},
];
