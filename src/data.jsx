...
const MEDIA = [
  // ─── TV & NEWS ───────────────────────────────────────────────────────────────
  {name:"HRT 1 — Live TV",desc:"Main national channel • news, drama, sport",web:"https://hrti.hrt.hr/live/tv",icon:"📺",color:"#0e7490",cat:"tv",level:"B1",tip:"Watch the Dnevnik (news at 19:30) daily. Same stories as what you read online — hearing the words cements vocabulary fast."},
  {name:"HRT 2 — Kultura & Sport",desc:"Arts, documentaries, sports coverage",web:"https://hrti.hrt.hr/",icon:"📺",color:"#0284c7",cat:"tv",level:"B2",tip:"HRT 2 airs cultural programs and in-depth debates. Great for hearing formal, careful Croatian."},
  {name:"HRT 3 — Documentaries",desc:"Education, nature & travel docs",web:"https://hrti.hrt.hr/",icon:"🎓",color:"#0369a1",cat:"tv",level:"B1",tip:"Documentary narration is slow, clear and well-pronounced. Perfect for intermediate learners."},
  ...
  // ─── MUSIC & RADIO ───────────────────────────────────────────────────────────
  {name:"HRT Radio 1",desc:"Croatian public radio — news, talk, music",web:"https://hrti.hrt.hr/live/radio",icon:"📻",color:"#0e7490",cat:"music",level:"B1",tip:"Leave HRT Radio 1 playing in the background while you cook or drive. Passive listening is powerful — your brain absorbs rhythm and pronunciation."},
  {name:"HRT Radio 2 — Classic",desc:"Classical music & cultural programs",web:"https://hrti.hrt.hr/live/radio",icon:"🎵",color:"#6d28d9",cat:"music",level:"B2",tip:"Cultural programs feature thoughtful, slow speech from educated speakers. Great for training your ear on formal Croatian."},
  {name:"CMC TV",desc:"Croatian Music Channel • pop, folk, turbofolk",web:"https://www.youtube.com/results?search_query=CMC+TV+Croatian+Music+Channel+live+2024",icon:"🎶",color:"#7c3aed",cat:"music",level:"A1",tip:"Music is the best passive learning tool. Even at A1, exposure to Croatian song structures trains your ear for rhythm, stress and melody."},
  {name:"CMC Radio Live",desc:"24/7 Croatian hits • all genres",web:"https://www.youtube.com/results?search_query=CMC+radio+croatia+live+stream",icon:"🎧",color:"#9333ea",cat:"music",level:"A1",tip:"Pop songs repeat the same phrases dozens of times — this is vocabulary acquisition without effort. Pick one song and look up the lyrics."},
  ...
  // ─── FILM & SERIES ───────────────────────────────────────────────────────────
  {name:"Croatian Films (Free)",desc:"250+ award-winning shorts • English subtitles available",web:"https://www.croatian.film/en/",icon:"🎬",color:"#b91c1c",cat:"film",level:"B1",tip:"Start with short films (5-15 min). Watch once with English subs for story, then again with Croatian subs for language. Brilliant free resource."},
  ...
  {name:"ABA Liga",desc:"Adriatic Basketball Association",web:"https://www.aba-liga.com/newslist/HL/1/",icon:"🏀",color:"#0e7490",cat:"sport",level:"B1",tip:"Short game reports on ABA Liga use compact, clear sports writing. Great for reading practice — games have predictable sentence structures."},
  // ─── PODCASTS & LEARNING ─────────────────────────────────────────────────────
  ...
  {name:"HRT Podcast Arhiva",desc:"Croatian radio podcasts on demand",web:"https://radio.hrt.hr/podcasts/",icon:"🎧",color:"#0e7490",cat:"podcast",level:"B2",tip:"HRT podcasts cover everything from history to cooking. Find a topic you love and listen to it — motivation sustains learning better than discipline."},
...
const CROATIAN_CITIES = [
  ...
  {name:"Hvar",region:"Dalmatia",icon:"🌿",color:"#16a34a",tagline:"Sunniest Place in Croatia",
    ...
    facts:["Hvar gets 2,726 hours of sunshine per year — the most of any Croatian town","The Hvar Communal Theatre (1612) is one of the oldest community theatres in the world","Stari Grad Plain on Hvar is a UNESCO-listed Greek land division system from 384 BC — unchanged for 2,400 years","The Hvar Rebellion of 1510 was one of the first major peasant uprisings in European history","Lavender has been cultivated on Hvar for over 100 years — the island produces most of Croatia's lavender oil"],
    ...
    didYouKnow:"Stari Grad Plain on Hvar island preserves an intact ancient Greek land division (chora) from 384 BC — the fields and paths have been in the same pattern for 2,400 years, recognised by UNESCO."},
...
/* === CARDS === */
.c{background:#fff;border:1px solid rgba(0,0,0,.07);border-radius:18px;padding:18px;box-shadow:0 1px 3px rgba(0,0,0,.06),0 4px 16px rgba(0,0,0,.04)}
.c:hover{box-shadow:0 4px 24px rgba(14,116,144,.1),0 1px 3px rgba(0,0,0,.06);transition:box-shadow .2s}
.tc{background:#fff;border:1px solid rgba(0,0,0,.07);border-radius:18px;padding:16px;cursor:pointer;transition:transform .18s,box-shadow .18s,border-color .18s;box-shadow:0 1px 3px rgba(0,0,0,.06),0 4px 16px rgba(0,0,0,.04)}
...
.tc:active{transform:translateY(0);box-shadow:0 1px 3px rgba(0,0,0,.06)}
/* === BUTTONS === */
...
.bg{background:#fff;color:#475569;border:1.5px solid #e2e8f0;box-shadow:0 1px 3px rgba(0,0,0,.06)}
.bg:hover{background:#f8fafc;border-color:#0e7490;color:#0e7490}
/* === INPUTS === */
input[type=text],input[type=password],input[type=email],textarea{width:100%;padding:13px 16px;border:1.5px solid #e2e8f0;border-radius:12px;background:#fff;color:#1c1917;font-size:15px;font-weight:500;outline:none;font-family:'Outfit',sans-serif;transition:border-color .2s,box-shadow .2s}
...
/* === QUIZ OPTIONS === */
.ob{width:100%;padding:14px 18px;border:1.5px solid #e2e8f0;border-radius:12px;background:#fff;color:#1c1917;font-size:15px;font-weight:600;cursor:pointer;transition:all .18s;font-family:'Outfit',sans-serif;text-align:left;margin-bottom:8px;box-shadow:0 1px 3px rgba(0,0,0,.04)}
.ob:hover{border-color:#0e7490;background:#f0f9ff;transform:translateX(2px)}
.ob.ok{border-color:#16a34a;background:#f0fdf4;color:#15803d}
.ob.no{border-color:#dc2626;background:#fef2f2;color:#b91c1c}
/* === TYPOGRAPHY === */
.sh{font-size:11px;font-weight:800;color:#94a3b8;margin-bottom:10px;margin-top:24px;letter-spacing:.1em;text-transform:uppercase;padding-bottom:0;border-bottom:none}
/* === READING TEXT === */
.rt{font-size:17px;line-height:2;color:#374151}
...
.nav-bar{position:fixed;bottom:0;left:0;right:0;background:rgba(255,255,255,.96);border-top:1px solid rgba(0,0,0,.06);display:flex;justify-content:space-around;align-items:center;padding:4px 0;padding-bottom:max(4px,env(safe-area-inset-bottom));z-index:9000;backdrop-filter:saturate(160%) blur(24px)}
...
.nav-btn .nav-label{font-size:10px;font-weight:600;color:#94a3b8;transition:color .15s}
...
@media(min-width:768px){
  .nav-bar{bottom:auto;top:0;border-top:none;border-bottom:1px solid rgba(0,0,0,.07);padding:0 32px;justify-content:center;gap:2px;height:60px}
  ...
  .nav-btn .nav-label{font-size:13px;font-weight:600;color:#64748b}
...
const H=(t,s)=><div style={{marginBottom:20,paddingBottom:16,borderBottom:"1px solid rgba(0,0,0,.06)"}}>
  <h2
    style={{fontFamily:"'Playfair Display',serif",fontSize:24,color:"#0f172a",fontWeight:800,letterSpacing:"-.02em",lineHeight:1.2}}>
    {t}
  </h2>
  {s&&<p style={{color:"#64748b",fontSize:13,marginTop:5,fontWeight:500}}>
    {s}
  </p>}
</div>;
const Bar=({v,mx,color="#0e7490",h=8})=><div
  style={{background:"rgba(0,0,0,.06)",borderRadius:h/2,height:h,overflow:"hidden"}}>
  <div
