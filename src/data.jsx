...
const LEARN_PATH = [
  {level:1,title:"Survivor",desc:"First 48 hours",items:[
    {id:"lp1",name:"Basic Greetings",ck:function(s){return s.ct&&s.ct.includes("greetings")},go:"lesson",topic:"greetings"},{id:"lp2",name:"Numbers",ck:function(s){return s.ct&&s.ct.includes("numbers")},go:"lesson",topic:"numbers"},{id:"lp3",name:"Emergency Phrases",ck:function(s){return s.ct&&s.ct.includes("health")},go:"lesson",topic:"health"},{id:"lp4",name:"Order Food",ck:function(s){return s.ct&&s.ct.includes("restaurant")},go:"lesson",topic:"restaurant"},{id:"lp5",name:"Get Around",ck:function(s){return s.ct&&s.ct.includes("transport")},go:"lesson",topic:"transport"}]},
  {level:2,title:"Settler",desc:"First week",items:[
    {id:"lp6",name:"Family Words",ck:function(s){return s.ct&&s.ct.includes("family")},go:"lesson",topic:"family"},{id:"lp7",name:"School Kit",ck:function(s){return s.ct&&s.ct.includes("in the classroom")},go:"lesson",topic:"in the classroom"},{id:"lp8",name:"Making Friends",ck:function(s){return s.ct&&s.ct.includes("personality")},go:"lesson",topic:"personality"},{id:"lp9",name:"Grocery Shopping",ck:function(s){return s.ct&&s.ct.includes("shopping")},go:"lesson",topic:"shopping"},{id:"lp10",name:"Alphabet",ck:function(s){return s.lc>=3},go:"alphabet",topic:"alphabet"},{id:"lp11",name:"First Quiz",ck:function(s){return s.xp>=50},go:"mcgame"}]},
