...
// ═══ PLACEMENT TEST ═══
const PLACE = [
  {q:"What does 'Bog' mean?",o:["Goodbye","Hello","Thank you"],c:1,d:1},
  ...
  {q:"How do you say 'Goodbye'?",o:["Bog","Doviđenja","Hvala"],c:1,d:1},
...
const LEARN_PATH = [
  {level:1,title:"Survivor",desc:"First 48 hours",items:[
    {id:"lp1",name:"Basic Greetings",ck:function(s){return (s.ct&&s.ct.includes("greetings"))||s.lc>=1},go:"lesson",topic:"greetings"},{id:"lp2",name:"Numbers",ck:function(s){return (s.ct&&s.ct.includes("numbers"))||s.lc>=2},go:"lesson",topic:"numbers"},{id:"lp3",name:"Emergency Phrases",ck:function(s){return (s.ct&&s.ct.includes("health"))||s.lc>=3},go:"lesson",topic:"health"},{id:"lp4",name:"Order Food",ck:function(s){return (s.ct&&s.ct.includes("restaurant"))||s.lc>=4},go:"lesson",topic:"restaurant"},{id:"lp5",name:"Get Around",ck:function(s){return (s.ct&&s.ct.includes("transport"))||s.lc>=5},go:"lesson",topic:"transport"}]},
  {level:2,title:"Settler",desc:"First week",items:[
    {id:"lp6",name:"Family Words",ck:function(s){return (s.ct&&s.ct.includes("family"))||s.lc>=6},go:"lesson",topic:"family"},{id:"lp7",name:"School Kit",ck:function(s){return (s.ct&&s.ct.includes("in the classroom"))||s.lc>=7},go:"lesson",topic:"in the classroom"},{id:"lp8",name:"Making Friends",ck:function(s){return (s.ct&&s.ct.includes("personality"))||s.lc>=8},go:"lesson",topic:"personality"},{id:"lp9",name:"Grocery Shopping",ck:function(s){return (s.ct&&s.ct.includes("shopping"))||s.lc>=9},go:"lesson",topic:"shopping"},{id:"lp10",name:"Alphabet",ck:function(s){return s.lc>=3},go:"alphabet",topic:"alphabet"},{id:"lp11",name:"First Quiz",ck:function(s){return s.xp>=50},go:"mcgame"}]},
  {level:3,title:"Communicator",desc:"First month",items:[
    {id:"lp12",name:"Grammar Intro",ck:function(s){return s.gc>=1},go:"grammar"},{id:"lp13",name:"Texting/Slang",ck:function(s){return s.lc>=10},go:"texting"},{id:"lp14",name:"Role-Play",ck:function(s){return s.lc>=10},go:"roleplay"},{id:"lp15",name:"Read a Story",ck:function(s){return s.lc>=12},go:"readlist"},{id:"lp16",name:"Conjugation",ck:function(s){return s.gc>=2},go:"conjdrill"},{id:"lp17",name:"Listening",ck:function(s){return s.lc>=12},go:"listening"},{id:"lp18",name:"Tenses & Gender",ck:function(s){return s.gc>=3},go:"tenses"},{id:"lp34",name:"Vi ili ti?",ck:function(s){return s.gc>=3},go:"formalregister"},{id:"lp35",name:"Tech & Digital",ck:function(s){return s.lc>=12},go:"techvoc"},{id:"lp42",name:"Work & Career",ck:function(s){return (s.ct&&s.ct.includes("work"))||s.lc>=14},go:"lesson",topic:"work"},{id:"lp43",name:"Opinions & Debate",ck:function(s){return (s.ct&&s.ct.includes("opinions"))||s.lc>=15},go:"lesson",topic:"opinions"}]},
  {level:4,title:"Explorer",desc:"Months 2-3",items:[
    {id:"lp19",name:"7 Cases",ck:function(s){return s.gc>=4},go:"padezi"},{id:"lp20",name:"Padeži Master",ck:function(s){return s.gc>=5},go:"padezifull"},{id:"lp21",name:"Verb Aspect",ck:function(s){return s.gc>=5},go:"aspect"},{id:"lp22",name:"Modal Verbs",ck:function(s){return s.gc>=6},go:"modal"},{id:"lp23",name:"Declension",ck:function(s){return s.gc>=6},go:"declension"},{id:"lp24",name:"False Friends",ck:function(s){return s.lc>=20},go:"falsefr"},{id:"lp25",name:"Dialects",ck:function(s){return s.lc>=20},go:"dialects"},{id:"lp36",name:"Conditional Mood",ck:function(s){return s.gc>=5},go:"conditional"},{id:"lp37",name:"Impersonal",ck:function(s){return s.gc>=6},go:"impersonal"},{id:"lp39",name:"Clitic Pronouns",ck:function(s){return s.gc>=6},go:"clitic"},{id:"lp44",name:"Environment",ck:function(s){return (s.ct&&s.ct.includes("environment"))||s.lc>=22},go:"lesson",topic:"environment"},{id:"lp45",name:"Society & Community",ck:function(s){return (s.ct&&s.ct.includes("society"))||s.lc>=23},go:"lesson",topic:"society"}]},
