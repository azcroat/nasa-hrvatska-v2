...
const LEARN_PATH = [
  ...
  {level:3,title:"Communicator",desc:"First month",items:[
    {id:"lp12",name:"Grammar Intro",diff:2,dur:"~10 min",ck:function(s){return s.gc>=1},go:"grammar"},{id:"lp13",name:"Texting/Slang",diff:2,dur:"~10 min",ck:function(s){return (s.vs&&s.vs.includes('texting'))||s.lc>=10},go:"texting"},{id:"lp14",name:"Role-Play",diff:2,dur:"~10 min",ck:function(s){return (s.vs&&s.vs.includes('roleplay'))||s.lc>=10},go:"roleplay"},{id:"lp15",name:"Read a Story",diff:2,dur:"~12 min",ck:function(s){return (s.vs&&s.vs.includes('readlist'))||s.lc>=12},go:"readlist",filter:["beginner"]},{id:"lp16",name:"Conjugation",diff:3,dur:"~12 min",ck:function(s){return s.gc>=2},go:"conjdrill"},{id:"lp17",name:"Listening",diff:2,dur:"~10 min",ck:function(s){return (s.vs&&s.vs.includes('listening'))||s.lc>=12},go:"listening"},{id:"lp18",name:"Tenses & Gender",diff:3,dur:"~12 min",ck:function(s){return (s.vs&&s.vs.includes('tenses'))||s.gc>=3},go:"tenses"},
  ...
  {level:7,title:"Majstor",desc:"Year 1+",items:[
    ...
    {id:"lp66",name:"Idioms: Expert",diff:3,dur:"~20 min",ck:function(s){return s.xp>=2000},go:"idioms"},
    ...
    {id:"lp70",name:"Tongue Twisters: Expert",diff:3,dur:"~15 min",ck:function(s){return s.xp>=2500},go:"brzalice"},
