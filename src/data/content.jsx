...
const LEARN_PATH = [
  ...
  {level:6,title:"Virtuoz",desc:"Months 7-12",items:[
    ...
    {id:"lp53",name:"Clitic Pronouns",diff:3,dur:"~15 min",ck:function(s){return (s.vs&&s.vs.includes('clitic'))||s.lc>=36},go:"clitic"},
    ...
    {id:"lp55",name:"Impersonal Constructions",diff:3,dur:"~15 min",ck:function(s){return (s.vs&&s.vs.includes('impersonal'))||s.gc>=7},go:"impersonal"},
    {id:"lp56",name:"Conditional Mood",diff:3,dur:"~15 min",ck:function(s){return (s.vs&&s.vs.includes('conditional'))||s.gc>=7},go:"conditional"},
    {id:"lp57",name:"Word Formation",diff:3,dur:"~15 min",ck:function(s){return (s.vs&&s.vs.includes('wordform'))||s.lc>=38},go:"wordform"},
    ...
    {id:"lp60",name:"B2 Reading",diff:3,dur:"~20 min",ck:function(s){return (s.vs&&s.vs.includes('readlist'))||s.lc>=40},go:"readlist",filter:["b2"]},
    {id:"lp61",name:"Croatian History",diff:3,dur:"~20 min",ck:function(s){return (s.vs&&s.vs.includes('history'))||s.lc>=40},go:"history"},
    {id:"lp62",name:"Listening Mastery",diff:3,dur:"~20 min",ck:function(s){return (s.vs&&s.vs.includes('listeningpath'))||s.lc>=40},go:"listeningpath"}
  ]},
  {level:7,title:"Majstor",desc:"Year 1+",items:[
    {id:"lp63",name:"Croatian Dialects",diff:3,dur:"~20 min",ck:function(s){return (s.vs&&s.vs.includes('dialects'))||s.lc>=45},go:"dialects"},
    ...
    {id:"lp66",name:"Advanced Idioms",diff:3,dur:"~20 min",ck:function(s){return (s.vs&&s.vs.includes('idioms'))||s.xp>=2000},go:"idioms"},
    {id:"lp67",name:"Abstract Language",diff:3,dur:"~20 min",ck:function(s){return (s.ct&&s.ct.includes("philosophy"))||s.xp>=2000},go:"lesson",topic:"philosophy"},
    {id:"lp68",name:"Media Language",diff:3,dur:"~20 min",ck:function(s){return (s.ct&&s.ct.includes("journalism"))||s.xp>=2000},go:"lesson",topic:"journalism"},
    {id:"lp69",name:"Legal Croatian",diff:3,dur:"~20 min",ck:function(s){return (s.ct&&s.ct.includes("law"))||s.xp>=2500},go:"lesson",topic:"law"},
    {id:"lp70",name:"Tongue Twisters Master",diff:3,dur:"~15 min",ck:function(s){return (s.vs&&s.vs.includes('brzalice'))||s.xp>=2500},go:"brzalice"},
    {id:"lp72",name:"C1 Stories",diff:3,dur:"~20 min",ck:function(s){return (s.vs&&s.vs.includes('readlist'))||s.lc>=45},go:"readlist",filter:["c1"]}
  ]}
];
// ═══ REFLEXIVE VERBS ═══
const REFLEXIVE = {
