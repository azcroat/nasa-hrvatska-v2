...
const LEARN_PATH = [
  ...
  {level:6,title:"Virtuoz",desc:"Months 7-12",items:[
    ...
    {id:"lp60",name:"B2 Reading",diff:3,dur:"~20 min",ck:function(s){return s.lc>=40},go:"readlist",filter:["b2"]},
  ...
  {level:7,title:"Majstor",desc:"Year 1+",items:[
    ...
    {id:"lp72",name:"C1 Stories",diff:3,dur:"~20 min",ck:function(s){return s.lc>=45},go:"readlist",filter:["c1"]}
  ]}
];
// ═══ REFLEXIVE VERBS ═══
const REFLEXIVE = {
