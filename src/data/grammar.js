...
export const GRAM = {
  beginner: [
    {title:"Noun Genders & Plurals",desc:"3 genders: Feminine (-A: žena, knjiga), Neuter (-O/-E: selo, sunce), Masculine (consonant: grad). Plurals: Fem -A→-E, Neut -O→-A, Masc add -I/-OVI.",exs:[["žena→žene","woman→women"],["selo→sela","village→villages"],["grad→gradovi","city→cities"]],qs:[
      ...
      {q:"Which ending signals a neuter noun?",o:["-a ending","consonant ending","-o or -e ending"],c:2},
      ...
      {q:"Which gender uses -OVI to form many plurals?",o:["Masculine","Feminine","Neuter"],c:0},
    ...
    {title:"Verb 'Biti' (To Be)",desc:"Ja sam, Ti si, On/Ona je, Mi smo, Vi ste, Oni su. Negative: nisam, nisi, nije, nismo, niste, nisu.",exs:[["Ja sam profesor.","I am a teacher."],["Ja nisam umoran.","I am not tired."]],qs:[
    ...
    {title:"Basic Negation",desc:"Add 'ne' before the verb. For 'biti': nisam, nisi, nije... For others: ne + verb.",exs:[["Ne govorim","I don't speak"],["Nema problema","No problem"]],qs:[
      {q:"'I don't know' =",o:["Ne znam","Nisam znam","Ja ne"],c:0},
      {q:"'She doesn't speak' =",o:["Ona nisam govori","Ona ne govori","Ona nije govori"],c:1},
      {q:"'There is no coffee' =",o:["Nema kave","Ne kava","Nije kava"],c:0},
      {q:"'He doesn't work' =",o:["On nije radi","On ne radi","On nisam radi"],c:1},
      {q:"'We don't understand' =",o:["Mi ne razumijemo","Mi nisam razumijemo","Mi nema razumijemo"],c:0},
      {q:"After 'nema', nouns take which case?",o:["Nominative","Accusative","Genitive"],c:2},
      ...
      {q:"'Nothing is ready' =",o:["Ništa ne gotovo","Ništa nije gotovo","Nema gotovo"],c:1},
      {q:"'I didn't eat' =",o:["Nisam jeo/jela","Nema jeo/jela","Ne sam jeo/jela"],c:0},
      {q:"'Nikad' (never) in a sentence requires:",o:["'ne' before the verb — double negative is standard","No 'ne' — 'nikad' alone is enough","'nije' instead of 'ne'"],c:0},
      {q:"'You will not go' =",o:["Ne ćeš ići","Nećeš ići","Niste ići"],c:1}
    ]}
  ],
  intermediate: [
    {title:"Present Tense",desc:"-ati verbs: -am,-aš,-a,-amo,-ate,-aju. -iti verbs: -im,-iš,-i,-imo,-ite,-e.",exs:[["Ja čitam","I read"],["Oni čitaju","They read"]],qs:[
      ...
      {q:"Which conjugation pattern fits 'učiti'?",o:["-am,-aš,-a,-amo,-ate,-aju","-im,-iš,-i,-imo,-ite,-e","-em,-eš,-e,-emo,-ete,-u"],c:1},
    ...
    {title:"Accusative Case",desc:"Direct object. Fem: -a→-u. Masc animate: add -a. Inanimate/neuter: no change.",exs:[["Vidim kuću.","I see a house."],["Čitam knjigu.","I read a book."]],qs:[
      {q:"Accusative of 'sestra' (sister)?",o:["sestru","sestre","sestri"],c:0},
      {q:"Accusative of 'majka' (mother)?",o:["majku","majke","majki"],c:0},
      {q:"'Vidim brata' — 'brat' is masculine animate, so it takes:",o:["No change","Genitive form (-a)","Dative form (-u)"],c:1},
      {q:"'I read a book' — 'knjiga' in accusative =",o:["knjige","knjigi","knjigu"],c:2},
      {q:"Inanimate masculine nouns in accusative take:",o:["genitive form","no change","dative form"],c:1},
      {q:"'Volim Hrvatsku' — 'Hrvatska' in accusative =",o:["Hrvatsku","Hrvatska","Hrvatske"],c:0},
      {q:"Accusative of 'žena' (woman) =",o:["žene","ženu","ženi"],c:1},
      {q:"'Vidim grad' — 'grad' is inanimate, so accusative =",o:["grad (no change)","grada","gradu"],c:0},
      {q:"Neuter nouns in the accusative take:",o:["genitive form","dative form","no change"],c:2},
      {q:"Which question word corresponds to the accusative?",o:["Tko? Što?","Koga? Što?","Komu? Čemu?"],c:1},
      {q:"'Kupujem auto' — 'auto' is inanimate, accusative =",o:["auto","auta","autu"],c:0},
      {q:"Accusative of 'rijeka' (river, fem) =",o:["rijeke","rijeki","rijeku"],c:2},
      {q:"'Čekam prijatelja' — animate, so accusative =",o:["nominative form","genitive form (-a)","dative form (-u)"],c:1},
      {q:"Accusative of 'more' (sea, neuter) =",o:["mora","moru","more"],c:2}
    ]},
    {title:"Past Tense",desc:"Past participle + 'biti'. Masc: -o, Fem: -la, Neut: -lo.",exs:[["Ja sam čitao","I read (m)"],["Ona je pjevala","She sang"]],qs:[
      {q:"'She ate' (jesti) =",o:["Ona je jeo","Ona je jela","Ona je jelo"],c:1},
      {q:"'He worked' (raditi) =",o:["On je radio","On je radila","On je radilo"],c:0},
      {q:"'I (f) studied' (učiti) =",o:["Ja sam učio","Ja sam učila","Ja sam učilo"],c:1},
      {q:"'They went' (ići, masc. pl.) =",o:["Oni su išli","Oni su išle","Oni su išao"],c:0},
      {q:"Past participle of 'pisati' (to write, m) =",o:["pisao","pisala","pisalo"],c:0},
      {q:"'We watched' (gledati, fem. pl.) =",o:["Mi smo gledali","Mi smo gledale","Mi smo gledao"],c:1},
      {q:"Past auxiliary for 3rd person singular =",o:["sam","si","je"],c:2},
      {q:"Past participle of 'raditi' (feminine) =",o:["radio","radila","radilo"],c:1},
      {q:"'They (f) drank' (piti, fem. pl.) =",o:["One su pili","One su pile","One su pilo"],c:1},
      {q:"'You (sg, m) went' = Ti ___ išao",o:["si","sam","je"],c:0},
      {q:"Negative past of 'raditi' for 'on' =",o:["On nije radio","On ne je radio","On nisam radio"],c:0},
      {q:"Past participle of 'biti' (to be, masc sing) =",o:["bila","bil","bio"],c:2},
      {q:"Past tense: the auxiliary comes in which position?",o:["First","Second (after subject or topic)","Always last"],c:1},
      {q:"'I (m) read yesterday' = Ja sam ___ (čitati)",o:["čitao","čitala","čitali"],c:0}
    ]},
    {title:"Future Tense",desc:"ću/ćeš/će/ćemo/ćete/će + infinitive. Neg: neću/nećeš/neće...",exs:[["Ja ću čitati.","I will read."],["Neću spavati.","I won't sleep."]],qs:[
      ...
      {q:"Short future: 'Čitat ću' means?",o:["I was reading","I will read","I read"],c:1},
      ...
      {q:"Short future drops the final ___ of the infinitive.",o:["syllable -ti","-i","-iti"],c:1},
  ...
  advanced: [
    {title:"All Seven Cases",desc:"Nominativ (who?), Genitiv (whose?), Dativ (to whom?), Akuzativ (what?), Vokativ (hey!), Lokativ (where?), Instrumental (with what?).",exs:[["žena: žena,žene,ženi,ženu,ženo,ženi,ženom","all 7 cases"]],qs:[
      ...
      {q:"'Idem u Zagreb' — 'Zagreb' is in which case?",o:["Nominative","Accusative","Locative"],c:1},
      {q:"Vocative is used for?",o:["Locations","Direct address","Possession"],c:1},
      {q:"'Nema vode' — 'voda' is in which case?",o:["Nominative","Accusative","Genitive"],c:2},
      {q:"'Govorim o prijatelju' — after 'o' the noun takes?",o:["Dative","Locative","Instrumental"],c:1},
      {q:"Which case is the dictionary/subject form?",o:["Nominative","Accusative","Dative"],c:0},
      {q:"'Živim u Zagrebu' — 'Zagreb' is in which case?",o:["Accusative","Dative","Locative"],c:2},
      {q:"Prepositions 'iz', 'od', 'do', 'bez', 'kod' require which case?",o:["Genitive","Dative","Instrumental"],c:0},
      {q:"'Pišem olovkom' — 'olovkom' is in which case?",o:["Dative","Locative","Instrumental"],c:2},
      {q:"Which case ALWAYS requires a preposition?",o:["Genitive","Locative","Dative"],c:1},
      {q:"'Dajem pismo Ani' — 'Ani' is in which case?",o:["Dative","Accusative","Genitive"],c:0},
      {q:"Masculine animate accusative uses which form?",o:["Nominative form","Genitive form","Dative form"],c:1},
      {q:"'Hej, Ivane!' — 'Ivane' is in which case?",o:["Nominative","Accusative","Vocative"],c:2}
    ]},
    {title:"Conditional Mood",desc:"bih/bi/bi/bismo/biste/bi + past participle. Wishes, polite requests.",exs:[["Ja bih jeo.","I would eat."],["Željela bih kavu.","I'd like coffee."]],qs:[
      ...
      {q:"'Would you like coffee?' (formal) =",o:["Bih li kavu?","Biste li željeli kavu?","Bi li kavu?"],c:1},
      {q:"Conditional formed with?",o:["bih/bi... + infinitive","bih/bi... + past participle","ću/će... + infinitive"],c:1},
      {q:"'Da imam novca...' means?",o:["Because I have money...","If I had money...","When I have money..."],c:1},
      {q:"'You (sg) would go' = Ti ___ išao.",o:["bi","bih","bismo"],c:0},
      {q:"'They would read' = Oni ___ čitali.",o:["bi","bih","biste"],c:0},
      {q:"'I would like a coffee' =",o:["Bih kavu","Bi kavu","Htio/Htjela bih kavu"],c:2},
      {q:"'You (pl) would sing' = Vi ___ pjevali.",o:["bih","biste","bismo"],c:1},
      {q:"'Kad bih imao...' translates as?",o:["If I had...","When I have...","Because I had..."],c:0},
      {q:"'Biste li mogli...' means?",o:["Would you like...?","Could you (pl/formal)...?","Should you...?"],c:1},
      {q:"Past participle in conditional agrees with?",o:["Subject's gender/number","Object's gender/number","Verb root only"],c:0},
      {q:"Conditional of 'moći' (3rd sg): 'Ona ___ mogla'",o:["bih","bismo","bi"],c:2}
    ]},
    {title:"da + Present Clause",desc:"Croatian uses 'da + present tense' in subordinate clauses — after impersonal expressions (važno je, moguće je), verbs of thinking, fearing, and hoping. After verbs of wanting (htjeti, željeti) and needing (trebati, morati), use the infinitive — NOT 'da + present'. That pattern is a Serbism.",exs:[["Važno je da govoriš.","It's important that you speak."],["Hoću ići.","I want to go. (NOT: Hoću da idem)"],["Treba jesti.","We need to eat. (NOT: Treba da jedemo)"],["Nadam se da će doći.","I hope that he'll come."]],qs:[
      {q:"'I want to go' — correct Croatian?",o:["Hoću da idem.","Hoću ići.","Da idem hoću."],c:1},
      {q:"'It is important that she knows' =",o:["Važno je da zna.","Važno je znati.","Važno je ona znala."],c:0},
      {q:"After 'važno je', use:",o:["da + present tense","infinitive only","past tense"],c:0},
      {q:"After 'trebam' (I need), use:",o:["da + present","infinitive","past participle"],c:1},
      {q:"'I hope she comes' =",o:["Nadam se da dođe.","Nadam se da doći.","Nadam se doći."],c:0},
      {q:"'Hoću da idem' is considered?",o:["Standard Croatian","A Serbism to avoid","Perfectly formal"],c:1},
      {q:"'Mislim da...' (I think that...) is followed by?",o:["da + present/future/past","infinitive only","accusative noun"],c:0},
      {q:"'It's possible that he comes' = Moguće je ___",o:["da doći","da dođe","doći"],c:1},
      {q:"'I'm afraid she won't come' =",o:["Bojim se da neće doći.","Bojim se neće doći.","Bojim se ne doći."],c:0},
      {q:"After 'moram' (I must), standard Croatian uses:",o:["da + present","infinitive","past tense"],c:1},
      {q:"'I want her to come' = Želim ___",o:["da doći","doći","da dođe"],c:2},
      {q:"'Čudno je da...' (It's strange that...) takes:",o:["da + present tense","infinitive","conditional"],c:0},
      {q:"'Treba da jedemo' is?",o:["Perfectly standard Croatian","Non-standard (Serbism) — correct form: Treba jesti","Formal written style only"],c:1},
      {q:"'Nadam se da...' (I hope that...) takes:",o:["present or future tense after 'da'","infinitive only","conditional 'bi'"],c:0}
    ]},
    {title:"Clitic Pronouns (me/te/ga/je)",desc:"Short unstressed pronouns. Accusative: me, te, ga (m.) / je/ju (f.), nas, vas, ih. Dative: mi, ti, mu/joj, nam, vam, im. Chain order: [auxiliary] [dative] [accusative] [se]. Note: je (3rd sg past auxiliary) may appear sentence-finally — 'Dao mi ga je' is standard spoken Croatian.",exs:[["Vidim te.","I see you."],["Daj mi to.","Give me that."],["Rekao sam mu.","I told him."],["Dala joj ga je.","She gave it to her."]],qs:[
      {q:"Dative clitic of 'on' (he) is:",o:["ga","mu","se"],c:1},
      {q:"Correct clitic chain order:",o:["[acc] [dat] [se]","[se] [dat] [acc]","[dat] [acc] [se]"],c:2},
      ...
      {q:"In 'Dao mi ga je', what is 'ga'?",o:["Accusative of 'on' (it/him)","Dative of 'ona'","Instrumental clitic"],c:0},
      {q:"Reflexive clitic 'se' is which case?",o:["Dative reflexive","Accusative reflexive","Nominative reflexive"],c:1},
...
export const TENSES = {
  ...
  verbs:[
    ...
    {inf:"moći",en:"to be able to / can",
      ...
      futureM:["moć ću","moć ćeš","moć će","moć će","moć ćemo","moć ćete","moć će","moć će"],
      futureF:["moć ću","moć ćeš","moć će","moć će","moć ćemo","moć ćete","moć će","moć će"],
