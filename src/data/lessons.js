  ...
  // ─────────────────────────────────────────────────────────
  {
    ...
    slides: [
      ...
      },
      {
        ...
        items: [
          { hr: "Svaki dan pijem kavu.", en: "Every day I drink coffee.", note: "piti (impf.) — repeated habit" },
          { hr: "Uvijek čitam prije spavanja.", en: "I always read before sleep.", note: "čitati (impf.) — always" },
          { hr: "Često smo šetali po obali.", en: "We often walked along the shore.", note: "šetati (impf.) — often in past" },
          { hr: "Obično jem u podne.", en: "I usually eat at noon.", note: "jesti (impf.) — usual routine" },
        ],
      },
      {
        type: "rule",
      ...
      },
      {
        ...
        items: [
          { hr: "Čitao sam kada je zazvonio telefon.", en: "I was reading when the phone rang.", note: "čitao sam (impf.) = background; zazvonio (pf.) = event" },
          { hr: "Ona je spavala dok smo mi razgovarali.", en: "She was sleeping while we were talking.", note: "spavala (impf.) + razgovarali (impf.) — parallel processes" },
          { hr: "Sunce je sjalo dok smo plivali.", en: "The sun was shining while we swam.", note: "sjalo (impf.) — scenic background" },
        ],
      },
      {
        type: "rule",
      ...
      },
      {
        ...
        items: [
          { hr: "Pisao sam pismo.", en: "I was writing a letter. (process, not necessarily finished)", note: "pisao (impf.) — focus on activity" },
          { hr: "Napisao sam pismo.", en: "I wrote a letter. (finished — it exists now)", note: "napisao (pf.) — result assured" },
          { hr: "Učio sam za ispit.", en: "I was studying for the exam.", note: "učio (impf.) — process, outcome open" },
          { hr: "Naučio sam lekciju.", en: "I learned the lesson. (mastered it)", note: "naučio (pf.) — successful completion" },
        ],
      },
      {
        type: "quiz",
        ...
        correct: 1,
        explanation: "'She was drinking coffee when I arrived' — the ongoing background action needs imperfective (pila je kavu kada sam stigao). The first three options that reference completion or a quick single event use perfective (popiti). Imperfective = process / scene-setting.",
      },
      {
        type: "quiz",
        ...
        correct: 1,
        explanation: "'Svaki dan' (every day) is a classic imperfective trigger. 'Hodati' is the imperfective of 'to walk'. 'Prohodati' is perfective (to learn to walk / walk for the first time). The daily habit demands imperfective.",
      },
      {
        type: "summary",
        title: "Imperfective — When to Use It",
  ...
  // ─────────────────────────────────────────────────────────
  {
    ...
    slides: [
      ...
      },
      {
        ...
        items: [
          { hr: "Napisao sam email.", en: "I wrote the email. (it's done)", note: "napisati (pf.) — email exists, complete" },
          { hr: "Ona je otišla.", en: "She left. (she is gone)", note: "otići (pf.) — departure completed" },
          { hr: "Pojeli smo cijeli kolač.", en: "We ate the whole cake.", note: "pojesti (pf.) — cake finished" },
          { hr: "Pročitao je cijelu knjigu.", en: "He read the whole book.", note: "pročitati (pf.) — book done" },
        ],
      },
      {
        type: "rule",
      ...
      },
      {
        ...
        items: [
          { hr: "Ušao je, pogledao okolo i sjeo.", en: "He entered, looked around, and sat down.", note: "ući/pogledati/sjesti — 3 plot events, all pf." },
          { hr: "Uzela je kaput i izašla.", en: "She took her coat and left.", note: "uzeti/izaći — sequential events, both pf." },
          { hr: "Popio je kavu, platio i otišao.", en: "He drank his coffee, paid, and left.", note: "popiti/platiti/otići — classic narrative chain" },
        ],
      },
      {
        type: "rule",
      ...
      },
      {
        ...
        items: [
          { hr: "Nazvat ću te sutra.", en: "I will call you tomorrow. (one call, done)", note: "nazvati (pf.) — specific planned event" },
          { hr: "Zvat ću te cijelo ljeto.", en: "I will be calling you all summer.", note: "zvati (impf.) — ongoing/repeated future" },
          { hr: "Pročitat ću tu knjigu za tjedan dana.", en: "I'll finish reading that book in a week.", note: "pročitati (pf.) — completion implied" },
          { hr: "Čitat ću svaki dan.", en: "I will read every day.", note: "čitati (impf.) — habitual future" },
        ],
      },
      {
        type: "quiz",
        q: "In the sentence 'He entered the room, sat down, and opened his laptop' — what aspect are ALL the verbs?",
        options: ["All imperfective — ongoing background", "All perfective — sequential plot events", "Mixed: first two imperfective, last perfective", "It depends on whether he finished"],
        correct: 1,
        explanation: "Sequential narrative events that advance the story are ALWAYS perfective: ušao je (pf.), sjeo je (pf.), otvorio je (pf.). This is the rule of narrative: imperfective sets the scene, perfective drives the plot.",
      },
      {
        type: "quiz",
        ...
        correct: 1,
        explanation: "'Napisao sam pismo i poslao ga' — perfective 'napisati' (write to completion) + 'poslati' (send) form a narrative chain of completed events. Option A is wrong: 'svaki dan' requires imperfective. Option C's situation requires imperfective for the background action.",
      },
      {
        type: "summary",
        title: "Perfective — When to Use It",
  ...
  // ─────────────────────────────────────────────────────────
  {
    ...
    slides: [
      ...
      },
      {
        ...
        items: [
          { hr: "Nisam čitao tu knjigu.", en: "I didn't read that book. (at all)", note: "čitati (impf.) — standard negation; reading never happened" },
          { hr: "Nisam pročitao tu knjigu.", en: "I didn't finish reading that book.", note: "pročitati (pf.) — implies I started but didn't complete it" },
          { hr: "Nije jela ništa.", en: "She didn't eat anything.", note: "jesti (impf.) — no eating occurred at all" },
          { hr: "Nije pojela sve.", en: "She didn't eat everything.", note: "pojesti (pf.) — she ate some, not all (not complete)" },
        ],
      },
      {
        type: "rule",
      ...
      },
      {
        ...
        items: [
          { hr: "Govori sporije! (impf.)", en: "Speak more slowly! (general instruction — do it as a habit from now on)", note: "general instruction" },
          { hr: "Reci mi svoju adresu! (pf.)", en: "Tell me your address! (do it now, once)", note: "specific, one-time request" },
          { hr: "Pij više vode! (impf.)", en: "Drink more water! (general lifestyle advice)", note: "repeated habit instruction" },
          { hr: "Popij ovu tabletu! (pf.)", en: "Take this tablet! (now, this specific one)", note: "one specific action now" },
        ],
      },
      {
        type: "rule",
      ...
      },
      {
        ...
        items: [
          { hr: "Mogu li otvarati prozor? (impf.)", en: "May I open the window? (asking permission)", note: "impf. — requesting right to do the action" },
          { hr: "Možeš li otvoriti prozor? (pf.)", en: "Can you open the window? (asking them to do it)", note: "pf. — specific one-time request" },
          { hr: "Smijem li pušiti ovdje? (impf.)", en: "May I smoke here? (permission)", note: "impf. — seeking permission for habit" },
          { hr: "Možeš li zatvoriti vrata? (pf.)", en: "Can you close the door? (please do it once)", note: "pf. — requesting a specific action" },
        ],
      },
      {
        type: "rule",
      ...
      },
      {
        ...
        correct: 1,
        explanation: "'Jedi zdravo!' — general lifestyle imperative requires imperfective. 'Eat healthy!' is ongoing advice about a habit, not a one-time request to eat a specific meal. 'Pojedi' (pf.) would mean 'finish eating that specific thing right now' — very different!",
      },
      {
        type: "quiz",
        ...
        correct: 2,
        explanation: "She DID take (polagala) the exam — she just didn't pass (položiti = to pass, perfective). 'Nisam položila' (pf. negative) means 'I tried/took it but didn't successfully complete it.' 'Nisam polagala' would mean she never sat the exam at all — which contradicts the situation.",
      },
      {
        type: "summary",
  ...
  // ─────────────────────────────────────────────────────────
  {
    ...
    slides: [
      ...
      },
      {
        ...
        items: [
          { hr: "Vidim brata.", en: "I see my brother.", note: "brat (masc. animate) → brata (acc.)" },
          { hr: "Vidim grad.", en: "I see the city.", note: "grad (masc. inanimate) → grad (acc., no change)" },
          { hr: "Volim mačku.", en: "I love the cat.", note: "mačka (fem.) → mačku (acc.)" },
          { hr: "Volim more.", en: "I love the sea.", note: "more (neuter) → more (acc., no change)" },
          { hr: "Zovem prijatelja.", en: "I'm calling a friend.", note: "prijatelj (masc. animate) → prijatelja (acc.)" },
          { hr: "Kupujem auto.", en: "I'm buying a car.", note: "auto (masc. inanimate) → auto (acc., no change)" },
        ],
      },
      {
        type: "rule",
      ...
      },
      {
        ...
        items: [
          { hr: "Idem u Zagreb. (acc.)", en: "I'm going to Zagreb. (direction)", note: "motion: u + accusative" },
          { hr: "Živim u Zagrebu. (loc.)", en: "I live in Zagreb. (location)", note: "static: u + locative" },
          { hr: "Sjeo je na stolicu. (acc.)", en: "He sat down on the chair. (motion — onto)", note: "na + accusative = direction" },
          { hr: "Sjedi na stolici. (loc.)", en: "He's sitting on the chair. (location)", note: "na + locative = static" },
        ],
      },
      {
        type: "rule",
      ...
      },
      {
        ...
        correct: 1,
        explanation: "'Profesora' — profesor is masculine animate (a person), so accusative = genitive form: profesor → profesora. This is one of Croatian's most important rules. 'Vidim profesora' = I see the professor.",
      },
      {
        type: "quiz",
        ...
        correct: 1,
        explanation: "'Stavi' (put) indicates movement. 'Na policu' = onto the shelf (accusative, polica → policu). When na implies movement/direction, it takes accusative. When it describes where something statically is, it takes locative ('na polici' = on the shelf).",
      },
      {
        type: "summary",
  ...
  // ─────────────────────────────────────────────────────────
  {
    ...
    slides: [
      ...
      },
      {
        ...
        title: "Nema + Genitive",
        items: [
          { hr: "Nema kave.", en: "There's no coffee.", note: "kava → kave (fem. gen.) after nema" },
      ...
      },
      {
        ...
        correct: 2,
        explanation: "'Iz' (from inside a place) takes the genitive. Zagreb → Zagreba (masculine genitive, -a ending). So: 'Idem iz Zagreba.' Note: 'od Zagreba' would mean 'away from Zagreb' (like a distance), while 'iz Zagreba' means 'from Zagreb' where you lived or were.",
      },
      {
        type: "quiz",
        ...
        correct: 2,
        explanation: "'Nema' always takes the genitive: kava → kave. 'Nema kave u kuhinji' = There's no coffee in the kitchen. This pattern (nema + genitive) is used thousands of times a day in Croatian conversation.",
      },
      {
        type: "summary",
  ...
  // ─────────────────────────────────────────────────────────
  {
    ...
    slides: [
      ...
      },
      {
        ...
        items: [
          { hr: "Dao sam knjugu Ani.", en: "I gave the book to Ana.", note: "Ana → Ani (fem. dat.)" },
          { hr: "Rekla je sestri.", en: "She told her sister.", note: "sestra → sestri (fem. dat.)" },
          { hr: "Pišem prijatelju.", en: "I'm writing to my friend.", note: "prijatelj → prijatelju (masc. dat.)" },
      ...
      },
      {
        ...
        items: [
          { hr: "Živim u Zagrebu.", en: "I live in Zagreb.", note: "Zagreb → Zagrebu (masc. loc.)" },
          { hr: "Knjiga je na stolu.", en: "The book is on the table.", note: "stol → stolu (masc. loc.)" },
          { hr: "Pričamo o moru.", en: "We're talking about the sea.", note: "more → moru (neut. loc.)" },
          { hr: "Šetamo po gradu.", en: "We're walking around the city.", note: "grad → gradu (masc. loc.)" },
        ],
      },
      {
        type: "rule",
      ...
      },
      {
        ...
        items: [
          ...
          { hr: "Rekla mu je istinu.", en: "She told him the truth.", note: "mu = to him (dative clitic)" },
          { hr: "Pišu nam svaki tjedan.", en: "They write to us every week.", note: "nam = to us (dative clitic)" },
      ...
      },
      {
        ...
        correct: 1,
        explanation: "'Idem u grad.' — Direction uses u + accusative. Masculine inanimate 'grad' takes no change in accusative: u grad. 'U gradu' (locative) means 'in the city' (static location). 'Po gradu' (locative) means 'around the city' (movement throughout, different meaning).",
      },
      {
        type: "quiz",
        ...
        correct: 2,
        explanation: "'Poslao sam pismo Ani.' — Ana is the recipient (to whom?), so she takes the dative: Ana → Ani (feminine dative, -a → -i). 'Pismo' (letter) is the direct object in accusative (neuter, no change). 'Anu' would be accusative (direct object), 'Ane' genitive (of Ana).",
      },
      {
        type: "summary",
  ...
  // ─────────────────────────────────────────────────────────
  {
    ...
    slides: [
      ...
      },
      {
        ...
        items: [
          { hr: "Pišem olovkom.", en: "I'm writing with a pencil.", note: "olovka → olovkom (fem. instr.)" },
          { hr: "Putujem vlakom.", en: "I travel by train.", note: "vlak → vlakom (masc. instr.)" },
          { hr: "Jedem vilicom.", en: "I eat with a fork.", note: "vilica → vilicom (fem. instr.)" },
      ...
      },
      {
        ...
        items: [
          ...
          { hr: "Razgovaram s prijateljem.", en: "I'm talking with a friend.", note: "prijatelj → prijateljem (masc. instr.)" },
          { hr: "Živim sa sestrom.", en: "I live with my sister.", note: "sestra → sestrom (fem. instr.); 'sa' before consonant cluster" },
          { hr: "Pije kavu s mlijekom.", en: "She drinks coffee with milk.", note: "mlijeko → mlijekom (neut. instr.)" },
        ],
      },
      {
        type: "rule",
      ...
      },
      {
        ...
        correct: 2,
        explanation: "'Idem s majkom.' — s/sa (with) + instrumental. Majka (mother) is feminine, instrumental ending -om: majka → majkom. This is the accusation for one of Croatian's most common preposition patterns.",
      },
      {
        type: "quiz",
        ...
        correct: 1,
        explanation: "'Plaćam karticom.' — The means (how you pay) = instrumental. Kartica → karticom. No preposition needed — the -om ending alone indicates the instrument. This pattern (means without a preposition) is a key feature of the instrumental case.",
      },
      {
        type: "summary",
  ...
  // ─────────────────────────────────────────────────────────
  {
    ...
    slides: [
      ...
      },
      {
        ...
        items: [
          { hr: "Vidim veliki grad. (acc.)", en: "I see the big city.", note: "masc. inanim. acc. = no change" },
          { hr: "Vidim velikog brata. (acc.)", en: "I see my big brother.", note: "masc. anim. acc. = -og" },
          { hr: "Vidim lijepu ženu. (acc.)", en: "I see a beautiful woman.", note: "fem. acc. = -u" },
          { hr: "Živim u velikom gradu. (loc.)", en: "I live in a big city.", note: "masc. loc. = -om" },
          { hr: "Idem s lijepom ženom. (instr.)", en: "I'm going with a beautiful woman.", note: "fem. instr. = -om" },
        ],
      },
      {
        type: "rule",
      ...
      },
      {
        ...
        correct: 0,
        explanation: "'To je lijepa kuća.' — kuća is feminine (ends in -a), nominative (subject position). Feminine nominative adjective ending = -a. So 'lijep' + -a = 'lijepa'. 'Lijep' (no ending) would be indefinite masculine; 'lijepo' is neuter.",
      },
      {
        type: "quiz",
        ...
        correct: 2,
        explanation: "'Vidim lijepu ženu.' — žena (feminine noun) in accusative = ženu. The adjective must match: feminine accusative = -u ending. So 'lijepa' → 'lijepu'. 'Lijepi' is masculine, 'lijepa' is feminine nominative, 'lijepom' is dative/instrumental feminine.",
      },
      {
        type: "summary",
  ...
  // ─────────────────────────────────────────────────────────
  {
    ...
    slides: [
      ...
      },
      {
        ...
        items: [
          { hr: "Dao sam mu ga.", en: "I gave it to him.", note: "sam (aux) → mu (dat.) → ga (acc.) — correct order" },
          { hr: "Rekla mi je.", en: "She told me.", note: "mi (dat.) → je (aux) — correct" },
          { hr: "Kupit ću ti ga.", en: "I will buy it for you.", note: "ću (aux) → ti (dat.) → ga (acc.)" },
          { hr: "Pokazao bi mi ga.", en: "He would show it to me.", note: "bi (cond.) → mi (dat.) → ga (acc.)" },
        ],
      },
      {
        type: "rule",
      ...
      },
      {
        ...
        items: [
          { hr: "Marija mi je to rekla.", en: "Marija told me that.", note: "'Marija' is the first unit; mi + je follow" },
          { hr: "Moja stara prijateljica mi je to rekla.", en: "My old friend told me that.", note: "entire NP is first unit; mi + je follow" },
          { hr: "Jučer mi je rekla.", en: "She told me yesterday.", note: "'Jučer' (adverb) = first unit; mi + je follow" },
          { hr: "Kad mi je to rekla...", en: "When she told me that...", note: "'Kad' = first unit in subclause" },
        ],
      },
      {
        type: "rule",
      ...
      },
      {
        ...
        items: [
          { hr: "Dao mu je.", en: "He gave it to him.", note: "je = past auxiliary (is in aux slot)" },
          { hr: "Dao mu ga je.", en: "He gave it to him. (explicit 'it')", note: "je = 'is'/identity; comes after ga" },
          { hr: "Rekla mu je.", en: "She told him.", note: "je = aux (she has told)" },
          { hr: "To mu je rekla.", en: "She told him that.", note: "je = aux, to = object before cluster" },
        ],
      },
      {
        type: "quiz",
        ...
        correct: 2,
        explanation: "'Ona mi ga je dala.' — Order: ona (first unit) → mi (dative) → ga (accusative) → je (auxiliary) → dala (participle). The rule: auxiliary comes after dative and accusative pronouns. 'Ona je mi ga dala' is wrong — je cannot precede mi/ga.",
      },
      {
        type: "quiz",
        ...
        correct: 1,
        explanation: "'Moja starija sestra mi je rekla.' — The entire noun phrase 'Moja starija sestra' is the first stressed unit. The clitic cluster (mi je) follows immediately after the complete NP. This is the second-position rule applied to a multi-word first unit.",
      },
      {
        type: "summary",
    ...
    slides: [
      ...
      },
      {
        ...
        rows: [
          ...
          ["putovati", "putovanje", "travelling", "Putovanje širi horizonte. (Travel broadens horizons.)"],
      ...
      },
      {
        ...
        items: [
          { hr: "Knjiga je napisana.", en: "The book has been written.", note: "napisati → napisana (fem. passive part.)" },
          { hr: "Vrata su otvorena.", en: "The doors are open(ed).", note: "otvoriti → otvorena (pl. passive part.)" },
          { hr: "Odluka je donesena.", en: "The decision has been made.", note: "donijeti → donesena (formal news register)" },
          { hr: "Sporazum je potpisan.", en: "The agreement has been signed.", note: "potpisati → potpisan (media/legal)" },
        ],
      },
      {
        type: "rule",
      ...
      },
      {
        ...
        items: [
          { hr: "Idući kroz grad, vidio je prijatelja.", en: "While walking through the city, he saw a friend.", note: "idući = present adverbial (simultaneous)" },
          { hr: "Govoreći o tome, nasmijao se.", en: "Speaking about it, he laughed.", note: "govoreći = present adverbial" },
          { hr: "Otišavši rano, stigla je prva.", en: "Having left early, she arrived first.", note: "otišavši = past adverbial (sequence)" },
        ],
      },
      {
        type: "quiz",
        ...
        correct: 2,
        explanation: "'Putovanje' — the verbal noun is formed by adding -nje to the infinitive stem. Putovati → putova- + -nje = putovanje (travel, travelling). It declines as a neuter noun: putovanje (nom.), putovanju (dat./loc.), putovanjem (instr.), etc.",
      },
      {
        type: "quiz",
        ...
        correct: 3,
        explanation: "'Zakon je usvojen.' — In formal/legal Croatian, 'usvojiti' (to adopt/pass [a law]) → 'usvojen' (passive participle). This is the standard media formula. 'Prošao' means passed physically through; 'prošan' is not a standard form. The passive participle 'usvojen' with 'biti' forms the standard passive voice for formal announcements.",
      },
      {
        type: "summary",
  ...
  // ─────────────────────────────────────────────────────────
  {
    ...
    slides: [
      ...
      },
      {
        ...
        items: [
          { hr: "Pala mu je mrak na oči.", en: "He saw red / lost it.", note: "Lit: 'Darkness fell on his eyes' — rage" },
          { hr: "Čuvaj se kao od vatre.", en: "Avoid it like the plague.", note: "Lit: 'Guard yourself as from fire'" },
          { hr: "Nije mu sve doma.", en: "He's not all there / a bit odd.", note: "Lit: 'Not everything is home in him'" },
          { hr: "Baciti rukavicu.", en: "To throw down the gauntlet.", note: "Lit: 'To throw a glove' — same as English!" },
          { hr: "Igrati se vatrom.", en: "To play with fire.", note: "Same as English — fire idioms cross cultures" },
          { hr: "Svaka čast!", en: "Well done! / Respect!", note: "Lit: 'Every honour!' — extremely common praise" },
        ],
      },
      {
        type: "rule",
      ...
      },
      {
        ...
        items: [
          { hr: "Znači, ti ne znaš.", en: "So, you don't know then.", note: "znači = 'so' / drawing conclusion" },
          { hr: "Eto, tako je.", en: "There you have it, that's how it is.", note: "eto = presenting a conclusion" },
          { hr: "Pa, nisam siguran.", en: "Well, I'm not sure.", note: "pa = hedging / 'well'" },
          { hr: "Baš si u pravu.", en: "You're exactly right.", note: "baš = emphasis ('exactly', 'really')" },
      ...
      },
      {
        ...
        rows: [
          ...
          ["Tko rano rani, dvije sreće grabi.", "Who rises early grabs two fortunes.", "The early bird catches two worms."],
          ["Svaka ptica svojem jatu leti.", "Every bird flies to its own flock.", "Birds of a feather flock together."],
          ["Nema ruže bez trnja.", "No rose without thorns.", "No rose without thorns."],
          ["U zdravom tijelu zdrav duh.", "In a healthy body, a healthy spirit.", "A healthy mind in a healthy body."],
          ["Nije zlato sve što sja.", "Not all that glitters is gold.", "All that glitters is not gold."],
          ["Sitna kap kamen dubi.", "A tiny drop hollows stone.", "Constant dripping wears the stone."],
        ],
      },
      {
        type: "quiz",
        ...
        correct: 1,
        explanation: "'Svaka čast!' (literally 'every honour') is one of the most common expressions of genuine admiration and respect in Croatian. It's used exactly as English 'Well done!' or 'Respect!' — sincere, warm, and very frequent among friends and family.",
      },
      {
        type: "quiz",
        ...
        correct: 1,
        explanation: "'Hej, gdje je kolodvor? Znaš li?' — uses 'hej' (informal greeting), ti-form 'znaš', and direct question structure. Option A uses the polite 'Vi' form. Option C is bureaucratic/formal. Option D is polite neutral. The colloquial marker is the ti-form 'znaš' and the casual opener 'Hej'.",
      },
      {
        type: "summary",
