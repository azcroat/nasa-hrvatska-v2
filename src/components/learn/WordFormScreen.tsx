    ...
    <div className="scr-wrap">
      ...
      <div className="c" style={{ marginBottom: 20 }}>
          ...
          {WORDFORM.prefixes.map(function(p, pi) {
            return (
              <button
                ...
                style={{ padding: '8px 4px', fontSize: 14, background: 'none', border: 'none', cursor: 'pointer', textAlign: 'left', fontFamily: "'Outfit',sans-serif" }}
                onClick={function() { speak(p.verb); }}
              >
        ...
        <div style={{ marginTop: 12 }}>
          {WORDFORM.prefixes.map(function(p, pi) {
            return (
              <div key={pi} style={{ fontSize: 12, color: 'var(--subtext)', marginBottom: 4, paddingLeft: 8, borderLeft: '2px solid #e0f2fe' }}>
              ...
              {b.pairs.map(function(p, pi) {
                return (
                  <button
                    ...
                    style={{ padding: '6px 0', fontSize: 14, background: 'none', border: 'none', cursor: 'pointer', textAlign: 'left', fontFamily: "'Outfit',sans-serif" }}
