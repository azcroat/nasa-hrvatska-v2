...
export default function TensesScreen({ goBack, award }) {
  ...
  return (
    <div className="scr-wrap">
      {H(
        '🔄 Tenses & Gender',
        'Past / Present / Future — How men & women speak differently',
        goBack,
      )}
            ...
            {TENSES.verbs.map((v, i) => (
              <button
                ...
                style={{
                  padding: '6px 12px',
                  borderRadius: 10,
                  border: '2px solid ' + (tnVerb === i ? '#164e63' : '#e7e5e4'),
                  background: tnVerb === i ? '#164e63' : 'white',
                  color: tnVerb === i ? 'white' : '#44403c',
                  fontWeight: 600,
                  fontSize: 12,
                  cursor: 'pointer',
                }}
            ...
            return (
              <React.Fragment>
                <div
                  ...
                  style={{
                    marginBottom: 12,
                    borderLeft: '4px solid ' + (tnGender === 'm' ? '#0e7490' : '#dc2626'),
                    padding: 0,
                    overflow: 'hidden',
                  }}
                >
                  ...
                  >
                    ...
                    <div style={{ fontSize: 13, opacity: 0.85, marginTop: 2 }}>
                      {tenseLabel} • {tnGender === 'm' ? 'Speaking as male' : 'Speaking as female'}
                    </div>
                  </div>
                      ...
                      {forms.map((f, fi) => {
                        ...
                        return (
                          <tr
                            ...
                            role="button"
                            tabIndex={0}
                            aria-label={`Play audio for ${TENSES.persons[fi]} ${f}`}
                            style={{
        ...
        <React.Fragment>
          ...
          >
            ...
            <div style={{ fontSize: 14, marginTop: 6, lineHeight: 1.7 }}>
              In Croatian, the PAST TENSE changes based on the speaker's gender. If you are a man,
              you say 'Išao sam' (I went). If you are a woman, you say 'Išla sam.' This is one of
              the FIRST things Croatians notice about your Croatian. Getting it right marks you as a
              serious learner.
            </div>
          </div>
              ...
              <div className="c" style={{ marginTop: 16 }}>
                <div style={{ display: 'flex', gap: 8, marginBottom: 8 }}>
                  ...
                  <span
                    style={{
                      padding: '3px 10px',
                      background: q.gender === 'm' ? 'rgba(14,116,144,.1)' : 'rgba(220,38,38,.08)',
                      borderRadius: 10,
                      fontSize: 12,
                      fontWeight: 700,
