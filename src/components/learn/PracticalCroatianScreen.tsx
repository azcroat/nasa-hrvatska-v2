...
const SCENARIOS = [
  {
    ...
    phrases: [
      ...
      {
        hr: 'Dajte mi, molim, kilu jabuka.',
        en: 'Give me, please, a kilo of apples.',
        note: 'Market shopping',
      },
      ...
      { hr: 'Gdje je kasa?', en: 'Where is the checkout?', note: 'Finding the till' },
      {
        ...
        note: 'Always say this leaving a shop',
      },
    ...
    dialogue: [
      {
        role: 'A',
        speaker: 'You',
        text: 'Dobar dan! Imate li svježe kruha?',
        trans: 'Good day! Do you have fresh bread?',
      },
      {
        role: 'B',
        speaker: 'Shopkeeper',
        text: 'Imamo, naravno. Bijeli ili crni?',
        trans: 'We do, of course. White or dark?',
      },
      {
        role: 'A',
        speaker: 'You',
        text: 'Bijeli, molim. I kilu jabuka.',
        trans: 'White, please. And a kilo of apples.',
      },
      {
        role: 'B',
        speaker: 'Shopkeeper',
        text: 'To je petnaest kuna ukupno.',
        trans: 'That is fifteen kuna in total.',
      },
      { role: 'A', speaker: 'You', text: 'Mogu li platiti karticom?', trans: 'Can I pay by card?' },
      {
        role: 'B',
        speaker: 'Shopkeeper',
        text: 'Može, naravno. Hvala lijepa!',
        trans: 'Of course. Thank you very much!',
      },
    ],
    quiz: [
      {
        q: 'How do you ask "How much does it cost?"',
        options: ['Koliko košta?', 'Gdje je kasa?', 'Imate li?', 'Hvala.'],
        ans: 0,
      },
      {
        q: 'Which phrase means "Can I pay by card?"',
        options: [
          'Ima li popusta?',
    ...
    dialogue: [
      {
        role: 'A',
        speaker: 'You',
        text: 'Dobar dan. Ne osjećam se dobro.',
        trans: 'Good day. I do not feel well.',
      },
      { role: 'B', speaker: 'Doctor', text: 'Što vas boli?', trans: 'What is hurting you?' },
      {
        ...
        trans: 'My throat hurts and I have a fever.',
      },
      {
        role: 'B',
        speaker: 'Doctor',
        text: 'Od kada imate temperaturu?',
        trans: 'Since when have you had a fever?',
      },
      {
        role: 'A',
        speaker: 'You',
        text: 'Od jučer. Alergičan sam na penicilin.',
        trans: 'Since yesterday. I am allergic to penicillin.',
      },
      {
        role: 'B',
        speaker: 'Doctor',
        text: 'Dat ću vam recept za antibiotike.',
        trans: 'I will give you a prescription for antibiotics.',
      },
    ],
    quiz: [
      {
        q: '"Boli me glava" means:',
        options: ['I have a fever', 'My head hurts', 'I need a doctor', 'I am allergic'],
        ans: 1,
      },
      {
        q: 'How do you say "I am allergic to..."?',
        options: [
          'Imam temperaturu',
          'Trebam liječnika',
          'Alergičan/a sam na...',
      ...
      {
        q: 'What does "Gdje je ljekarna?" mean?',
        options: [
          'Where is the doctor?',
  ...
  },
  {
    ...
    phrases: [
      ...
      {
        hr: 'Gdje se prijavljujem za boravišnu dozvolu?',
        en: 'Where do I register for a residence permit?',
        note: 'Key phrase',
      },
      {
        hr: 'Trebam ovjeriti dokument.',
        en: 'I need to certify a document.',
        note: 'Notarisation',
      },
      {
        hr: 'Mogu li dobiti potvrdu?',
        en: 'Can I get a confirmation?',
        note: 'Requesting official docs',
      },
      {
        hr: 'Koji su potrebni dokumenti?',
        en: 'Which documents are needed?',
        note: 'Always ask this first',
      },
      {
        hr: 'Nisam razumio/razumjela. Možete li ponoviti?',
        en: "I didn't understand. Can you repeat?",
        note: 'Essential polite phrase',
      },
      ...
      {
        hr: 'Mogu li zakupiti termin?',
        en: 'Can I book an appointment?',
        note: 'Most offices require this',
      },
    ],
    dialogue: [
      {
        role: 'A',
        speaker: 'You',
        text: 'Dobar dan. Trebam produžiti vizu.',
        trans: 'Good day. I need to extend my visa.',
      },
      {
        role: 'B',
        speaker: 'Official',
        text: 'Imate li sve potrebne dokumente?',
        trans: 'Do you have all the necessary documents?',
      },
      {
        role: 'A',
        speaker: 'You',
        text: 'Koji su potrebni dokumenti?',
        trans: 'Which documents are needed?',
      },
      {
        role: 'B',
        speaker: 'Official',
        text: 'Putovnica, dokaz o smještaju i financijsko jamstvo.',
        trans: 'Passport, proof of accommodation and financial guarantee.',
      },
      {
        role: 'A',
        speaker: 'You',
        text: 'Nisam razumio. Možete li ponoviti?',
        trans: "I didn't understand. Can you repeat?",
      },
      {
        role: 'B',
        speaker: 'Official',
        text: 'Naravno. Trebate putovnicu i potvrdu o smještaju.',
        trans: 'Of course. You need your passport and accommodation confirmation.',
      },
    ],
    quiz: [
      {
        q: 'How do you say "I need to extend my visa"?',
        options: [
          'Trebam prevoditelja.',
          'Trebam produžiti vizu.',
          'Koji su dokumenti?',
      ...
      {
        q: '"Nisam razumio/razumjela" means:',
        options: [
          'I need a translator',
          "I didn't understand",
          'Can you repeat?',
  ...
  },
  {
    ...
    phrases: [
      {
        hr: 'Drago mi je što te vidim!',
        en: 'I am glad to see you!',
        note: 'Informal greeting for family',
      },
      {
        hr: 'Kako si? / Kako ste?',
        en: 'How are you? (informal/formal)',
        note: 'Ti vs Vi difference shown',
      },
      { hr: 'Mnogo mi nedostaješ.', en: 'I miss you a lot.', note: 'Emotional, diaspora context' },
      {
        hr: 'Ostajete li na večeru?',
        en: 'Are you staying for dinner?',
        note: 'Very common invitation',
      },
      {
        hr: 'Hvala na gostoprimstvu.',
        en: 'Thank you for your hospitality.',
        note: 'After a visit',
      },
      { hr: 'Koji si razred?', en: 'What grade are you in?', note: 'Asking children' },
      {
        hr: 'Kako ti ide škola?',
        en: 'How is school going for you?',
        note: 'Informal family chat',
      },
      {
        hr: 'Baka, pomaži me malo.',
        en: 'Grandma, help me a little.',
        note: 'Diminutive baka = grandma',
      },
    ...
    dialogue: [
      {
        role: 'A',
        speaker: 'You',
        text: 'Baka, drago mi je što te vidim!',
        trans: 'Grandma, I am so glad to see you!',
      },
      {
        role: 'B',
        speaker: 'Grandma',
        text: 'I meni, srce moje! Kako si?',
        trans: 'Me too, my heart! How are you?',
      },
      {
        role: 'A',
        speaker: 'You',
        text: 'Dobro, hvala. Mnogo mi nedostajete.',
        trans: 'Good, thank you. I miss you all so much.',
      },
      {
        role: 'B',
        speaker: 'Grandma',
        text: 'Ostajete li na večeru? Pravim sarmu.',
        trans: 'Are you staying for dinner? I am making sarma.',
      },
      {
        role: 'A',
        speaker: 'You',
        text: 'Naravno! Sarmu obožavam!',
        trans: 'Of course! I love sarma!',
      },
      {
        role: 'B',
        speaker: 'Grandma',
        text: 'Odlično. Dođite za sat vremena.',
        trans: 'Excellent. Come in an hour.',
      },
    ],
    quiz: [
      {
        q: '"Mnogo mi nedostaješ" means:',
        options: ['I love you', 'I miss you a lot', 'I am glad to see you', 'Take care'],
        ans: 1,
      },
      {
        q: 'What is the formal way to say "How are you?"',
        options: ['Kako si?', 'Kako je?', 'Kako ste?', 'Kako ti je?'],
        ans: 2,
      },
      {
        q: '"Čuvaj se!" means:',
        options: ['Come again!', 'Thank you!', 'Goodbye!', 'Take care of yourself!'],
        ans: 3,
      },
    ],
  },
    ...
    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 }}>
      {SCENARIOS.map((s) => (
        ...
        >
          ...
          <div
            style={{ fontSize: 11, color: 'var(--subtext)', fontStyle: 'italic', lineHeight: 1.3 }}
          >
            {s.titleEn}
          </div>
      ...
      {phrases.map((p: Phrase, i: number) => (
        ...
        >
          <div style={{ flex: 1, minWidth: 0 }}>
            ...
            <div style={{ fontSize: 13, color: 'var(--subtext)', marginBottom: 4 }}>{p.en}</div>
            <div
              style={{ fontSize: 11, color: 'var(--subtext)', fontStyle: 'italic', opacity: 0.75 }}
            >
              {p.note}
            </div>
          </div>
...
function LearnView({
  ...
  return (
    <div>
      {/* Header */}
      <div
        style={{ marginBottom: 20, paddingBottom: 16, borderBottom: '1px solid rgba(0,0,0,.06)' }}
      >
        <button
          onClick={onBack}
          style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
          ...
          <div>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 6, marginTop: 4 }}>
              <span style={{ fontSize: 12, color: 'var(--subtext)', fontStyle: 'italic' }}>
                {scenario.titleEn}
              </span>
    ...
    return (
      <div>
        ...
        >
          ...
          {perfect && (
            <div
              style={{ marginTop: 10, fontSize: 12, color: 'var(--subtext)', fontStyle: 'italic' }}
            >
              🎊 Confetti! Savršeno!
            </div>
          )}
    ...
    <div className="scr-wrap">
      {view === 'menu' && (
        <>
          ...
          >
            💡 Four scenarios diaspora and visitors need most. Learn phrases, follow the dialogue,
            then test yourself.
          </div>
      ...
      {view === 'learn' && scenario && (
        <LearnView scenario={scenario} onStartQuiz={handleStartQuiz} onBack={handleBackToMenu} />
      )}

      {view === 'quiz' && scenario && <QuizView scenario={scenario} onBack={handleBackToLearn} />}
    </div>
  );
}
