        ...
        return (
          <div key={i} className="c" style={{ marginBottom: 10 }}>
            <div style={{ display: 'flex', justifyContent: 'space-between' }}>
              ...
              >
                {p.impf} <span aria-hidden="true">🔊</span>
              </button>
              <button
              ...
              >
                {p.perf} <span aria-hidden="true">🔊</span>
              </button>
            </div>
  ...
  return (
    <div className="scr-wrap">
      ...
      <div style={{ display: 'flex', flexWrap: 'wrap', gap: 6, marginBottom: 16 }}>
        {DECL.nouns.map(function (noun, i) {
          return (
            <button
              key={i}
      ...
      <table style={{ width: '100%', borderCollapse: 'collapse' }}>
        <tbody>
          {DECL.caseNames.map(function (cs, ci) {
            return (
              <tr
                key={ci}
  ...
  return (
    <div className="scr-wrap">
      ...
      <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: 13 }}>
        <thead>
          <tr>
            {['English', 'Što', 'Kaj', 'Ča'].map(function (h, i) {
              return (
                <th
                  key={i}
            ...
            return (
              ...
              >
                <span style={{ fontWeight: 700, color: '#0e7490' }}>
                  {p.prefix}
                  {p.verb} <span aria-hidden="true">🔊</span>
                </span>
                {' — '}
