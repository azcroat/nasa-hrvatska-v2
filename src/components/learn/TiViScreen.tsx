...
const SITUATIONS = [
  ...
  },
  {
    ...
    formal: {
      hr: 'Dopustite da se predstavim — zovem se [ime].',
      en: 'Allow me to introduce myself — my name is [name].',
    },
  ...
  },
  {
    ...
    formal: {
      hr: 'Oprostite, možete li mi reći gdje je WC?',
      en: 'Excuse me, could you tell me where the WC is?',
    },
  ...
  },
  {
    ...
    informal: {
      hr: 'Ne razumijem. Možeš to ponoviti?',
      en: "I don't understand. Can you repeat that?",
    },
    formal: {
      hr: 'Žao mi je, ne razumijem. Možete li govoriti sporije?',
      en: "I'm sorry, I don't understand. Could you speak more slowly?",
    },
  ...
  return (
    <div>
      ...
      >
        ...
        >
          When in doubt, use <strong>Vi</strong>. Croatians will invite you to switch to <em>ti</em>{' '}
          if they want to — it's a warm social gesture.
        </div>
      </div>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
        {displayed.map((s, i) => (
          <div
            ...
            style={{
              background: 'var(--card)',
              border: `1.5px solid ${selected === i ? '#0e7490' : 'var(--card-b)'}`,
              borderRadius: 14,
              overflow: 'hidden',
            ...
            {selected === i && (
              <div style={{ borderTop: '1px solid var(--card-b)' }}>
                ...
                >
                  ...
                  <button
                    aria-label={`Play audio for ${s.informal.hr}`}
                    onClick={() => speak(s.informal.hr)}
                    style={{
                      display: 'flex',
                      alignItems: 'center',
                      gap: 8,
                ...
                >
                  ...
                  <button
                    aria-label={`Play audio for ${s.formal.hr}`}
                    onClick={() => speak(s.formal.hr)}
                    style={{
                      display: 'flex',
                      alignItems: 'center',
                      gap: 8,
      ...
      >
        🇭🇷 Most Croatians will switch to informal <em>ti</em> quickly once rapport is established.
        Follow their lead.
      </div>
    </div>
  );
