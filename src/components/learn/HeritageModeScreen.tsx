...
const GAP_AREAS = [
  {
    ...
    modules: [
      { label: 'Alphabet & Pronunciation', scr: 'alphabet' },
      { label: 'Pronunciation Course', scr: 'pronunciation_course' },
    ],
  },
  {
    id: 'cases',
    ...
    weakness:
      'Heritage speakers use nominative for everything — "Vidim mama" instead of "Vidim mamu"',
    modules: [
      { label: 'Case System', scr: 'padezi' },
      { label: 'Case Transformer', scr: 'casetransformer' },
    ],
  },
  {
    id: 'verbs',
    ...
    modules: [
      { label: 'Verb Drill', scr: 'verbdrill' },
      { label: 'Tenses', scr: 'tenses' },
    ],
  },
  {
    id: 'aspect',
  ...
  },
  {
    ...
    modules: [
      { label: 'Writing Practice', scr: 'writing' },
      { label: 'Grammar Reference', scr: 'grammar-ref' },
    ],
  },
];
...
export default function HeritageModeScreen({ goBack, award }) {
  ...
  useEffect(() => {
    ...
    try {
      localStorage.setItem('nh_heritage_mode', 'true');
    } catch {}
  }, []);
    ...
    return (
      <div>
        ...
        >
          ...
          <div style={{ fontSize: 20, fontWeight: 900, marginBottom: 6, lineHeight: 1.2 }}>
        ...
        {allChecked && !checkDone && (
          <div
            style={{
              background: 'linear-gradient(135deg,rgba(22,163,74,.1),rgba(21,128,61,.08))',
          ...
          >
            ...
            <div
              style={{ fontSize: 13, color: 'var(--subtext)', lineHeight: 1.6, marginBottom: 14 }}
            >
              {knownCount >= 12
      ...
      <div>
        ...
        >
          ...
          <div style={{ fontSize: 20, fontWeight: 900, marginBottom: 6 }}>
            Your Dialect Connection
          </div>
          <div style={{ fontSize: 13, color: 'rgba(255,255,255,.85)', lineHeight: 1.5 }}>
            Croatian has 3 major dialects. Your family's region shapes the Croatian you grew up
            hearing.
          </div>
        </div>
          ...
          return (
            <button
              ...
              onClick={() => {
                ...
                try {
                  localStorage.setItem('nh_dialect', d.id);
                } catch {}
              }}
              style={{
                width: '100%',
            ...
            >
                ...
                <div>
                  <div
                    style={{
                      fontWeight: 800,
                      fontSize: 14,
                      color: active ? 'var(--info)' : 'var(--heading)',
                    }}
                  >
                    {d.name}
                  </div>
              ...
              <div style={{ fontSize: 11, color: 'var(--subtext)', marginTop: 4, lineHeight: 1.4 }}>
                {d.note}
              </div>
            </button>
          );
            ...
            {chosen.comparisons.map((c, i) => (
              <div
                ...
                style={{
                  ...
                  gap: 4,
                  padding: '6px 0',
                  borderTop: i === 0 ? 'none' : '1px solid var(--info-b)',
                }}
              >
    ...
    return (
      <div>
        ...
        >
          ...
          <div style={{ fontSize: 13, color: 'rgba(255,255,255,.85)', lineHeight: 1.5 }}>
            Heritage learners have strong listening — but where do you want to improve? Rate your
          ...
          return (
            ...
            >
              <div style={{ display: 'flex', alignItems: 'flex-start', gap: 10, marginBottom: 8 }}>
                ...
                <div style={{ flex: 1 }}>
                  <div style={{ fontWeight: 800, fontSize: 14, color: 'var(--heading)' }}>
                    {g.label}
                  </div>
              ...
              <div style={{ display: 'flex', gap: 6, alignItems: 'center' }}>
                <span
                  style={{ fontSize: 11, color: 'var(--subtext)', fontWeight: 600, marginRight: 4 }}
                >
                  My confidence:
                </span>
                {[1, 2, 3].map((v) => (
                  <button
                    ...
                    style={{
                      ...
                      height: 36,
                      borderRadius: 8,
                      border: `1.5px solid ${rating >= v ? 'var(--warning)' : 'var(--card-b)'}`,
        ...
        {allRated && (
          <div
            style={{
              background: 'linear-gradient(135deg,rgba(91,33,182,.08),rgba(124,58,237,.06))',
          ...
          >
            <div
              style={{ fontWeight: 800, fontSize: 14, color: 'var(--heading)', marginBottom: 8 }}
            >
              {weakAreas.length > 0
            ...
            <div
              style={{ fontSize: 12, color: 'var(--subtext)', lineHeight: 1.5, marginBottom: 12 }}
            >
              {weakAreas.length > 0
    ...
    return (
      <div>
        ...
        >
          ...
          <div style={{ fontSize: 13, color: 'rgba(255,255,255,.85)', lineHeight: 1.5 }}>
            The phrases diaspora people desperately want for family visits. Tap the speaker to hear
            pronunciation.
          </div>
        </div>
        ...
        {BAKA_PHRASES.map((p, i) => {
          ...
          return (
            ...
            >
              <div
                style={{ fontWeight: 800, fontSize: 15, color: 'var(--heading)', marginBottom: 4 }}
              >
                {p.hr}
              </div>
        ...
        <div style={{ textAlign: 'center', padding: '32px 16px' }}>
          ...
          >
            ...
            <div style={{ fontSize: 13, color: 'var(--subtext)', lineHeight: 1.6 }}>
              You've set up Heritage Mode, assessed your dialect background, identified your
              learning gaps, and saved key phrases for your next family visit. +75 XP earned.
            </div>
          </div>
    ...
    <div className="scr-wrap">
      ...
      >
        ...
        <div style={{ fontSize: 13, color: 'rgba(255,255,255,.85)', lineHeight: 1.6 }}>
          You grew up with Croatian voices, food, and family. This mode activates what's already
          there.
        </div>
      </div>
