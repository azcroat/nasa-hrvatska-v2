...
import { CASE_INFO, GENDER_COLOR, GENDER_BG, GENDER_LABEL, CT_STYLES } from './CaseTransformerData.js';

export default function CaseTransformerDeclension({ selectedNoun, declined, number, setNumber, onBackToPicker, onStartQuiz }) {
