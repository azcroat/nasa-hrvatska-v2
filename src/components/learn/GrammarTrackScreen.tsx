...
const LEVELS = [
  {
    ...
    units: [
      { id: 'gender',      icon: '♂️♀️', title: 'Noun Gender',        desc: 'Masculine, feminine, neuter — the foundation',       screen: 'genderdrill',  qs: 30 },
      { id: 'pronouns',    icon: '👤',   title: 'Personal Pronouns',   desc: 'Ja, ti, on, ona, mi, vi, oni — all cases',           screen: 'pronouns',     qs: 15 },
      { id: 'qwords',      icon: '❓',   title: 'Question Words',       desc: 'Tko, Što, Gdje, Kada, Zašto, Kako, Kamo',           screen: 'qwords',       qs: 18 },
      { id: 'negation',    icon: '❌',   title: 'Basic Negation',       desc: 'Ne, nije, nisam — how to say no',                   screen: 'negation',     qs: 14 },
      { id: 'possess',     icon: '🤝',   title: 'Possessives',         desc: 'Moj, tvoj, njegov, njezin, naš, vaš',               screen: 'possess',      qs: 18 },
    ],
  },
  {
    id: 'A2',
    ...
    units: [
      { id: 'sentbuild',   icon: '🏗️',  title: 'Sentence Building',   desc: 'Word order in Croatian — SVO and beyond',            screen: 'sentbuild',    qs: 42 },
      { id: 'coloragree',  icon: '🎨',  title: 'Adjective Agreement',  desc: 'Colors and adjectives match noun gender',            screen: 'coloragree',   qs: 25 },
      { id: 'ordinals',    icon: '🔢',  title: 'Ordinal Numbers',      desc: 'First, second, third — in all genders',             screen: 'ordinals',     qs: 15 },
      { id: 'verbdrill',   icon: '💪',  title: '20 Core Verbs',        desc: 'The most-used Croatian verbs conjugated',           screen: 'verbdrill',    qs: 20 },
  ...
  },
  {
    ...
    units: [
      { id: 'padezi',      icon: '⚙️',  title: 'The 7 Cases',          desc: 'NOM / GEN / DAT / AKU / VOK / LOK / INS',           screen: 'padezi',       qs: 15 },
      { id: 'akudrill',    icon: '🍽️',  title: 'Accusative Case',      desc: 'Direct objects — the most-used case',               screen: 'akudrill',     qs: 15 },
      { id: 'future',      icon: '🚀',  title: 'Future Tense',         desc: 'Ću, ćeš, će — simple future construction',          screen: 'future',       qs: 20 },
      { id: 'reflexive',   icon: '🧲',  title: 'SE Reflexive Verbs',   desc: 'Volim se, zovem se, naći se — essential',           screen: 'reflexive',    qs: 10 },
      { id: 'comparatives',icon: '📈',  title: 'Comparatives',         desc: 'Veći, manji, brži — bigger, smaller, faster',       screen: 'comparatives', qs: 15 },
      { id: 'sibil',       icon: '🔄',  title: 'Sibilarization',       desc: 'k→c, g→z sound changes in plural & dative',        screen: 'sibil',        qs: 15 },
      { id: 'relpron',     icon: '🔗',  title: 'Relative Pronouns',    desc: 'Koji, koja, koje — the man who, the woman that',    screen: 'relpron',      qs: 15 },
      { id: 'imperative',  icon: '⚡',  title: 'Imperative Mood',      desc: 'Commands: Daj!, Idi!, Čekaj!, Reci!',              screen: 'imperative',   qs: 22 },
      { id: 'numcases',    icon: '🔢',  title: 'Numbers + Cases',      desc: '1/2-4/5+ case agreement — mastered for good',       screen: 'numcases',     qs: 24 },
      { id: 'neggen',      icon: '❌',  title: 'Negation + Genitive',  desc: 'Nemam vremena — negation shifts accusative→genitive', screen: 'neggen',     qs: 20 },
    ],
  },
  {
    id: 'B2',
    ...
    units: [
      { id: 'padezifull',  icon: '📚',  title: 'Full Declension Tables', desc: 'All noun & adjective paradigms in one place',      screen: 'padezifull',   qs: 20 },
      { id: 'clitic',      icon: '🔗',  title: 'Clitic Ordering',       desc: "Wackernagel's law — the hardest rule in Croatian",  screen: 'clitic',       qs: 22 },
      { id: 'aspect',      icon: '⏳',  title: 'Verbal Aspect',         desc: 'Perfective vs imperfective — the core of Croatian', screen: 'aspect',       qs: 16 },
      { id: 'aspectdrill', icon: '🔄',  title: 'Aspect Drill',          desc: 'Pisati/napisati — drilled until natural',           screen: 'aspectdrill',  qs: 25 },
      { id: 'conditional', icon: '🤔',  title: 'Conditional',          desc: 'Bi + past participle — I would, you would',         screen: 'conditional',  qs: 15 },
      { id: 'tenses',      icon: '🕰️',  title: 'All Tenses',           desc: 'Present, past, future, conditional — full chart',   screen: 'tenses',       qs: 10 },
      { id: 'modal',       icon: '💬',  title: 'Modal Verbs',           desc: 'Moći, morati, smjeti, trebati, htjeti',             screen: 'modal',        qs: 15 },
      { id: 'svojmoj',     icon: '🔄',  title: 'Svoj vs Moj',           desc: 'The reflexive possessive — tiny but critical',      screen: 'svojmoj',      qs: 15 },
    ],
  },
];
  ...
  return (
    <div className="scr-wrap" style={{ paddingBottom: 24 }}>
      ...
      <div style={{
        ...
        <div style={{ fontSize: 13, color: 'rgba(255,255,255,.65)', marginBottom: 14 }}>A1 → B2 · 38 units · Structured grammar progression</div>
            ...
            >
              ...
              <div style={{
                ...
                {isNext && !isDone && (
                  <div style={{
                    position: 'absolute', bottom: -4, right: -4,
                    width: 18, height: 18, borderRadius: '50%',
                    background: level.color, border: '2px solid var(--card)',
                    display: 'flex', alignItems: 'center', justifyContent: 'center',
                    fontSize: 9, color: 'white', fontWeight: 900,
                  }}>▶</div>
                )}
              ...
              <div style={{ flex: 1, minWidth: 0 }}>
                <div style={{ fontSize: 14, fontWeight: 800, color: 'var(--heading)', lineHeight: 1.2 }}>
                  {unit.title}
                  {isNext && !isDone && (
                    <span style={{ marginLeft: 6, fontSize: 9, fontWeight: 900, color: level.color,
                      background: level.color + '18', padding: '2px 5px', borderRadius: 4, textTransform: 'uppercase', letterSpacing: '.08em' }}>
                      Up next
                    </span>
                  )}
                </div>
                ...
                {unit.qs && (
                  <div style={{ fontSize: 10, color: 'var(--subtext)', marginTop: 4, fontWeight: 600 }}>
                    {unit.qs} exercises
                  </div>
                )}
              </div>
              ...
              <div style={{
                ...
                background: isDone ? 'var(--success-bg)' : isNext ? level.color + '15' : 'var(--bar-bg)',
