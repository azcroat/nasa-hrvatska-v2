...
export function declineNoun(noun) {
  ...
  if (noun.gender === 'm') {
    if (noun.type === 'animate') {
      const stems = {
        otac: {
          sg: ['otac', 'oca', 'ocu', 'oca', 'oče!', 'ocu', 'ocem'],
          pl: ['očevi', 'očeva', 'očevima', 'očeve', 'očevi!', 'očevima', 'očevima'],
        },
        muškarac: {
          sg: [
            'muškarac',
        ...
        pas: {
          sg: ['pas', 'psa', 'psu', 'psa', 'pse!', 'psu', 'psom'],
      ...
      const specialM = {
        grad: {
          sg: ['grad', 'grada', 'gradu', 'grad', 'grade!', 'gradu', 'gradom'],
          pl: ['gradovi', 'gradova', 'gradovima', 'gradove', 'gradovi!', 'gradovima', 'gradovima'],
        },
        auto: {
          sg: ['auto', 'auta', 'autu', 'auto', 'auto!', 'autu', 'autom'],
          pl: ['auti', 'auta', 'autima', 'aute', 'auti!', 'autima', 'autima'],
        },
        prozor: {
          sg: ['prozor', 'prozora', 'prozoru', 'prozor', 'prozore!', 'prozoru', 'prozorom'],
          pl: ['prozori', 'prozora', 'prozorima', 'prozore', 'prozori!', 'prozorima', 'prozorima'],
        },
        jezik: {
          sg: ['jezik', 'jezika', 'jeziku', 'jezik', 'jeziku!', 'jeziku', 'jezikom'],
          pl: ['jezici', 'jezika', 'jezicima', 'jezike', 'jezici!', 'jezicima', 'jezicima'],
        },
        dan: {
          sg: ['dan', 'dana', 'danu', 'dan', 'dane!', 'danu', 'danom'],
          pl: ['dani', 'dana', 'danima', 'dane', 'dani!', 'danima', 'danima'],
        },
        put: {
          sg: ['put', 'puta', 'putu', 'put', 'pute!', 'putu', 'putom'],
          pl: ['putovi', 'putova', 'putovima', 'putove', 'putovi!', 'putovima', 'putovima'],
        },
      };
  ...
  if (noun.gender === 'f') {
    const specialF = {
      zemlja: {
        sg: ['zemlja', 'zemlje', 'zemlji', 'zemlju', 'zemljo!', 'zemlji', 'zemljom'],
        pl: ['zemlje', 'zemalja', 'zemljama', 'zemlje', 'zemlje!', 'zemljama', 'zemljama'],
      },
      sestra: {
        sg: ['sestra', 'sestre', 'sestri', 'sestru', 'sestro!', 'sestri', 'sestrom'],
        pl: ['sestre', 'sestara', 'sestrama', 'sestre', 'sestre!', 'sestrama', 'sestrama'],
      },
      rijeka: {
        sg: ['rijeka', 'rijeke', 'rijeci', 'rijeku', 'rijeko!', 'rijeci', 'rijekom'],
        pl: ['rijeke', 'rijeka', 'rijekama', 'rijeke', 'rijeke!', 'rijekama', 'rijekama'],
      },
      ruka: {
        sg: ['ruka', 'ruke', 'ruci', 'ruku', 'ruko!', 'ruci', 'rukom'],
        pl: ['ruke', 'ruku', 'rukama', 'ruke', 'ruke!', 'rukama', 'rukama'],
      },
      noga: {
        sg: ['noga', 'noge', 'nozi', 'nogu', 'nogo!', 'nozi', 'nogom'],
        pl: ['noge', 'nogu', 'nogama', 'noge', 'noge!', 'nogama', 'nogama'],
      },
      knjiga: {
        sg: ['knjiga', 'knjige', 'knjizi', 'knjigu', 'knjigo!', 'knjizi', 'knjigom'],
        pl: ['knjige', 'knjiga', 'knjigama', 'knjige', 'knjige!', 'knjigama', 'knjigama'],
      },
      škola: {
        sg: ['škola', 'škole', 'školi', 'školu', 'školo!', 'školi', 'školom'],
        pl: ['škole', 'škola', 'školama', 'škole', 'škole!', 'školama', 'školama'],
      },
      ulica: {
        sg: ['ulica', 'ulice', 'ulici', 'ulicu', 'ulico!', 'ulici', 'ulicom'],
        pl: ['ulice', 'ulica', 'ulicama', 'ulice', 'ulice!', 'ulicama', 'ulicama'],
      },
      glava: {
        sg: ['glava', 'glave', 'glavi', 'glavu', 'glavo!', 'glavi', 'glavom'],
        pl: ['glave', 'glava', 'glavama', 'glave', 'glave!', 'glavama', 'glavama'],
      },
      kuća: {
        sg: ['kuća', 'kuće', 'kući', 'kuću', 'kućo!', 'kući', 'kućom'],
        pl: ['kuće', 'kuća', 'kućama', 'kuće', 'kuće!', 'kućama', 'kućama'],
      },
      mama: {
        sg: ['mama', 'mame', 'mami', 'mamu', 'mamo!', 'mami', 'mamom'],
        pl: ['mame', 'mama', 'mamama', 'mame', 'mame!', 'mamama', 'mamama'],
      },
      voda: {
        sg: ['voda', 'vode', 'vodi', 'vodu', 'vodo!', 'vodi', 'vodom'],
        pl: ['vode', 'voda', 'vodama', 'vode', 'vode!', 'vodama', 'vodama'],
      },
    };
  ...
  if (noun.gender === 'n') {
    const specialN = {
      more: {
        sg: ['more', 'mora', 'moru', 'more', 'more!', 'moru', 'morem'],
        pl: ['mora', 'mora', 'morima', 'mora', 'mora!', 'morima', 'morima'],
      },
      sunce: {
        sg: ['sunce', 'sunca', 'suncu', 'sunce', 'sunce!', 'suncu', 'suncem'],
        pl: ['sunca', 'sunaca', 'suncima', 'sunca', 'sunca!', 'suncima', 'suncima'],
      },
      srce: {
        sg: ['srce', 'srca', 'srcu', 'srce', 'srce!', 'srcu', 'srcem'],
        pl: ['srca', 'srca', 'srcima', 'srca', 'srca!', 'srcima', 'srcima'],
      },
      voće: {
        sg: ['voće', 'voća', 'voću', 'voće', 'voće!', 'voću', 'voćem'],
        pl: ['voća', 'voća', 'voćima', 'voća', 'voća!', 'voćima', 'voćima'],
      },
      lice: {
        sg: ['lice', 'lica', 'licu', 'lice', 'lice!', 'licu', 'licem'],
        pl: ['lica', 'lica', 'licima', 'lica', 'lica!', 'licima', 'licima'],
      },
      polje: {
        sg: ['polje', 'polja', 'polju', 'polje', 'polje!', 'polju', 'poljem'],
        pl: ['polja', 'polja', 'poljima', 'polja', 'polja!', 'poljima', 'poljima'],
      },
      ime: {
        sg: ['ime', 'imena', 'imenu', 'ime', 'ime!', 'imenu', 'imenom'],
        pl: ['imena', 'imena', 'imenima', 'imena', 'imena!', 'imenima', 'imenima'],
      },
    };
