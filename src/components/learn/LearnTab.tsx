  ...
  return (
    <React.Fragment>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 10, marginBottom: 10 }}>
        ...
        >
          ...
          <div>
            ...
            <div className="feature-card-desc" style={{ color: '#0369a1' }}>
              L-participle · gender endings · A2
            </div>
          </div>
        </button>
        <button
      ...
      >
        ...
        <div style={{ flex: 1 }}>
          <div className="feature-card-title" style={{ color: '#451a03' }}>
            Grammar Track A1→B2
          </div>
          <div className="feature-card-desc" style={{ color: '#92400e' }}>
            40 units · cases, tenses, aspect &amp; more · alternative to Learn Path
          </div>
        </div>
            ...
            {[
              {
                ...
                label: 'Greetings',
                color: '#0e7490',
                bg: 'rgba(14,116,144,.1)',
                border: 'rgba(14,116,144,.3)',
              },
              {
                cat: 'family',
                icon: '👨‍👩‍👧',
        ...
        return (
          ...
          >
            <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 12 }}>
              ...
              <div>
                <div style={{ fontSize: 'var(--text-base)', fontWeight: 900, color: gf.color }}>
                  {gf.label}
                </div>
                <div
                  style={{
                    ...
                    <div style={{ flex: 1, textAlign: 'center' }}>
                      <div
                        style={{
                          ...
                          justifyContent: 'center',
                          fontSize: 'var(--text-base)',
                          color: isComplete || isCurrent ? 'var(--card)' : 'var(--subtext)',
                          fontWeight: 900,
                          boxShadow: isCurrent ? '0 0 0 3px rgba(14,116,144,.2)' : 'none',
                          transition: 'all .3s',
                        }}
                      >
                        {isComplete ? '✓' : lv.level}
                    ...
                    {i < LEARN_PATH.length - 1 && (
                      <div
                        style={{
                          ...
                          marginBottom: 16,
                          background:
                            lvDone === lv.items.length ? 'var(--success)' : 'var(--card-b)',
                          borderRadius: 2,
                        }}
                      />
                    )}
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 14 }}>
            ...
            <div>
              <div style={{ fontSize: 15, fontWeight: 900, color: '#78350f' }}>
                B1 Explorer — New content unlocked!
              </div>
              <div style={{ fontSize: 12, color: '#92400e', marginTop: 2 }}>
                You've reached the intermediate tier. Explore what's available to you.
              </div>
            </div>
          </div>
          <div
            ...
            {[
              {
                icon: '🎭',
                label: 'Aspect Drill',
                sub: 'Perfective vs imperfective',
                scr: 'aspectdrill',
              ...
              },
              {
                icon: '🗣️',
                label: 'Speaking',
                sub: 'Train spoken output',
                scr: 'speaking',
                bg: 'linear-gradient(135deg,#0e7490,#0369a1)',
              },
              {
                icon: '✍️',
                label: 'Production',
                sub: 'Sentence drills',
                scr: 'production_drill',
              ...
              >
                ...
                <div style={{ fontSize: 10, color: 'rgba(255,255,255,.75)', lineHeight: 1.3 }}>
                  {item.sub}
                </div>
              </button>
            ))}
      ...
      >
        ...
        >
          <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
            <span style={{ fontSize: 'var(--text-sm)', fontWeight: 800, color: 'var(--heading)' }}>
              🎓 CEFR Level
            </span>
            <span
          ...
          {['A1', 'A2', 'B1', 'B2', 'C1'].map((l) => (
            <div
              ...
              style={{
                fontSize: 'var(--text-xs)',
                fontWeight: 700,
                color: cefrLevel === l ? 'var(--heading)' : 'var(--subtext)',
              }}
            >
              {l}
            </div>
        ...
        {cefrToNext && (
          ...
          >
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              <div
                style={{ fontSize: 12, fontWeight: 900, color: 'var(--heading)', marginBottom: 4 }}
              >
