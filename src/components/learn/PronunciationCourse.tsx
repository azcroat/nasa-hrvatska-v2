        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
          ...
          <div>
            ...
            <div style={{ fontSize: 12, opacity: 0.85, lineHeight: 1.5 }}>
              Master the sounds that make Croatian different — with IPA, memory aids & audio
              examples
            </div>
          </div>
        </div>
        ...
        {letters.map((l: PronLetter) => {
          ...
          return (
            <button
              ...
              style={{
                background: 'var(--card)',
                border: `2px solid ${practiced ? l.color : 'var(--card-b)'}`,
                borderRadius: 16,
                padding: '16px 12px',
                cursor: 'pointer',
                textAlign: 'center',
  ...
  const quiz = [
    {
      ...
      opts: shuffleOpts([l.ipa, ...getWrongIpa(l, letters)]),
      correct: l.ipa,
    },
    {
  ...
  return (
    <div className="scr-wrap">
      ...
      >
        ...
        <div style={{ fontSize: 16, marginTop: 8, opacity: 0.9, fontFamily: 'monospace' }}>
          {l.ipa}
        </div>
        <div style={{ fontSize: 13, marginTop: 4, opacity: 0.85 }}>{l.name}</div>
      </div>
      ...
      {!quizMode ? (
        <>
          ...
          >
            <div
              style={{ fontSize: 13, fontWeight: 800, color: 'var(--heading)', marginBottom: 8 }}
            >
              🇬🇧 How to pronounce it
            </div>
            <p style={{ fontSize: 15, color: 'var(--heading)', lineHeight: 1.7, margin: 0 }}>
              {l.like}
            </p>
          </div>
        ...
        <>
          ...
          {quiz.map((q, qi) => (
            ...
            >
              <p
                style={{ fontSize: 14, fontWeight: 700, color: 'var(--heading)', marginBottom: 12 }}
              >
                {qi + 1}. {q.q}
              </p>
              {q.opts.map((opt, oi) => {
                ...
                return (
                  <button
                    ...
                    style={{
                      ...
                      color: col,
                      fontSize: 13,
                      fontWeight: sel !== undefined && isCorrect ? 700 : 500,
