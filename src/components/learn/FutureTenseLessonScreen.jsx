...
const FUTURE1_PARADIGM = [
  ...
  { person: 'On/Ona/Ono',   clitic: 'će',   full: 'će raditi',   short: 'Radit će',  en: 'he/she will work' },
  { person: 'Mi',           clitic: 'ćemo', full: 'ćemo raditi', short: 'Radit ćemo',en: 'we will work' },
  { person: 'Vi',           clitic: 'ćete', full: 'ćete raditi', short: 'Radit ćete',en: 'you (pl) will work' },
  { person: 'Oni/One/Ona',  clitic: 'će',   full: 'će raditi',   short: 'Radit će',  en: 'they will work' },
];
...
const NEG_PARADIGM = [
  ...
  { person: 'On/Ona/Ono',   neg: 'neće',   example: 'Neće doći večeras.', en: 'He/she won\'t come tonight.' },
  ...
  { person: 'Oni/One/Ona',  neg: 'neće',   example: 'Neće nas slušati.', en: 'They won\'t listen to us.' },
];
...
const QUIZ_QS = [
  ...
  },
  {
    ...
    opts: ['Ako ćeš imati vremena, dođi.', 'Ako budeš imao vremena, dođi.', 'Ako imaš, dođi ćeš.', 'Kada imaš vremena, dolazit ćeš.'],
  },
  {
    type: 'fut1',
  ...
  },
  {
    ...
    opts: ['Neću ići na posao.', 'Nisam išao na posao.', 'Ne idem na posao.', 'Nećeš ići na posao.'],
  },
];
  ...
  return (
    <div className="scr-wrap">
      ...
      {tab === 'fut1' && (
        <div>
          ...
          <div className="c" style={{ marginBottom: 14, borderLeft: '4px solid #7c3aed', background: 'linear-gradient(135deg,#faf5ff,#ede9fe)' }}>
            <div style={{ fontSize: 13, fontWeight: 900, color: '#7c3aed', marginBottom: 6, textTransform: 'uppercase', letterSpacing: '.08em' }}>Formula — Future I</div>
            ...
            <div style={{ fontSize: 13, color: '#6d28d9', lineHeight: 1.7 }}>
              <b>Ja ću raditi.</b> &nbsp;·&nbsp; I will work<br />
              <b>Ona će doći.</b> &nbsp;·&nbsp; She will come<br />
              <b>Mi ćemo učiti.</b> &nbsp;·&nbsp; We will study
            </div>
          </div>

          {/* Conjugation table */}
          <div className="c" style={{ padding: 0, overflow: 'hidden', marginBottom: 14, borderLeft: '4px solid #7c3aed' }}>
            <div style={{ padding: '12px 16px', background: 'linear-gradient(135deg,#7c3aed,#5b21b6)', color: '#fff' }}>
              <div style={{ fontSize: 17, fontWeight: 800 }}>raditi — Future I</div>
              <div style={{ fontSize: 12, opacity: .8, marginTop: 2 }}>Long form (formal) and short form (spoken)</div>
            </div>
            <table style={{ width: '100%', borderCollapse: 'collapse' }}>
              <thead>
                <tr style={{ borderBottom: '2px solid var(--card-b)', background: 'var(--bar-bg)' }}>
                  <th style={{ padding: '8px 14px', textAlign: 'left', fontSize: 11, fontWeight: 800, color: 'var(--subtext)', textTransform: 'uppercase' }}>Person</th>
                  <th style={{ padding: '8px 14px', textAlign: 'left', fontSize: 11, fontWeight: 800, color: 'var(--subtext)', textTransform: 'uppercase' }}>Long form</th>
                  <th style={{ padding: '8px 14px', textAlign: 'left', fontSize: 11, fontWeight: 800, color: 'var(--subtext)', textTransform: 'uppercase' }}>Short form</th>
                </tr>
              </thead>
              <tbody>
                {FUTURE1_PARADIGM.map((row, i) => (
                  ...
                  >
                    <td style={{ padding: '10px 14px', fontWeight: 700, color: '#7c3aed', fontSize: 13 }}>{row.person}</td>
                    <td style={{ padding: '10px 14px', fontWeight: 700, fontSize: 14, color: '#4c1d95' }}>
                      {row.full} <span aria-hidden="true">🔊</span>
                    </td>
                    <td style={{ padding: '10px 14px', fontSize: 13, color: '#059669', fontWeight: 700 }}>{row.short}</td>
                  </tr>
                ))}
              </tbody>
            </table>
          ...
          <div className="c" style={{ marginBottom: 14, borderLeft: '4px solid #059669', background: '#f0fdf4' }}>
            <div style={{ fontSize: 13, fontWeight: 800, color: '#065f46', marginBottom: 6 }}>Short form — spoken Croatian</div>
            <div style={{ fontSize: 12, color: '#374151', lineHeight: 1.8 }}>
              In everyday speech, the infinitive drops final <b>-i</b> and the clitic follows the first word of the clause:<br />
              <b>Čitat ću</b> (I will read) · <b>Pisat ćeš</b> (you will write)<br />
              <b>Ić ću</b> → but irregular: <b>Ići ću</b> is also accepted for ići<br />
              <br />
              Clitic placement: the ću-form is a <em>clitic</em> — it cannot start a sentence.
              It attaches after the first accented word or phrase.
            </div>
          </div>

          {/* Common verbs */}
          <div className="c" style={{ borderLeft: '4px solid #0e7490' }}>
            <div className="sh" style={{ marginBottom: 10 }}>10 common verbs in Future I (tap to hear)</div>
            <div style={{ display: 'flex', flexWrap: 'wrap', gap: 6 }}>
              {[
                'Ići ću', 'Doći ćeš', 'Raditi ćemo', 'Pisati će', 'Čitati ćete',
                'Gledati ću', 'Jesti ćemo', 'Piti će', 'Učiti ćeš', 'Putovati ću',
              ].map((s, i) => (
                <button
                  key={i}
                  onClick={() => speak(s)}
                  style={{
                    ...
                    color: '#0e7490', fontWeight: 700, fontSize: 12, cursor: 'pointer',
                  }}
                >
                  {s} 🔊
                </button>
      ...
      {tab === 'fut2' && (
        <div>
          <div className="c" style={{ marginBottom: 14, borderLeft: '4px solid #dc2626', background: '#fef2f2' }}>
            <div style={{ fontSize: 13, fontWeight: 800, color: '#dc2626', marginBottom: 4 }}>What is Future II?</div>
            <div style={{ fontSize: 12, color: '#78716c', lineHeight: 1.7 }}>
              Future II (futur egzaktni) expresses a future action that will be <b>completed before</b> another future action.
              It is used in subordinate clauses after <b>kad(a)</b> (when), <b>ako</b> (if), <b>čim</b> (as soon as), <b>dok</b> (while/until).
              English speakers often mistakenly use present tense here — Croatian requires Future II.
              This is one of the features that most distinguishes Croatian from English.
            </div>
          </div>

          {/* Formula */}
          <div className="c" style={{ marginBottom: 14, borderLeft: '4px solid #7c3aed', background: 'linear-gradient(135deg,#faf5ff,#ede9fe)' }}>
            <div style={{ fontSize: 13, fontWeight: 900, color: '#7c3aed', marginBottom: 6, textTransform: 'uppercase', letterSpacing: '.08em' }}>Formula — Future II</div>
            <div style={{ fontSize: 18, fontWeight: 800, color: '#4c1d95', marginBottom: 8 }}>
              budem/budeš/bude/… + L-participle
            </div>
            <div style={{ fontSize: 13, color: '#6d28d9', lineHeight: 1.7 }}>
              <b>Kad budem gotov, nazvat ću te.</b><br />
              When I am done, I will call you.
            </div>
          </div>

          {/* Paradigm table */}
          <div className="c" style={{ padding: 0, overflow: 'hidden', marginBottom: 14, borderLeft: '4px solid #dc2626' }}>
            <div style={{ padding: '12px 16px', background: 'linear-gradient(135deg,#dc2626,#9f1239)', color: '#fff' }}>
              <div style={{ fontSize: 17, fontWeight: 800 }}>raditi — Future II (kad + budem)</div>
              <div style={{ fontSize: 12, opacity: .8, marginTop: 2 }}>Used in subordinate clauses</div>
            </div>
            <table style={{ width: '100%', borderCollapse: 'collapse' }}>
              <tbody>
                {FUTURE2_PARADIGM.map((row, i) => (
                  <tr
                    ...
                    onKeyDown={e => { if (e.key === 'Enter' || e.key === ' ') { e.preventDefault(); speak(row.person + ' ' + row.form); } }}
                  >
                    <td style={{ padding: '10px 14px', fontWeight: 700, color: '#7c3aed', fontSize: 13, width: '28%' }}>{row.person}</td>
                    <td style={{ padding: '10px 14px', fontWeight: 700, fontSize: 14, color: '#9f1239' }}>
          ...
          <div className="sh" style={{ marginBottom: 10 }}>English vs Croatian — 5 real contrasts</div>
          {FUTURE2_CONTRASTS.map((c, i) => (
            <div key={i} className="c" style={{ marginBottom: 10, borderLeft: '4px solid #d97706' }}>
              <div style={{ fontSize: 12, fontWeight: 800, color: '#d97706', marginBottom: 4 }}>{c.en}</div>
              <div style={{ display: 'flex', flexDirection: 'column', gap: 4 }}>
                <div
                  style={{ padding: '6px 10px', borderRadius: 8, background: '#dcfce7', fontSize: 13, fontWeight: 700, color: '#166534', cursor: 'pointer' }}
                  onClick={() => speak(c.right)}
                  role="button"
                  tabIndex={0}
                  onKeyDown={e => { if (e.key === 'Enter' || e.key === ' ') { e.preventDefault(); speak(c.right); } }}
                >
                  ✓ {c.right} 🔊
                </div>
              </div>
      ...
      {tab === 'neg' && (
        <div>
          <div className="c" style={{ marginBottom: 14, borderLeft: '4px solid #dc2626', background: '#fef2f2' }}>
            <div style={{ fontSize: 13, fontWeight: 800, color: '#dc2626', marginBottom: 4 }}>Negative future: neću</div>
            <div style={{ fontSize: 12, color: '#78716c', lineHeight: 1.7 }}>
              ...
              <br /><br />
              Interrogative: <b>Hoće li + infinitive?</b> — "Will they come?" → "Hoće li doći?"
              The <b>li</b> particle marks a yes/no question.
            </div>
          </div>
          ...
          <div className="c" style={{ padding: 0, overflow: 'hidden', marginBottom: 14, borderLeft: '4px solid #dc2626' }}>
            <div style={{ padding: '12px 16px', background: 'linear-gradient(135deg,#dc2626,#9f1239)', color: '#fff' }}>
              <div style={{ fontSize: 17, fontWeight: 800 }}>Negative Future — neću + infinitive</div>
            </div>
            <table style={{ width: '100%', borderCollapse: 'collapse' }}>
              <tbody>
                {NEG_PARADIGM.map((row, i) => (
                  <tr
                    ...
                    onKeyDown={e => { if (e.key === 'Enter' || e.key === ' ') { e.preventDefault(); speak(row.example); } }}
                  >
                    <td style={{ padding: '10px 14px', fontWeight: 700, color: '#dc2626', fontSize: 13, width: '22%' }}>{row.neg}</td>
                    <td style={{ padding: '10px 14px', fontWeight: 700, fontSize: 14, color: 'var(--heading)' }}>
          ...
          <div className="c" style={{ marginBottom: 14, borderLeft: '4px solid #0e7490' }}>
            <div className="sh" style={{ marginBottom: 10 }}>Interrogative Future — Hoće li …?</div>
            {[
              ...
              <div key={i} style={{ marginBottom: 8, display: 'flex', alignItems: 'center', gap: 10 }}>
                <button
                  ...
                  style={{
                    padding: '6px 12px', borderRadius: 10, border: '1px solid rgba(14,116,144,.3)',
                    background: 'rgba(14,116,144,.08)', color: '#0e7490', fontWeight: 700, fontSize: 13, cursor: 'pointer',
                  }}
                >
                  {pair.q} 🔊
                </button>
          ...
          <div className="c" style={{ borderLeft: '4px solid #f59e0b', background: '#fffbeb' }}>
            <div style={{ fontSize: 13, fontWeight: 800, color: '#92400e', marginBottom: 6 }}>Key contrast to remember</div>
            <div style={{ fontSize: 12, color: '#78716c', lineHeight: 1.8 }}>
              Positive: <b>Ići ću</b> / <b>Ja ću ići</b> — two words, clitic second<br />
              Negative: <b>Neću ići</b> — one merged negative word + infinitive<br />
        ...
        if (qi >= total) {
          ...
          return (
            <div style={{ textAlign: 'center' }}>
              ...
              <h2 style={{ fontFamily: "'Playfair Display',serif", color: 'var(--heading)' }}>Future Tense Quiz Done!</h2>
              <div style={{ fontSize: 32, fontWeight: 800, color: '#7c3aed', marginBottom: 4 }}>{score} / {total}</div>
        ...
        return (
          <div>
            <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 8 }}>
              ...
              <span style={{ fontSize: 14, fontWeight: 700, color: '#7c3aed' }}>Score: {score}</span>
            </div>
            <Bar v={qi + 1} mx={total} color="#7c3aed" />
            <div className="c" style={{ marginTop: 16, marginBottom: 16 }}>
              <div style={{ marginBottom: 8 }}>
                <span style={{ padding: '3px 10px', borderRadius: 10, fontSize: 11, fontWeight: 800, background: tc.bg, color: tc.color }}>
                  {tc.label}
                </span>
              </div>
              ...
              {opts.map((o, oi) => (
                <button
                  ...
                  style={{
                    ...
                    borderColor: answered ? (o === q.answer ? '#16a34a' : selected === oi ? '#dc2626' : 'rgba(124,58,237,.12)') : 'rgba(124,58,237,.12)',
                  }}
                  onClick={() => {
                    if (answered) return;
                    setSelected(oi);
