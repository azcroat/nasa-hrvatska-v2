            ...
            <div key={stop.name} style={{ display: 'flex', alignItems: 'center' }}>
              ...
              >
                ...
                >
                  <span
                    style={{
                      filter: isFuture ? 'grayscale(1) opacity(.45)' : 'none',
      ...
      <div style={{ background: sc.bg, padding: '18px 20px', color: 'var(--card)' }}>
        ...
        >
          <div>
            ...
            <div style={{ fontSize: 18, fontWeight: 800, marginTop: 3, color: 'var(--card)' }}>
              {currentStage?.title}
            </div>
            <div
              style={{
          ...
          <div style={{ textAlign: 'right', flexShrink: 0 }}>
            <div style={{ fontSize: 'var(--text-2xl)', fontWeight: 900, lineHeight: 1 }}>
              {overallPct}%
            </div>
            <div style={{ fontSize: 'var(--text-xs)', opacity: 0.7, marginTop: 2 }}>overall</div>
          </div>
        </div>
        <div
          style={{
        ...
        <div style={{ fontSize: 'var(--text-xs)', opacity: 0.7, marginTop: 5 }}>
      ...
      <div style={{ background: 'var(--card)', padding: '16px 20px' }}>
        {nextItem ? (
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginTop: 5 }}>
                <span
                  ...
                  title={`Difficulty: ${nextItem.diff || 1}/3`}
                >
                  {'⭐'.repeat(nextItem.diff || 1)}
                  {'☆'.repeat(3 - (nextItem.diff || 1))}
                </span>
                {nextItem.dur && (
                  <span
                    style={{ fontSize: 'var(--text-sm)', color: 'var(--subtext)', fontWeight: 700 }}
                  >
                    {nextItem.dur}
                  </span>
                )}
              ...
              >
                {
                  /** @type {any} */ nextItem.description ||
                    `Learn essential ${/** @type {any} */ nextItem.label || 'vocabulary'} · includes audio`
                }
              </div>
            </div>
            {(!st || st.lc === 0) && (
          ...
          <div style={{ textAlign: 'center', padding: '8px 0' }}>
            ...
            <div style={{ fontSize: 'var(--text-sm)', color: 'var(--subtext)', marginTop: 2 }}>
              Ti si pravi Hrvat! Bravo!
            </div>
          </div>
        )}
        <button
          ...
          >
            ...
            <div style={{ flex: 1 }}>
              ...
              <div style={{ fontSize: 'var(--text-sm)', color: 'var(--subtext)' }}>
                Flashcards → drill new vocabulary
              </div>
            </div>
