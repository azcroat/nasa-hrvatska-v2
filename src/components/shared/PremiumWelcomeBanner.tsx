  ...
  return (
    ...
    >
      <div
        ...
        style={{
          background: 'var(--card)', borderRadius: 24, maxWidth: 380, width: '100%',
      ...
      >
        ...
        <div style={{ padding: '16px 24px' }}>
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 8, marginBottom: 16 }}>
            {FEATURES.map(f => (
              <div key={f.label} style={{
                ...
                <span style={{ fontSize: 11, fontWeight: 700, color: 'var(--heading)', lineHeight: 1.3 }}>{f.label}</span>
              </div>
            ))}
          </div>
          ...
          <div style={{
            ...
            padding: '8px 12px', background: 'rgba(14,116,144,.07)', borderRadius: 8,
