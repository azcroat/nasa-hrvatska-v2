...
const MILESTONES = [
  { days: 3,   icon: '🔥', title: '3-Day Streak!',  subtitle: 'You\'re building a habit. Keep going!', color: '#f97316', confettiColors: ['#f97316','#fb923c','#fdba74'] },
  { days: 7,   icon: '⚡', title: 'Week Warrior!',  subtitle: '7 days straight. Your brain is rewiring.', color: '#eab308', confettiColors: ['#eab308','#facc15','#fde047'] },
  { days: 14,  icon: '🌟', title: 'Two Weeks!',     subtitle: 'Dva tjedna — Croatian is settling in.', color: '#22c55e', confettiColors: ['#22c55e','#4ade80','#86efac'] },
  { days: 30,  icon: '🏆', title: 'Trideset Dana!', subtitle: '30 days. You\'re no longer a beginner.', color: '#6366f1', confettiColors: ['#6366f1','#818cf8','#a5b4fc','#D40030','#ffffff'] },
  { days: 50,  icon: '💎', title: 'Fifty Days!',    subtitle: 'The Adriatic has been waiting for you.', color: '#0e7490', confettiColors: ['#0e7490','#38bdf8','#7dd3fc','#D40030'] },
  { days: 100, icon: '👑', title: 'Sto Dana!',      subtitle: '100 days. Svaka čast, majstore!', color: '#D40030', confettiColors: ['#D40030','#ffffff','#0e7490','#f59e0b','#ffffff'] },
  { days: 365, icon: '🇭🇷', title: 'Godišnjica!',   subtitle: 'One year. You ARE Croatian now.', color: '#D40030', confettiColors: ['#D40030','#ffffff','#1e3a8a','#f59e0b'] },
];
      ...
      >
        ...
        >
          ...
          <div style={{
            ...
            <span style={{ fontSize: 13, fontWeight: 700, color: 'var(--subtext, #555e6e)' }}>day streak</span>
          </div>

          <p style={{
            fontSize: 15, color: 'var(--subtext, #555e6e)',
