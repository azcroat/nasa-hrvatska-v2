        ...
        >
          ...
          <motion.div
            ...
            style={{
              ...
              inset: -10,
              borderRadius: 30,
              background: 'radial-gradient(ellipse at center, rgba(14,116,144,0.45) 0%, transparent 70%)',
              pointerEvents: 'none',
              zIndex: 0,
            }}
          />
          ...
          <div aria-hidden="true" style={{ position: 'absolute', left: 28, top: 24, pointerEvents: 'none', zIndex: 2 }}>
            {PARTICLES.map((p, i) => (
              <motion.div
                key={i}
                custom={p}
          ...
          >
            ...
            <motion.div variants={childVariants} style={{ flexShrink: 0, position: 'relative', zIndex: 1 }}>
