...
const QUICK_CULTURE = [
  ...
  {
    mood: 'happy',
    text: 'The Pula Arena is one of the six largest Roman amphitheatres still standing — built in 27 BC. Concerts happen inside it every summer. ⚔️',
  },
  {
    mood: 'happy',
    text: "Hvar gets 2,726 sunshine hours per year — more than Barcelona. The lavender fields bloom in June. Smell it once and you'll never forget it. 🌿",
  },
  {
    mood: 'happy',
  ...
  {
    mood: 'happy',
    text: "The Za Križen procession in Hvar has run every year for 500 years — torchlight, 8 villages, all night. One of Europe's oldest living traditions. 🕯️",
  },
];
...
const CONTEXTUAL_POOL = [
  ...
  {
    mood: 'happy',
    text: 'Split, Dubrovnik, Rovinj, Zadar — every city sounds more magical when you understand what the name means. 🏛️',
  },
  {
    mood: 'encouraged',
  ...
  {
    mood: 'encouraged',
    text: 'Polako, ali sigurno — slowly but surely. The Croatian phrase for exactly what language learning requires. 🛡️',
  },
  {
    mood: 'ready',
    text: '5 million Croatian speakers worldwide. With every session, you get measurably closer to joining them. ⚔️',
  },
  {
    mood: 'happy',
  ...
  {
    mood: 'happy',
    text: 'The Baška Tablet, carved in 1100 AD on Krk Island, is one of the oldest surviving texts in Croatian. Your language has a thousand-year paper trail. 📜',
  },
  {
    mood: 'thinking',
    text: '"Bok" is used only in Zagreb. "Čao" covers Dalmatia. "Hej" is Slavonia. One language, three ways to say hello — and each one tells you where someone is from. 🗺️',
  },
  {
    mood: 'happy',
    text: "Goran Ivanišević was a wildcard entry at Wimbledon 2001. He won it anyway. You're learning Croatian against the odds too — and the odds don't matter. 🎾",
  },
  {
    mood: 'thinking',
    text: 'The vocative case — "Marija" becomes "Marijo" when you call out to her. Croatian marks the difference between talking about someone and talking to them. 📐',
  },
  {
    mood: 'happy',
    text: 'Rovinj is built on an island that was connected to the mainland in 1763. Every street leads to the sea. Every word leads to a culture. Start walking. 🌊',
  },
  {
    mood: 'encouraged',
    text: 'Moreška is a sword dance performed in Korčula for 400 years. Two kings, two armies, one beautiful woman. Same drama as Croatian grammar — worth learning. ⚔️',
  },
  {
    mood: 'happy',
    text: 'The oldest continuously inhabited building in the world is in Vinkovci, Slavonia — 8,300 years of human life in one town. Learn Croatian and you join that thread. 🏺',
  },
  {
    mood: 'thinking',
    text: '"Trebati" can mean "to need" or "should" depending on the case. Trebaš — you need. Treba ti — it\'s needed to you. The precision is the point. 📐',
  },
  {
    mood: 'happy',
    text: 'Klapa singing — four to eight voices, no instruments, harmonies that ring off stone walls. When you understand the words, the emotion doubles. 🎶',
  },
  {
    mood: 'encouraging',
    text: 'Ivan Meštrović was offered a villa by Mussolini and refused it. He carved marble into monuments that outlast empires. The same principle applies to vocab: build it to last. 🗿',
  },
  {
    mood: 'happy',
    text: '"Fala" is the Dalmatian slang for "hvala" — thank you. Dialects aren\'t wrong Croatian. They\'re Croatian with history attached. 🌊',
  },
  {
    mood: 'thinking',
    text: 'Future tense in Croatian: "Ići ću" or "Idem" — the present can carry future meaning. Context carries a lot of weight in this language. 📐',
  },
  {
    mood: 'happy',
    text: "Pag Island produces cheese so hard it's like stone, and lace so fine it's UNESCO heritage. One small island — two extremes of craft. 🧀",
  },
  {
    mood: 'ready',
    text: "Šibenik's Cathedral of St. James took 105 years to build. The builders knew they'd never see it finished — and they built it anyway. Play the long game. ⛪",
  },
  {
    mood: 'encouraged',
    text: '"Nema problema" flows off the tongue in Dalmatia. Life\'s too short for problems that can\'t be solved over coffee. Learn the phrase — use the philosophy. ☕',
  },
  {
    mood: 'thinking',
    text: 'Croatian diminutives are everywhere: "kava" → "kavica," "kuća" → "kućica." When you hear the suffix -ica or -ić, someone is being affectionate. 💙',
  },
  {
    mood: 'happy',
    text: 'The Adriatic is the cleanest sea in Europe. Croatia has 1,246 islands. The word for island — "otok" — literally means "surrounded by water." 🏝️',
  },
  {
    mood: 'celebrating',
    text: 'Croatia qualified for the 2018 World Cup Final. A country of 4 million — against nations of hundreds of millions. Size has nothing to do with what you can achieve. 🥈',
  },
  {
    mood: 'thinking',
    text: '"Doći" (to come/arrive) vs "dolaziti" (to be coming, ongoing). The perfective/imperfective split is a camera lens: close-up or wide angle on the same action. 🎬',
  },
  {
    mood: 'happy',
    text: 'Plitvice Lakes — 16 terraced lakes, emerald waterfalls, a UNESCO site. The Croatian word "voda" (water) is one of the oldest words in the Indo-European family. 💧',
  },
];
...
function getGreeting(st, streakCount, level) {
  ...
  if (lc0)
    return pick([
      ...
      {
        mood: 'happy',
        text: "Dobro došli! Whether you have Croatian roots or just fell in love with this corner of Europe — you're in the right place. First lesson awaits. ⚔️",
      },
      {
        mood: 'encouraged',
  ...
  if (streakBroken)
    return pick([
      {
        mood: 'sad',
        text: "Nije dobro... Streak broken. But Nikola Tesla failed a thousand times before his breakthrough. One session and you're back. 💪",
      },
      {
        mood: 'sad',
        text: "Streak gone. I've watched Hajduk Split fans rebuild hope after worse. Five minutes — the comeback starts now. ⚽",
      },
      {
        mood: 'encouraged',
  ...
  if (hour >= 21 && streakCount > 0) {
    ...
    if (!practicedToday)
      return pick([
        ...
        {
          mood: 'ready',
          text: "Late night in Zagreb, the kafići are still full — and so is your next lesson. Don't lose the streak. ☕",
        },
        {
          mood: 'ready',
          text: `One lesson before bed. That's all it takes. ${streakCount} days — too valuable to lose tonight. ⚔️`,
        },
      ]);
  }
  ...
  if (streakCount >= 21)
    return {
      mood: 'celebrating',
      text: `Tri tjedna — 21 days. Habit science says this is when it sticks. I can confirm: it's sticking. 🔥`,
    };
  if (streakCount >= 14)
    return {
      mood: 'happy',
  ...
  if (streakCount >= 7)
    return {
      ...
      text:
        streakCount === 7
          ? `7-day streak — a full week! Your brain is forming real Croatian pathways now. Sjajno! 💪`
          : `${streakCount}-day streak! Real Croatian pathways forming. Keep going strong. 💪`,
    };
  if (streakCount >= 3)
    return {
      mood: 'happy',
      text: `${streakCount} days straight. Consistency beats intensity — you're proving it every day. Hajde! ⚔️`,
    };

  if (xp >= 5000)
    return {
      mood: 'victory',
      text: `${xp.toLocaleString()} XP! You've crossed into territory where Croatian conversations start happening by accident. 🗣️`,
    };
  if (xp >= 2500)
    return {
      mood: 'celebrating',
      text: `${xp.toLocaleString()} XP — you could order food, argue about football, and apologize in Croatian. Not bad at all. 🍽️`,
    };
  if (xp >= 1500)
    return {
      mood: 'celebrating',
      text: `${xp.toLocaleString()} XP! A short real conversation is within reach now. Keep going — the jump from here to fluent is smaller than it looks. 🌊`,
    };
  if (xp >= 1000)
    return {
      mood: 'happy',
  ...
  if (xp >= 750)
    return {
      mood: 'happy',
      text: `${xp.toLocaleString()} XP. You're well past basic tourist phrases now — you can navigate markets, ask directions, and understand answers. 🏛️`,
    };
  if (xp >= 500)
    return {
      mood: 'happy',
      text: `500+ XP! You've moved past tourist Croatian into something real. A local would actually be impressed. 🇭🇷`,
    };
  if (xp >= 200)
    return {
      mood: 'encouraged',
      text: `${xp.toLocaleString()} XP — the words are starting to stick. The early phase is the hardest, and you're past it. 💪`,
    };
  if (xp >= 100)
    return {
      mood: 'encouraged',
  ...
  if (xp >= 50)
    return {
      mood: 'encouraged',
      text: `${xp} XP! Every expert started exactly here. You're not at the beginning — you're already past it. ⚔️`,
    };

  if (gc >= 10)
    return {
      mood: 'thinking',
      text: `${gc} grammar sessions. You're building the skeleton of Croatian — cases, aspect, everything. Most learners skip this. You didn't. 📐`,
    };
  if (gc >= 5)
    return {
      mood: 'thinking',
  ...
  if (lc >= 50)
    return {
      mood: 'celebrating',
      text: `${lc} lessons complete! The Pula Arena has stood 2,000 years — built stone by stone. So is your Croatian. 🏛️`,
    };
  if (lc >= 25)
    return {
      mood: 'happy',
      text: `${lc} lessons! Tesla, Ivanišević, Modrić — they all spoke Croatian. Progress report: so do you, increasingly. 🎾`,
    };
  if (lc >= 10)
    return {
      mood: 'happy',
  ...
  if (hour < 9)
    return pick([
      ...
      {
        mood: 'happy',
        text: "Early start. In Dubrovnik, fishermen are out before dawn. You're building something at the same hour. Hajdemo! 🌊",
      },
      {
        mood: 'encouraged',
  ...
  if (hour >= 23)
    return pick([
      {
        mood: 'neutral',
        text: 'Po noći — by night. A quiet mind absorbs language differently. Late learners often go the deepest. 🌙',
      },
      {
        mood: 'thinking',
  ...
  if (day === 0)
    return pick([
      {
        mood: 'happy',
        text: 'Nedjelja — Sunday. No better day to learn something that lasts a lifetime. Croatia on Sundays smells like roasting lamb. 🥩',
      },
      {
        mood: 'neutral',
        text: 'Sunday session. In Dalmatia they call this "polako" time — slow down and do one thing well. Let\'s do that. ☀️',
      },
    ]);
  if (day === 6)
    return pick([
      ...
      {
        mood: 'happy',
        text: 'Saturday in Croatia = markets, coffee, sea. Learn the words, then go live them. 🛶',
      },
    ]);
  if (day === 1)
    return pick([
      {
        mood: 'encouraged',
        text: 'Ponedjeljak — Monday. Fresh week, clean slate. The learners who study on Mondays are the ones who end up fluent. ⚔️',
      },
      {
        mood: 'ready',
        text: 'Monday. Set the tone now. Everything else this week will feel easier after this one session. 🛡️',
      },
    ]);
  if (day === 5)
    return pick([
      {
        mood: 'happy',
        text: 'Petak — Friday! End the week strong. Future-you at a Dalmatian wedding will be very grateful. 💃',
      },
      {
        mood: 'celebrating',
        text: "Friday session locked in. The Adriatic is calling — now you'll know what to say when you get there. 🌊",
      },
    ]);
...
export default function KnightSpeech({
  ...
  function _loadPoolState() {
    try {
      ...
      return {
        poolIdx: parsed.poolIdx ?? -1,
        lastPick: parsed.lastPick ?? { grammar: -1, culture: -1, motivate: -1 },
      };
    } catch {
      return { poolIdx: -1, lastPick: { grammar: -1, culture: -1, motivate: -1 } };
    }
  ...
  useEffect(() => {
    ...
    const BADGE_REACTIONS = [
      {
        mood: 'celebrating',
        text: "Čestitam! A new badge earned. Badges don't come easy — you put in the work. Svaka čast! 🏅",
      },
      {
        mood: 'victory',
        text: 'Badge unlocked! Every great Croatian soldier earned their insignia through action, not words. Today you did both. ⚔️',
      },
      {
        mood: 'celebrating',
        text: 'Novo odlikovanje! Another badge to your name. The Habsburgs gave Croatia medals. I give you this one. Well earned. 🎖️',
      },
    ];
    const onBadge = () => {
  ...
  if (mode === 'mini') {
    ...
    return (
      <motion.div
        initial={
          _isNative ? false : hasSeenIntro ? { scale: 0.7, opacity: 0 } : { x: -72, opacity: 0 }
        }
      ...
      >
        <button
          ...
          style={{
            ...
            border: showUrgency
              ? '2.5px solid rgba(220,38,38,.55)'
              : `2.5px solid ${accentColor}50`,
      ...
      <div style={{ padding: '12px 14px' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 6, marginBottom: 10 }}>
          ...
          <button
            ...
            onMouseEnter={(e) => {
              e.currentTarget.style.background = 'var(--card-b)';
