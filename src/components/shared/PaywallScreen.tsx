    ...
    >
      ...
      >
        ...
        <div style={{ padding: '24px 20px 12px' }}>
            ...
            {PLANS.map((plan) => (
              <button
                ...
                style={{
                  ...
                  cursor: 'pointer',
                  border:
                    selectedPlan === plan.id ? '2.5px solid #0e7490' : '2px solid var(--card-b)',
                  background: selectedPlan === plan.id ? 'rgba(14,116,144,.07)' : 'var(--card)',
                  position: 'relative',
                  textAlign: 'center',
                  transition: 'all .15s',
                }}
          ...
          <div
            style={{ fontSize: 11, color: 'var(--subtext)', textAlign: 'center', marginBottom: 16 }}
          >
            Then {selectedPlan === 'yearly' ? '$49.99/year' : '$7.99/month'} · Cancel anytime · No
            commitment
          </div>
          ...
          {promoMsg && (
            <div
              style={{
                ...
                marginBottom: 12,
                background:
                  promoMsg.includes('Invalid') || promoMsg.includes('already')
                    ? '#fef2f2'
                    : '#f0fdf4',
                color:
                  promoMsg.includes('Invalid') || promoMsg.includes('already')
          ...
          >
            {['🔒 Secure payment', '✉️ Cancel anytime', '🇭🇷 Built with love'].map((t) => (
              <span key={t} style={{ fontSize: 11, color: 'var(--subtext)', fontWeight: 600 }}>
                {t}
              </span>
            ))}
          </div>
