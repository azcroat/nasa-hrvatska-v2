    ...
    <div className="scr-wrap">
      ...
      <div className="c" style={{marginBottom:16}}>
        ...
        <p style={{fontSize:13,color:"var(--rt-c)",lineHeight:1.7,marginBottom:10}}>
          ...
          generation is processed by ElevenLabs. These requests are proxied through our server
          and are not stored or retained by us after the audio is delivered.
        </p>
      ...
      <div className="c" style={{marginBottom:16}}>
        <h3 style={{fontSize:15,fontWeight:800,color:"var(--heading)",marginBottom:8}}>AI-Powered Features</h3>

        <p style={{fontSize:13,color:"var(--rt-c)",lineHeight:1.7,marginBottom:10}}>
          Naša Hrvatska uses Claude AI (Anthropic) for conversation practice, grammar checking,
          and writing evaluation. Text you submit to AI features is sent to Anthropic's API.
          We do not store your conversation data beyond the current session.
        </p>
        ...
        <p style={{fontSize:13,color:"var(--rt-c)",lineHeight:1.7}}>
          ...
          <a href="https://www.anthropic.com/privacy" target="_blank" rel="noopener noreferrer" style={{color:"#0e7490"}}>anthropic.com/privacy</a>.
          ElevenLabs' policy:{" "}
          <a href="https://elevenlabs.io/privacy" target="_blank" rel="noopener noreferrer" style={{color:"#0e7490"}}>elevenlabs.io/privacy</a>.
        </p>
      </div>
