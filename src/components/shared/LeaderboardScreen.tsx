...
function getTierProgress(rank) {
  ...
  if (rank <= 20)
    return { message: `You're #${rank} — reach top 10 for Platinum 💎`, isTop: false };
    ...
    <div className="scr-wrap">
      ...
      >
        ...
        <div style={{ textAlign: 'right' }}>
          <div style={{ fontSize: 'var(--text-xs)', color: 'var(--subtext)', fontWeight: 700 }}>
            Week
          </div>
          ...
          .map((l) => (
            <div
              ...
              style={{
                ...
                fontSize: 'var(--text-xs)',
                fontWeight: 700,
                color: l.id === league.id ? l.color : 'var(--subtext)',
                whiteSpace: 'nowrap',
              }}
            >
              {l.icon} {l.name}
      ...
      {loading ? (
        ...
        <div style={{ textAlign: 'center', padding: 40 }}>
          ...
          <p style={{ color: 'var(--subtext)', marginTop: 12 }}>
        ...
        <div style={{ textAlign: 'center', padding: 40 }}>
          ...
          <p style={{ color: 'var(--subtext)', marginTop: 12 }}>
            ...
            <br />
            Complete lessons to get ranked!
          </p>
        </div>
      ) : (
                  ...
                  style={{
                    ...
                    background: isMe
                      ...
                      : isNeighbor
                        ...
                        : 'var(--card)',
                    border: isMe
                      ? '1.5px solid var(--info-b, rgba(14,116,144,0.3))'
                      : isNeighbor
                ...
                >
                  ...
                  <div
                    style={{
                      fontWeight: 900,
                      fontSize: 15,
                      color: isMe ? 'var(--info)' : 'var(--heading)',
                    }}
                  >
                    {e.xp}{' '}
      ...
      {myRank && myRank > 50 && (
        <div
          style={{
            ...
            border: '1.5px solid var(--info-b, rgba(14,116,144,0.2))',
            display: 'flex',
            alignItems: 'center',
            gap: 12,
          }}
