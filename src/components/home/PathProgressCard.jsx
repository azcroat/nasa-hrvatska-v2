...
function CityJourney({ currentLevel, activePalette }) {
  return (
    <div style={{ marginBottom: 14, marginTop: 4 }}>
      {/* Journey label */}
      <div style={{ fontSize: 10, fontWeight: 800, color: 'rgba(255,255,255,0.6)', textTransform: 'uppercase', letterSpacing: '.1em', marginBottom: 10 }}>
        Your Croatian Journey
      </div>

      {/* City path */}
      <div style={{ display: 'flex', alignItems: 'center', gap: 0, overflowX: 'auto', paddingBottom: 4, scrollbarWidth: 'none' }}>
            ...
            <React.Fragment key={stop.level}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', flexShrink: 0, minWidth: 44 }}>
                ...
                <div style={{
                  ...
                  {isDone && (
                    <div style={{
                      ...
                      background: '#16a34a', border: '1.5px solid rgba(255,255,255,0.8)',
                      display: 'flex', alignItems: 'center', justifyContent: 'center',
                ...
                <div style={{
                  ...
                  color: isCurrent ? 'rgba(255,255,255,0.95)' : isDone ? 'rgba(255,255,255,0.6)' : 'rgba(255,255,255,0.3)',
                  marginTop: 5, textAlign: 'center', lineHeight: 1.2, maxWidth: 44,
                  whiteSpace: 'nowrap',
                }}>
                  {stop.city}
                </div>
              ...
              {i < JOURNEY_CITIES.length - 1 && (
                <div style={{
                  ...
                  background: stop.level < currentLevel
      ...
      {!syncReady ? (
        ...
        <>
          ...
          <div className="progress-hero-count">
            Stage progress: {pathData.activeLvDone} / {pathData.activeLv.items.length} lessons · {pct}%
          </div>
