...
const SCENE_POOL = [
  {
    key: 'dubrovnik',
    img: '/images/scenes/dubrovnik-hero.webp',
    city: 'Dubrovnik',
    label: 'Adriatic Pearl',
  },
  {
    key: 'dalmatian',
    img: '/images/scenes/dalmatian-coast.webp',
    city: 'Dalmatian Coast',
    label: 'The Adriatic Sea',
  },
  {
    key: 'sibenik',
    img: '/images/scenes/dalmatian-ai.webp',
    city: '\u0160ibenik',
    label: 'City of St. James Cathedral',
  },
  { key: 'zagreb', img: '/images/scenes/zagreb.webp', city: 'Zagreb', label: 'The Capital' },
  {
    key: 'labin',
    img: '/images/scenes/labin.webp',
    city: 'Labin, Istria',
    label: 'Medieval Hilltop Town',
  },
  { key: 'mostar', img: '/images/scenes/mostar.webp', city: 'Mostar', label: 'Stari Most Bridge' },
  {
    key: 'food',
    img: '/images/scenes/croatian-food.webp',
    city: 'Croatian Cuisine',
    label: 'Taste of Croatia',
  },
];
...
export default function CroatiaPostcard({
  ...
  return (
    <motion.div
      initial={_isNative ? false : { opacity: 0, y: 16 }}
    ...
    >
      <VideoBackground
        ...
        style={{
          borderRadius: 18,
          marginBottom: 16,
          minHeight: dailyCulture ? 190 : 145,
              ...
              <>
                ...
                <div style={{ fontSize: 12, color: 'rgba(255,255,255,.75)', fontWeight: 600 }}>
                  ...
                  <span style={{ opacity: 0.55, marginLeft: 4 }}>
                    · {dailyCulture?.category || phrase.cat}
                  </span>
                </div>
              </>
            )}
