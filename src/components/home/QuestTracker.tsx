...
const QUEST_COLORS = {
  ...
  grammar: {
    bg: '#92400e',
    text: '#fff',
    shadow: 'rgba(146,64,14,.35)',
    border: 'rgba(146,64,14,.22)',
  },
  grammar2: {
    bg: '#92400e',
    text: '#fff',
  ...
  reading: {
    bg: '#14532d',
    text: '#fff',
    shadow: 'rgba(20,83,45,.35)',
    border: 'rgba(20,83,45,.22)',
  },
  reading2: {
    bg: '#14532d',
    text: '#fff',
  ...
  vocab: {
    bg: '#075985',
    text: '#fff',
    shadow: 'rgba(7,89,133,.35)',
    border: 'rgba(7,89,133,.22)',
  },
  vocab2: {
    bg: '#075985',
    text: '#fff',
  ...
  perfect: {
    bg: '#78350f',
    text: '#fff',
    shadow: 'rgba(120,53,15,.35)',
    border: 'rgba(120,53,15,.22)',
  },
};
    ...
    <div style={{ marginBottom: 20 }}>
      ...
      >
        <div
          style={{
            background:
              'linear-gradient(135deg, #3b0764 0%, #6d28d9 55%, var(--lavender,#7c3aed) 100%)',
            padding: '14px 18px',
          }}
        >
          ...
          <div style={{ marginTop: 10 }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 5 }}>
              ...
              >
                {allQuestsDone
                  ? 'All quests complete!'
                  : `${total - questsDoneCount} quest${total - questsDoneCount !== 1 ? 's' : ''} remaining`}
              </span>
              <span
                style={{
                  fontSize: 11,
                  fontWeight: 800,
                  color: allQuestsDone ? '#e9d5ff' : 'rgba(255,255,255,.85)',
                  fontFamily: 'var(--font-sans)',
                }}
              >
                {pct}%
          ...
          return (
            <div
              ...
              style={{
                ...
                boxShadow: done
                  ? 'none'
                  : `0 2px 12px ${qc.shadow.replace('.35', '.10')}, var(--card-shadow)`,
              ...
              onMouseEnter={(e) => {
                if (!done) {
                  ...
                  e.currentTarget.style.boxShadow = `0 6px 20px ${qc.shadow.replace('.35', '.2')}, var(--card-shadow-hover)`;
                }
              }}
              onMouseLeave={(e) => {
                ...
                <>
                  <button
                    ...
                    style={{
                      ...
                      cursor: 'pointer',
                      lineHeight: 1.4,
                      boxShadow: `0 3px 12px ${qc.shadow}`,
                      fontFamily: 'var(--font-sans)',
                      transition: 'transform .12s ease, box-shadow .12s ease',
                    }}
                    onMouseEnter={(e) => {
                      e.currentTarget.style.transform = 'scale(1.05)';
                      e.currentTarget.style.boxShadow = `0 5px 16px ${qc.shadow}`;
                    }}
                    onMouseLeave={(e) => {
                      e.currentTarget.style.transform = '';
                      e.currentTarget.style.boxShadow = `0 3px 12px ${qc.shadow}`;
                    }}
                    onPointerDown={(e) => {
        ...
        >
          ...
          >
            ...
            <div>
              ...
              >
                +50 XP bonus · All {total} quests complete
              </div>
            </div>
          </div>
        </div>
