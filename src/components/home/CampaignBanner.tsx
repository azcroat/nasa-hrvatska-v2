...
export default function CampaignBanner({
  ...
  const earnedXP =
    activeCampaign.quests?.filter((q) => campaignQuestsDone[q.id]).reduce((s, q) => s + q.xp, 0) ??
    0;
      ...
      >
        ...
        <button
          onClick={() => {
            ...
            localStorage.setItem('nh_campaign_dismissed_' + activeCampaign.id, '1');
          }}
          style={{
                  ...
                  return (
                    ...
                    >
                      <span
                        style={{
                          fontSize: 14,
                          color: done ? baseColor : 'var(--subtext)',
                          flexShrink: 0,
                        }}
                      >
                        {done ? '✓' : '○'}
