...
export default function DailyCroatianSection({ todayPhrases }) {
  ...
  return (
    <>
      ...
      >
        ...
        <div
          style={{
            ...
            inset: 0,
            background:
              'linear-gradient(105deg, transparent 30%, rgba(255,200,60,.07) 50%, transparent 70%)',
        ...
        <div
          style={{
            ...
            inset: 0,
            background:
              'linear-gradient(to bottom, rgba(0,0,0,.08) 0%, transparent 40%, rgba(0,0,0,.35) 100%)',
            pointerEvents: 'none',
          }}
        />
        {/* Location badge */}
      ...
      <div
        style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 12, marginTop: 24 }}
      >
        <div
          style={{
            width: 3,
            height: 20,
            background: 'var(--color-croatian,#D40030)',
            borderRadius: 2,
            flexShrink: 0,
          }}
        />
