...
export function markRecapShown() {
  try {
    localStorage.setItem(recapShownKey(), '1');
  } catch {}
}
...
export default function WeeklyRecapModal({ onClose, onMount }) {
  ...
  const prevXP = (() => {
    try {
      return parseInt(localStorage.getItem('nh_week_xp_' + prevWeekKey()) || '0', 10);
    } catch {
      return 0;
    }
  })();
      ...
      >
          ...
          >
            <span
              style={{
                fontSize: 13,
                fontWeight: 800,
                color: goalMet ? 'var(--success)' : 'var(--info)',
                letterSpacing: '.04em',
          ...
          >
            <div
              style={{
                ...
                background: goalMet
                  ? 'var(--success)'
                  : 'linear-gradient(90deg, var(--info), var(--info-light, #38bdf8))',
                borderRadius: 6,
        ...
        >
          ...
          >
            ...
            <div>
              <div
                style={{ fontSize: 20, fontWeight: 900, color: 'var(--heading)', lineHeight: 1 }}
              >
                {streak.count}
              </div>
              <div
