          ...
          {[
            {
              ...
              reason: 'Reinforce words with spaced repetition',
              duration: 5,
            },
            {
              id: 'shadowing',
              ...
              reason: 'Train your ear and pronunciation',
              duration: 10,
            },
            {
              id: 'writing',
              ...
              reason: 'Build sentence construction skills',
              duration: 10,
            },
          ].map((act) => (
            <button
              key={act.id}
              onClick={() => setScr && setScr(act.id)}
              style={{
                display: 'flex',
                alignItems: 'center',
                gap: 12,
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 4 }}>
            ...
            <span
              style={{
                fontSize: 10,
                fontWeight: 800,
                color: allDone ? '#86efac' : 'rgba(255,255,255,.8)',
              }}
            >
          ...
          >
            <div
              style={{
                ...
                background: allDone ? '#86efac' : 'rgba(255,255,255,.75)',
                borderRadius: 3,
                ...
                >
                  <span
                    style={{
                      fontSize: 14,
                      fontWeight: 800,
                      color: isDone ? 'var(--subtext)' : 'var(--heading)',
