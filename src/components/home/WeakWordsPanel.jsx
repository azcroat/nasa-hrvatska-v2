...
export default function WeakWordsPanel({ setScr }) {
  ...
  return (
    <div style={{ marginBottom: 16, borderRadius: 18, overflow: 'hidden', boxShadow: '0 4px 20px rgba(220,38,38,.15)', border: '1.5px solid rgba(220,38,38,.2)' }}>
      ...
      <div style={{
        ...
        <button
          ...
          style={{
            padding: '8px 14px', borderRadius: 10, border: '1.5px solid rgba(255,255,255,.4)',
            background: 'rgba(255,255,255,.15)', color: '#fff', fontSize: 12, fontWeight: 800,
      ...
      <div style={{ background: 'var(--card)', padding: '10px 12px 12px' }}>
            ...
            return (
              <div key={word} style={{
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 4 }}>
                    ...
                    <button
                      ...
                      style={{ background: 'none', border: 'none', cursor: 'pointer', padding: 0, fontSize: 14, opacity: 0.6, flexShrink: 0 }}
                    >🔊</button>
                  </div>
                ...
                <div style={{ flexShrink: 0, textAlign: 'right' }}>
                  <div style={{ fontSize: 10, color: 'var(--subtext)', fontWeight: 600 }}>{total} reviews</div>
                  {lapses > 0 && (
                    <div style={{ fontSize: 10, color: '#dc2626', fontWeight: 700 }}>{lapses} lapse{lapses !== 1 ? 's' : ''}</div>
                  )}
                </div>
              </div>
            );
        ...
        {weakWords.length >= 8 && (
          <button
            ...
            style={{
              width: '100%', marginTop: 8, height: 36,
