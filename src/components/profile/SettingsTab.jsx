...
export default function SettingsTab({ syncReady, onSyncNow }) {
  ...
  const [reminderTime, setReminderTime] = useState(() => localStorage.getItem('nh_reminder_time') || '20:00');
        ...
        {notifPermission === 'granted' && (
          <>
            ...
            <div style={{ marginTop: 14, display: 'flex', alignItems: 'center', gap: 12 }}>
              ...
              <div style={{ flex: 1 }}>
                <div style={{ fontSize: 12, fontWeight: 800, color: 'var(--heading)', marginBottom: 4 }}>
                  Daily reminder time
                </div>
                <select
                  value={reminderTime}
                  onChange={e => {
                    ...
                    setReminderTime(t);
                    try { localStorage.setItem('nh_reminder_time', t); } catch (_) {}
                  }}
                  style={{
