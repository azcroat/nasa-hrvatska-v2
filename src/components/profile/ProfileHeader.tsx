    ...
    >
      ...
      <div
        style={{
          ...
          height: '100%',
          background:
            'radial-gradient(ellipse at 50% 20%, rgba(14,116,144,.28) 0%, transparent 65%)',
          pointerEvents: 'none',
        }}
      />
      {/* Decorative circles */}
      ...
      <CroatianKnight
        size={50}
        mood="encouraged"
        style={{ margin: '8px auto 0', display: 'block', position: 'relative', zIndex: 1 }}
      />
      <div
        style={{
