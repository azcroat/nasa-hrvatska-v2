...
const ISSUE_TYPES = [
  ...
  },
  {
    ...
    color: '#ca8a04',
    bg: '#fefce8',
    desc: 'Wrong translation or text',
  },
  {
    id: 'question',
    icon: '❓',
  ...
  if (ticket)
    return (
      ...
      >
        ...
        <button className="b bp" onClick={goBack} style={{ minWidth: 160 }}>
          ← Back to Profile
        </button>
      </div>
    );
    ...
    <div className="scr-wrap">
          ...
          {ISSUE_TYPES.map((t) => (
            <button
              ...
              style={{
                ...
                borderRadius: 12,
                background: type === t.id ? t.bg : 'var(--card)',
                cursor: 'pointer',
                textAlign: 'left',
                transition: 'all .15s',
              }}
      ...
      >
        {loading
          ? 'Sending…'
          : selected
            ? `Send ${selected.icon} ${selected.label}`
            : 'Send Report'}
      </button>
