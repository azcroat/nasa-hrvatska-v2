...
export default function CertificateScreen({
  ...
  async function handleShare() {
    ...
    try {
      ...
      ctx.fillRect(0, 0, 267, 8);
      ctx.fillStyle = '#F5F5F5';
      ctx.fillRect(267, 0, 266, 8);
      ctx.fillStyle = '#003DA5';
      ctx.fillRect(533, 0, 267, 8);
      // App name
      ...
      ctx.fillText(
        `⭐ ${st.xp.toLocaleString()} XP   📚 ${st.lc} lessons   🔥 ${streak.count}-day streak`,
        60,
        260,
      );
      // Date
  ...
  return (
    <div className="scr-wrap">
      <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 24 }}>
        ...
        <h2 style={{ fontSize: 18, fontWeight: 900, color: 'var(--heading)', flex: 1 }}>
      ...
      >
        ...
        >
          ...
          <div style={{ fontSize: 13, opacity: 0.75 }}>Croatian Language Achievement</div>
        </div>
