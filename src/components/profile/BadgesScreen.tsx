          ...
          return (
            <div
              ...
              style={{
                textAlign: 'center',
                opacity: u ? 1 : 0.6,
                border: u ? '2px solid var(--warning)' : '1.5px dashed var(--card-b)',
              }}
            >
                ...
                <div style={{ marginTop: 8 }}>
                  ...
                  >
                    <div
                      style={{
                        height: '100%',
                        width: `${Math.round((prog.cur / prog.total) * 100)}%`,
                  ...
                  <div style={{ fontSize: 10, color: 'var(--subtext)', fontWeight: 700 }}>
                    🔒 {prog.cur.toLocaleString()} / {prog.total.toLocaleString()}
                  </div>
                </div>
              ) : (
                <div
                  style={{ fontSize: 10, color: 'var(--subtext)', marginTop: 6, fontWeight: 600 }}
                >
                  🔒 {b.d}
                </div>
              )}
