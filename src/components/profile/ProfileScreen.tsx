              ...
              {AVATAR_EMOJIS.map((em) => (
                <button
                  ...
                  onClick={() => {
                    setAvatarEmoji(em);
                    try {
                      localStorage.setItem('nh_avatar_emoji', em);
                    } catch {}
                    setShowEmojiPicker(false);
                  }}
                  style={{
                    fontSize: 28,
                    background: avatarEmoji === em ? 'var(--info-bg)' : 'var(--bar-bg)',
                    border: avatarEmoji === em ? '2px solid var(--info)' : '2px solid transparent',
                    borderRadius: 10,
                    width: 44,
                    height: 44,
                    cursor: 'pointer',
            ...
            {avatarEmoji && (
              <button
                onClick={() => {
                  setAvatarEmoji('');
                  try {
                    localStorage.removeItem('nh_avatar_emoji');
                  } catch {}
                  setShowEmojiPicker(false);
                }}
                style={{
