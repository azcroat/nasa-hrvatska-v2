...
export default function TravelScene() {
  return (
    <svg
      ...
      role="img"
      aria-label="Croatian coastal road trip"
    >
      <defs>
        {/* Sky */}
      ...
      {/* Sea */}
      <path
        d="M 0 100 Q 60 95 140 98 Q 200 101 280 96 L 280 180 L 0 180 Z"
        fill="url(#vs-travel-sea)"
      />

      {/* Sea shimmer lines */}
      <path
        d="M 10 115 Q 60 112 110 116"
        stroke="url(#vs-travel-shimmer)"
        strokeWidth="1.5"
        fill="none"
        opacity="0.5"
      />
      <path
        d="M 5 125 Q 70 121 130 126"
        stroke="url(#vs-travel-shimmer)"
        strokeWidth="1"
        fill="none"
        opacity="0.4"
      ...
      <path
        d="M 160 100 Q 175 70 195 65 Q 215 62 230 72 Q 248 80 260 100 Z"
        fill="url(#vs-travel-cliff1)"
      />
      {/* Cliff detail lines */}
      <path
        d="M 185 85 Q 195 78 205 82"
        stroke="#998070"
        strokeWidth="0.8"
        fill="none"
        opacity="0.5"
      ...
      <path
        d="M 155 100 Q 162 78 178 73 Q 192 70 205 78 Q 218 86 224 100 Z"
        fill="url(#vs-travel-cliff2)"
      />
      <path
        d="M 168 90 Q 178 82 188 87"
        stroke="#B0A090"
        strokeWidth="0.8"
        fill="none"
        opacity="0.5"
      ...
      {[0, 1, 2, 3, 4, 5, 6].map((i) => {
        const t0 = i / 7;
        const t1 = (i + 0.45) / 7;
        const x0 = 80 + t0 * (200 - 80),
          y0 = 180 + t0 * (100 - 180);
        const x1b = 80 + t1 * (200 - 80),
          y1b = 180 + t1 * (100 - 180);
      ...
      <path
        d="M 84 175 Q 95 165 105 158 Q 115 150 120 143"
        stroke="#607D8B"
        strokeWidth="0.6"
        fill="none"
        opacity="0.4"
      ...
      <g>
        ...
        {/* Hull */}
        <path
          d="M 28 122 Q 22 128 28 132 Q 55 140 82 132 Q 88 128 82 122 Z"
          fill="#F5F5F5"
          stroke="#DDDDDD"
          strokeWidth="0.8"
        />
      ...
      {/* ── Seagulls ── */}
      <path
        d="M 65 52 Q 68 48 71 52 Q 74 48 77 52"
        stroke="#546E7A"
        strokeWidth="1.5"
        fill="none"
        strokeLinecap="round"
      />
      <path
        d="M 100 40 Q 103 37 106 40 Q 109 37 112 40"
        stroke="#546E7A"
        strokeWidth="1.3"
        fill="none"
        strokeLinecap="round"
      />
      <path
        d="M 135 58 Q 137 55 139 58 Q 141 55 143 58"
        stroke="#607D8B"
        strokeWidth="1.2"
        fill="none"
        strokeLinecap="round"
