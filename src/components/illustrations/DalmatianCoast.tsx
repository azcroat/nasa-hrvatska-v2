    ...
    >
      ...
      {[0, 30, 60, 90, 120, 150, 180, 210, 240, 270, 300, 330].map((a, i) => {
        ...
        return (
          <line
            key={i}
            x1={480 + Math.cos(rad) * r1}
            y1={158 + Math.sin(rad) * r1}
            x2={480 + Math.cos(rad) * r2}
            y2={158 + Math.sin(rad) * r2}
            stroke="#fde68a"
      ...
      {[15, 45, 75, 105, 135, 165, 195, 225, 255, 285, 315, 345].map((a, i) => {
        ...
        return (
          <line
            key={i}
            x1={480 + Math.cos(rad) * 20}
            y1={158 + Math.sin(rad) * 20}
            x2={480 + Math.cos(rad) * (60 + i * 4)}
            y2={158 + Math.sin(rad) * (60 + i * 4)}
            stroke="#f9d150"
            strokeWidth="0.5"
            opacity="0.25"
      ...
      <ellipse
        ...
        rx="80"
        ry="14"
        fill="rgba(80,100,120,0.35)"
        filter="url(#dc2-atmBlur)"
      />
      <path
        d="M 440 152 Q 480 140 520 144 Q 560 138 600 150 L 600 160 L 440 160 Z"
        fill="url(#dc2-isle2)"
        filter="url(#dc2-atmBlur)"
        opacity="0.8"
      />
      ...
      <path
        d="M 360 152 Q 395 138 430 143 Q 455 136 480 148 L 480 162 L 360 162 Z"
        fill="url(#dc2-isle2)"
        opacity="0.75"
      />
      ...
      <path
        d="M 0 152 Q 60 128 140 138 Q 200 130 260 148 L 260 165 L 0 165 Z"
        fill="url(#dc2-isle1)"
        opacity="0.9"
      />
      ...
      {[318, 346, 372, 396].map((x, i) => (
        <React.Fragment key={i}>
          ...
          />
          <polygon
            points={`${x - 2},${108 + i * 4} ${x + 12 - i},${90 + i * 3} ${x + 28 - i * 2},${108 + i * 4}`}
            fill="url(#dc2-roof)"
            opacity={0.8 - i * 0.1}
          />
        </React.Fragment>
      ...
      <path d="M 0 162 L 420 162 L 420 170 Q 350 174 250 172 Q 140 170 0 172 Z" fill="#d8cdb0" />
      ...
      {[410, 428, 446, 462].map((x, i) => (
        <React.Fragment key={i}>
          {/* Gnarled trunk */}
          <polygon points={`${x},172 ${x + 2},164 ${x + 4},164 ${x + 5},172`} fill="#6b4c2a" />
      ...
      <path d="M 390 152 L 480 152 L 560 260 L 400 260 Z" fill="url(#dc2-sunPath)" opacity="0.55" />
      {/* Caustic light shimmer on water */}
      <path d="M 430 152 L 495 152 L 545 230 L 445 230 Z" fill="url(#dc2-sunPath)" opacity="0.3" />

      {/* ── Wave layers ── */}
      <g style={{ animation: 'dc2Wave 5s ease-in-out infinite' }}>
        {/* Near waves — most detail */}
        <path
          d="M 0 170 Q 40 164 80 170 Q 120 176 160 170 Q 200 164 240 170 Q 280 176 320 170 Q 360 164 400 170 Q 440 176 480 170 Q 520 164 560 170 Q 600 176 640 170"
          stroke="rgba(255,255,255,0.4)"
          strokeWidth="1.8"
          fill="none"
        />
        <path
          d="M 0 182 Q 50 176 100 182 Q 160 188 210 182 Q 270 176 320 182 Q 380 188 430 182 Q 490 176 540 182 Q 590 188 640 182"
          stroke="rgba(255,255,255,0.28)"
          strokeWidth="1.4"
          fill="none"
        />
        <path
          d="M 0 196 Q 60 190 120 196 Q 185 202 250 196 Q 310 190 370 196 Q 430 202 500 196 Q 565 190 640 196"
          stroke="rgba(255,255,255,0.18)"
          strokeWidth="1.2"
          fill="none"
        />
        <path
          d="M 0 212 Q 70 207 140 212 Q 210 218 280 212 Q 350 207 420 212 Q 490 218 560 212 Q 600 209 640 212"
          stroke="rgba(255,255,255,0.12)"
          strokeWidth="1"
          fill="none"
        />
        <path
          d="M 0 230 Q 80 226 160 230 Q 240 234 320 230 Q 400 226 480 230 Q 560 234 640 230"
      ...
      {/* ── Main sailing vessel ── */}
      <g
        style={{ animation: 'dc2Bob 3.8s ease-in-out infinite', transformOrigin: '320px 70%' }}
        filter="url(#dc2-boatShadow)"
      >
        {/* Hull — classic trabakul shape */}
        <path
          d="M 288 218 Q 316 212 344 218 L 340 228 Q 316 224 292 228 Z"
          fill="#e8d8b0"
          stroke="#c8b880"
          strokeWidth="0.8"
        />
        ...
        <path
          d="M 316 218 Q 296 200 280 168 Q 300 178 316 218 Z"
          fill="white"
          stroke="#d8cbb0"
          strokeWidth="0.8"
          opacity="0.95"
        ...
        <path
          d="M 316 218 Q 302 202 292 175 Q 286 168 280 168"
          fill="none"
        ...
        {/* Jib / foresail */}
        <path
          d="M 316 218 Q 330 200 346 168 Q 332 180 316 218 Z"
          fill="#D40030"
          stroke="#8a1000"
          strokeWidth="0.8"
          opacity="0.88"
        ...
        <g
          style={{ animation: 'dc2Flag 2.5s ease-in-out infinite', transformOrigin: '316px 168px' }}
        >
        ...
        <path
          d="M 292 228 Q 316 232 340 228 L 344 238 Q 316 244 288 238 Z"
          fill="rgba(232,216,176,0.2)"
          opacity="0.5"
        />
      </g>
      ...
      <g
        style={{ animation: 'dc2Bob 4.5s ease-in-out .8s infinite', transformOrigin: '180px 70%' }}
        opacity="0.75"
      >
        <path d="M 158 186 Q 172 182 186 186 L 184 192 Q 172 189 160 192 Z" fill="#d4c8a0" />
        <rect x="170.5" y="172" width="2" height="16" fill="#5c4033" rx="0.5" />
        <path d="M 171 186 Q 163 180 158 172 Q 167 176 171 186 Z" fill="rgba(255,255,255,0.85)" />
        <path d="M 172 186 Q 179 179 183 172 Q 176 177 172 186 Z" fill="#D40030" opacity="0.75" />
      </g>

      {/* ── Far distant boat silhouette ── */}
      <g opacity="0.45">
        <path d="M 560 168 Q 575 165 590 168 L 589 172 Q 575 170 561 172 Z" fill="#0e4a60" />
        <rect x="574.5" y="157" width="1.5" height="12" fill="#0e3a4a" />
        <path d="M 575 168 Q 569 163 563 157 Q 570 161 575 168 Z" fill="rgba(255,255,255,0.5)" />
        <path d="M 575 168 Q 580 162 585 157 Q 579 162 575 168 Z" fill="#D40030" opacity="0.5" />
      </g>
      ...
      {/* Sea horizon glow */}
      <rect x="0" y="150" width="640" height="6" fill="rgba(249,210,130,0.22)" />
      ...
      {/* ── Foreground sea foam ── */}
      <path
        d="M 0 252 Q 50 246 100 252 Q 150 258 200 252 Q 250 246 300 252 Q 350 258 400 252 Q 450 246 500 252 Q 550 258 600 252 L 640 252 L 640 260 L 0 260 Z"
