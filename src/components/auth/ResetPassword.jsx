    ...
    <div style={{...BG,display:"flex",alignItems:"center",justifyContent:"center",padding:24}}>
      <div style={{width:"100%",maxWidth:420,animation:"rise .5s",position:"relative",zIndex:1}}>
        ...
        <div className="c" style={{padding:28}}>
          ...
          <label htmlFor="reset-email" style={{fontSize:12,fontWeight:700,color:"#78716c",display:"block",marginBottom:6}}>EMAIL ADDRESS</label>
          ...
          <div style={{textAlign:"center",marginTop:20,fontSize:14,color:"#78716c"}}>
            <button type="button" style={{color:"#0e7490",cursor:"pointer",fontWeight:700,background:"none",border:"none",padding:0,fontSize:"inherit",fontFamily:"inherit"}} onClick={()=>{setAuthScreen("login");setAuthError("");setRpEm("")}}>← Back to Sign In</button>
          </div>
        </div>
      </div>
    </div>
