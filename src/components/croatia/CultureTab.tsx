    ...
    <React.Fragment>
      ...
      <div className="section-block">
        <div className="section-hdr">
          <div className="section-hdr-icon" style={{ background: 'rgba(212,0,48,.12)' }}>
            🏰
          </div>
        ...
        <div
          onClick={() => {
            if (!expandedCtx['history']) incrementCulture('regionCnt');
            toggleCtx('history');
          }}
          style={{
            fontSize: 12,
        ...
        {!!expandedCtx['history'] && (
          ...
          >
            🏰 <strong>Croatian history</strong> is woven into everyday conversation. References to
            the Domovinski Rat, Vukovar, and the medieval kings are part of how Croatians identify
            themselves. Understanding this context makes your Croatian feel genuine and earns
            respect from native speakers.
          </div>
        )}
        <div className="g2" style={{ gap: 8 }}>
          {[
            [
              ...
              '🇭🇷',
              'Domovinski Rat',
              '1991–1995 Homeland War',
              '#dc2626',
              'history',
            ],
            [
              () => setScr('region_vukovar'),
              '🕯️',
              'Vukovar',
              'Hero city — a deep dive',
              '#dc2626',
              'history',
            ],
            [
            ...
            [
              ...
              '🌊',
              'Split',
              'Rome on the Adriatic',
              '#0284c7',
              'history',
            ],
            [
              () => setScr('region_mostar'),
              '🌉',
              'Mostar',
              'The bridge reborn',
              'var(--lavender, #7c3aed)',
            ...
            [
              () => setScr('region_tomislavgrad'),
              '👑',
              'Tomislavgrad',
              'Where the kingdom was born',
              '#b45309',
              'history',
            ],
            [
            ...
            [
              () => setScr('region_vinkovci'),
              '🏛️',
              'Vinkovci',
              '8,300 years of history',
              '#78716c',
              'history',
            ],
      ...
      <div className="section-block">
        ...
        >
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 4, flexShrink: 0 }}>
            ...
            <span style={{ fontSize: 9, color: 'var(--subtext)', textAlign: 'center' }}>
              4 personas
            </span>
          </div>
          ...
          {/* Text content */}
          <div>
            <div style={{ fontSize: 17, fontWeight: 900, color: '#D4002D', marginBottom: 3 }}>
            ...
            >
              Choose from 4 conversation partners
            </div>
        ...
        <div className="g3" style={{ gap: 10 }}>
          ...
          >
            ...
            <div style={{ fontSize: 'var(--text-sm)', fontWeight: 800, color: 'var(--warning)' }}>
              Baka's Summer
            </div>
            <div
              style={{
          ...
          >
            <div style={{ fontSize: 26, marginBottom: 6 }}>📰</div>
            <div style={{ fontSize: 'var(--text-sm)', fontWeight: 800, color: 'var(--info)' }}>
              Croatia Today
            </div>
            <div
              style={{
          ...
          <button
            onClick={() => setScr('survival_dinner')}
            style={{
              padding: '14px 12px',
              borderRadius: 14,
          ...
          >
            ...
            <div style={{ fontSize: 'var(--text-sm)', fontWeight: 800, color: 'var(--success)' }}>
              At the Table
            </div>
            <div
              style={{
          ...
          >
            ...
            <div style={{ fontSize: 26, marginBottom: 6 }}>📮</div>
            <div style={{ fontSize: 'var(--text-sm)', fontWeight: 800, color: '#7c3aed' }}>
              Postcard
            </div>
            <div
              style={{ fontSize: 'var(--text-xs)', color: '#7c3aed', marginTop: 2, opacity: 0.75 }}
            >
              Write & share in Croatian
            </div>
          </button>
          <button
            onClick={() => setScr('storymode')}
            style={{
              padding: '14px 12px',
              borderRadius: 14,
              border: '1.5px solid rgba(14,116,144,.3)',
          ...
          >
            ...
            >
              AI stories set in Croatia
            </div>
          </button>
          <button
            onClick={() => setScr('heritage')}
            style={{
              padding: '14px 12px',
              borderRadius: 14,
          ...
          >
            ...
            <div style={{ fontSize: 26, marginBottom: 6 }}>🧬</div>
            <div style={{ fontSize: 'var(--text-sm)', fontWeight: 800, color: '#b45309' }}>
              Your Heritage
            </div>
            <div
              style={{ fontSize: 'var(--text-xs)', color: '#b45309', marginTop: 2, opacity: 0.75 }}
            >
              Discover your Croatian roots
            </div>
          </button>
          <button
            onClick={() => setScr('croatianews')}
            style={{
              padding: '14px 12px',
              borderRadius: 14,
              border: '1.5px solid rgba(3,105,161,.3)',
          ...
          >
            ...
            <div style={{ fontSize: 26, marginBottom: 6 }}>🗞️</div>
            <div style={{ fontSize: 'var(--text-sm)', fontWeight: 800, color: '#0369a1' }}>
              Croatian News
            </div>
            <div
              style={{ fontSize: 'var(--text-xs)', color: '#0369a1', marginTop: 2, opacity: 0.75 }}
            >
              Real news at your level
            </div>
          </button>
          <button
            onClick={() => setScr('phraseofday')}
            style={{
              padding: '14px 12px',
              borderRadius: 14,
          ...
          >
            ...
            <div style={{ fontSize: 26, marginBottom: 6 }}>💬</div>
            <div style={{ fontSize: 'var(--text-sm)', fontWeight: 800, color: '#db2777' }}>
              Phrase of the Day
            </div>
            <div
              style={{ fontSize: 'var(--text-xs)', color: '#db2777', marginTop: 2, opacity: 0.75 }}
            >
              Daily cultural expressions
            </div>
          </button>
          ...
          {(() => {
            ...
            const done =
              localStorage.getItem('nh_uskrs_kviz_done') === '1' ||
            ...
            return (
              ...
              >
                ...
                <div style={{ fontSize: 'var(--text-sm)', fontWeight: 800, color: '#166534' }}>
                  Uskrs u Hrvatskoj
                </div>
                <div
                  style={{
      ...
      <div className="section-block">
        ...
        >
          <div style={{ padding: '14px 16px', display: 'flex', alignItems: 'center', gap: 14 }}>
            ...
            <div style={{ flex: 1, textAlign: 'left' }}>
              ...
              <div style={{ fontSize: 10, color: 'rgba(255,255,255,.7)', lineHeight: 1.4 }}>
                47 real-life scenarios · speak Croatian now
              </div>
            </div>
            <div
              style={{
        ...
        >
          ...
          <div style={{ flex: 1 }}>
            ...
            <div style={{ fontSize: 'var(--text-xs)', color: 'var(--info)', opacity: 0.75 }}>
              A1 → C2 pathway
            </div>
          </div>
          <span style={{ fontSize: 14, color: 'var(--info)', opacity: 0.6 }}>→</span>
        </button>
      </div>
      ...
      <div className="section-block">
        ...
        <div
          onClick={() => {
            if (!expandedCtx['kafic']) incrementCulture('regionCnt');
            toggleCtx('kafic');
          }}
          style={{
            fontSize: 12,
        ...
        {!!expandedCtx['kafic'] && (
          ...
          >
            ☕ <strong>U Kafiću</strong> (At the Café) is where Croatian social life happens.
            Croatians spend hours in kafići — it's not just coffee, it's connection. Mastering café
            vocabulary and small talk unlocks the most natural everyday conversations you'll ever
            have.
          </div>
        )}
          ...
          {[
            {
              icon: '☕',
              title: 'U Kafiću',
              desc: 'The art of Croatian coffee culture',
              accent: 'rgba(245,158,11,.25)',
              scr: 'kafic',
            },
            {
              icon: '💙',
              title: 'Diaspora Croatian',
              desc: 'Code-switching & heritage language',
              accent: 'rgba(14,116,144,.25)',
              scr: 'diaspora',
            },
            {
              icon: '🎊',
              title: 'Life Events',
              desc: 'Weddings, funerals, baptisms',
            ...
            },
            {
              ...
              desc: 'Vocabulary to read the news',
              accent: 'rgba(22,163,74,.25)',
              scr: 'civic',
            },
          ].map((c) => (
            <button
      ...
      <div className="section-block">
        ...
        <button
          className="tc"
          style={{ display: 'flex', alignItems: 'center', gap: 12, padding: '16px', width: '100%' }}
          onClick={() => {
            setScr('crmap');
          }}
        >
          ...
          <div>
            ...
            <div style={{ fontSize: 'var(--text-sm)', color: 'var(--subtext)' }}>
              Explore Croatia — cities, parks, beaches, islands
            </div>
          </div>
        </button>
      </div>
