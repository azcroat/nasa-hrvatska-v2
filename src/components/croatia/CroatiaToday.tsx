...
Trener Hajduka rekao je na presici: "Svaka utakmica protiv Dinama posebna je za nas. Igrači su fokusirani i motivirani. Vjerujem da ćemo pokazati karakter." Utakmica se igra u nedjelju, a ulaznice su rasprodane već tjednima.`,
    ...
    vocab: [
      ...
      { hr: 'momčad', en: 'team', example: 'Trener je zadovoljan igrom momčadi.' },
      {
        hr: 'tribine',
        en: 'stands (stadium)',
        example: 'Navijači s tribina pjevaju i bodre momčad.',
      },
      {
        hr: 'presica',
        en: 'press conference',
        example: 'Trener je rekao na presici da su igrači motivirani.',
      },
      { hr: 'rasprodane', en: 'sold out', example: 'Ulaznice su rasprodane već tjednima.' },
      {
        hr: 'forma',
        en: 'form / condition',
        example: 'Dinamo dolazi na utakmicu s odličnom formom.',
      },
      {
        hr: 'natjecanje',
        en: 'competition',
        example: 'Hajduk je pokazao kvalitetu u europskim natjecanjima.',
      },
    ],
  },
  {
    ...
    headline:
      'Hrvatska bilježi rekordnu turističku sezonu: više od 22 milijuna posjetitelja u 2025. godini',
...
Turistički radnici ističu da sve više stranaca dolazi po drugi ili treći put, što pokazuje da Hrvatska nije samo ljetna destinacija, već zemlja kojoj se posjetitelji rado vraćaju.`,
    summary:
      'Croatia recorded a historic tourism season in 2025, welcoming 22.4 million visitors — 8% more than the previous year — generating €15 billion in revenue (about 20% of GDP). Growth was strongest on Dalmatian islands and in continental agrotourism regions. The government plans to invest in sustainable tourism to reduce pressure on hotspots like Dubrovnik and Plitvice.',
    vocab: [
      {
        hr: 'posjetitelji',
        en: 'visitors',
        example: 'Hrvatska je primila više od 22 milijuna posjetitelja.',
      },
      {
        hr: 'prihodi',
        en: 'revenues / income',
        example: 'Prihodi od turizma dosegli su 15 milijardi eura.',
      },
      { hr: 'održivi', en: 'sustainable', example: 'Vlada planira investirati u održivi turizam.' },
      {
        hr: 'agroturizam',
        en: 'agrotourism',
        example: 'Agroturizam privlači posjetitelje koji žele autentično iskustvo.',
      },
      {
        hr: 'pritisak',
        en: 'pressure',
        example: 'Novi projekti smanjit će pritisak na najposjećenija mjesta.',
      },
      {
        hr: 'boravili',
        en: 'stayed / spent time',
        example: 'Turisti su sve dulje boravili na otocima.',
      },
    ],
  },
  {
...
No izazovi ostaju. Klimatske promjene utječu na razinu vode u jezerima, a masovni turizam zahtijeva pametno upravljanje. Park je već uveo elektroničke ulaznice i ograničio dnevni broj posjetitelja na 8.000 kako bi sačuvao osjetljivi ekosustav.`,
    ...
    vocab: [
      ...
      },
      {
        hr: 'staništa',
        en: 'habitats',
        example: 'Program obnove staništa divljih životinja ostvario je uspjeh.',
      },
      {
        hr: 'raznolikost',
        en: 'diversity',
        example: 'Biološka raznolikost parka povećana je za 12 posto.',
      },
      {
        hr: 'ekosustav',
        en: 'ecosystem',
        example: 'Broj posjetitelja ograničen je kako bi se sačuvao ekosustav.',
      },
      {
        hr: 'izazovi',
        en: 'challenges',
        example: 'Klimatske promjene ostaju veliki izazovi za park.',
      },
      {
        hr: 'upravljanje',
        en: 'management',
        example: 'Masovni turizam zahtijeva pametno upravljanje.',
      },
    ],
  },
  {
    ...
    vocab: [
      {
        hr: 'brodogradilište',
        en: 'shipyard',
        example: 'Brodosplit je jedno od najstarijih brodogradilišta na Mediteranu.',
      },
      {
        hr: 'ugovor',
        en: 'contract',
        example: 'Kompanija je potpisala ugovor vrijedan 600 milijuna eura.',
      },
      { hr: 'kapacitet', en: 'capacity', example: 'Svaki kruzer ima kapacitet 2.400 putnika.' },
      {
        hr: 'neizravnih',
        en: 'indirect',
        example: 'Projekt će stvoriti 1.200 neizravnih radnih mjesta.',
      },
      {
        hr: 'dobavljači',
        en: 'suppliers',
        example: 'Dobit će koristi i dobavljačka poduzeća u regiji.',
      },
      {
        hr: 'oporavak',
        en: 'recovery',
        example: 'Europsko brodograditeljstvo doživljava oporavak.',
      },
    ],
  },
  {
...
Hrvatska turistička zajednica prepoznala je klapa pjevanje kao važan dio turističke ponude. Restorani u Splitu, Trogiru i Dubrovniku nude klapa večere, a mnogi turisti govore da je taj doživljaj najdragocjeniji uspomeni s odmora.`,
    ...
    vocab: [
      {
        hr: 'višeglasno',
        en: 'multi-voice / polyphonic',
        example: 'Klapa je tradicijsko višeglasno pjevanje iz Dalmacije.',
      },
      {
        hr: 'ansambl',
        en: 'ensemble / group',
      ...
      },
      {
        hr: 'nematerijalna',
        en: 'intangible',
        example: 'Klapa je upisana na popis nematerijalne kulturne baštine.',
      },
      {
        hr: 'izvedba',
        en: 'performance',
        example: 'Njihova izvedba pjesme bila je digitalna senzacija.',
      },
      {
        hr: 'pratitelji',
        en: 'followers / subscribers',
        example: 'Kanal ima više od 400.000 pratitelja.',
      },
      {
        hr: 'suradnja',
        en: 'collaboration',
        example: 'Producenti su kontaktirali ansamble zbog suradnje.',
      },
      {
        hr: 'doživljaj',
        en: 'experience',
...
Maraton je ujedno bio humanitarnog karaktera — prikupljeno je 45.000 eura za obnovu sportskih terena u školama diljem splitsko-dalmatinske županije.`,
    summary:
      "The 23rd Split Marathon drew 12,340 runners from 60 countries through the streets of Diocletian's Palace and along the Adriatic waterfront in perfect conditions. Kenyan athlete Joseph Kipchoge (training in Dalmatia) won the men's race, while Croatian Ana Kovačić set a new national record in the women's category. The event raised €45,000 for school sports facilities.",
    vocab: [
      {
        hr: 'sudionici',
        en: 'participants',
        example: 'Maraton je postavio novi rekord po broju sudionika.',
      },
      {
        hr: 'dionica',
        en: 'section / distance segment',
        example: '4.200 trkača trčalo je punu maratonsku dionicu.',
      },
      {
        hr: 'kulisa',
        en: 'backdrop / setting',
        example: 'Split Marathon poznat je po iznimnoj kulisi.',
      },
      { hr: 'povetarac', en: 'light breeze', example: 'Blagi povetarac s mora hladio je trkače.' },
      {
        hr: 'humanitarno',
        en: 'charitable / humanitarian',
        example: 'Maraton je bio humanitarnog karaktera.',
      },
      {
        hr: 'prikupljeno',
        en: 'collected / raised',
        example: 'Prikupljeno je 45.000 eura za sportske terene.',
      },
    ],
  },
  {
...
Hrvatska vlada pohvalila je uspjeh mlade tvrtke i najavila nove poticaje za startupe u sektoru zdravstvenih tehnologija, uključujući lakši pristup fondovima Europske unije.`,
    ...
    vocab: [
      {
        hr: 'prikupila',
        en: 'raised / collected (funds)',
        example: 'Tvrtka je prikupila 18 milijuna eura od investitora.',
      },
      {
        hr: 'detekcija',
        en: 'detection',
        example: 'Alati za ranu detekciju raka spašavaju živote.',
      },
      {
        hr: 'preciznost',
        en: 'precision / accuracy',
        example: 'Sustav je postigao veliku preciznost u testiranjima.',
      },
      {
        hr: 'pravednost',
        en: 'fairness / equity',
        example: 'To je pitanje pravednosti u zdravlju.',
      },
      { hr: 'poticaji', en: 'incentives', example: 'Vlada je najavila nove poticaje za startupe.' },
      {
        hr: 'proširiti se',
        en: 'to expand',
        example: 'Tvrtka planira proširiti se na europska tržišta.',
      },
      {
        hr: 'stručnjaci',
        en: 'experts / specialists',
        example: 'Planiraju zaposliti 60 novih stručnjaka.',
      },
    ],
  },
  {
...
Turisti koji dolaze posebno zbog lavande sve su brojniji. Agencije u Splitu nude jednodnevne izlete s prelaskom trajektom, obilaskom plantaža i radionicama gdje posjetitelji mogu sami nabrati lavandu i napraviti mirisnu vrećicu. Lokalni producenti kažu da je lavandino ulje s Hvara prepoznato kao jedno od najkvalitetnijih na svijetu.`,
    ...
    vocab: [
      ...
      {
        hr: 'uzgaja',
        en: 'is cultivated / grown',
        example: 'Lavanda se na Hvaru uzgaja već sto godina.',
      },
      {
        hr: 'prinos',
        en: 'yield / crop',
        example: 'Prinos je bio iznimno dobar zahvaljujući blagoj zimi.',
      },
      {
        hr: 'destilira',
        en: 'is distilled',
        example: 'Od svježe lavande destilira se eterično ulje.',
      },
      { hr: 'plantaža', en: 'plantation', example: 'Obitelj vodi plantažu u blizini Vrbanja.' },
      {
        hr: 'mirisna',
        en: 'fragrant / aromatic',
        example: 'Posjetitelji mogu napraviti mirisnu vrećicu.',
      },
...
Hrvatski rukometni savez objavio je plan za sljedeću sezonu koji uključuje više prijateljskih utakmica protiv top-ranked ekipa te tjedan intenzivnih priprema u austrijskom planinarskom centru. Cilj je ući u Egipat kao jedna od favorita za medalju.`,
    ...
    vocab: [
      ...
      { hr: 'asistencije', en: 'assists', example: 'Raspodijelio je šest asistencija u utakmici.' },
      {
        hr: 'golman',
        en: 'goalkeeper',
        example: 'Mladi golman Tin Petrović privukao je pažnju skauta.',
      },
      { hr: 'omjer', en: 'ratio / percentage', example: 'Postigao je omjer od 38 posto obrana.' },
      {
        hr: 'savez',
        en: 'federation / association',
        example: 'Hrvatski rukometni savez objavio je novi plan.',
      },
      {
        hr: 'pripreme',
  ...
  },
  {
    ...
    headline:
      '"Dalmatinski blues" osvaja Cannes: hrvatska koprodukcija u glavnom programu festivala',
...
Hrvatski ministar kulture čestitao je svim sudionicima i najavio povećanje proračuna za filmsku produkciju za 30 posto u 2027. godini. Karte za cannesku premijeru u Théâtre Lumière rasprodane su za manje od sat vremena.`,
    summary:
      '"Dalmatinski blues" by director Ivan Peroša has been selected for the main competition at the 2026 Cannes Film Festival — only the third time a Croatian production has entered the Official Selection. The film follows an elderly fisherman from the island of Vis teaching his grandson traditional fishing as the old way of life disappears. Shot entirely on Vis in Croatian, the film took four years to make with British Film Institute co-production support.',
    vocab: [
      {
        hr: 'redatelj',
        en: 'film director',
        example: 'Redatelj Ivan Peroša radi na filmu četiri godine.',
      },
      {
        hr: 'natjecanje',
        en: 'competition',
        example: 'Film je odabran za natjecanje u glavnom programu.',
      },
      {
        hr: 'kinematografija',
        en: 'cinematography / film industry',
        example: 'To je potvrda da hrvatska kinematografija raste.',
      },
      {
        hr: 'ribolov',
        en: 'fishing',
        example: 'Film prati priču o nestanku tradicijskog ribolova.',
      },
      {
        hr: 'demografski',
        en: 'demographically',
        example: 'Vis je mjesto koje umire demografski.',
      },
      {
        hr: 'proračun',
        en: 'budget',
        example: 'Ministar je najavio povećanje proračuna za filmsku produkciju.',
      },
      {
        hr: 'premijera',
        en: 'premiere',
        example: 'Karte za cannesku premijeru rasprodane su brzo.',
      },
    ],
  },
];
          ...
          return (
            <div
              ...
              style={{
                ...
                boxShadow: isFeatured ? `0 0 0 2px ${color}44` : '0 1px 4px rgba(0,0,0,.06)',
                position: 'relative',
              }}
            >
              {isFeatured && (
