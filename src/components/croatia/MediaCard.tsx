    ...
    >
      ...
      <div
        style={{
          ...
          position: 'relative',
          flexShrink: 0,
          background: enabled ? '#D40030' : 'var(--bar-bg)',
  ...
  return (
    <span
      style={{
        ...
        padding: '2px 7px',
        borderRadius: 20,
        border: '1px solid rgba(212,0,48,.2)',
  ...
  return (
    <div
      ...
      style={{
        ...
        overflow: 'hidden',
        marginBottom: 10,
        animation: 'nh-fade-in .3s ease both',
      }}
    >
      {/* Info row */}
      <div
        style={{ display: 'flex', gap: 12, padding: '14px 14px 12px', alignItems: 'flex-start' }}
      >
        <div
          style={{
            width: 46,
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          ...
          {isHRTI && (
            ...
            >
              <span>🔐</span>
              <span>Subscription required · browser auto-fills saved login</span>
            </div>
          )}
        </div>
      </div>
      ...
      {learningMode && (
        <button
          ...
          style={{
            ...
            padding: '6px 14px',
            borderRadius: 20,
            border: `1px solid ${done ? 'var(--success-b,#86efac)' : 'var(--card-b)'}`,
            background: done ? 'var(--success-bg,#f0fdf4)' : 'var(--bar-bg)',
            color: done ? 'var(--success,#16a34a)' : 'var(--subtext)',
            fontSize: 11,
            fontWeight: 700,
            cursor: 'pointer',
            display: 'flex',
