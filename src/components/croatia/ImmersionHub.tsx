...
const JOURNEY = [
  {
    ...
    weeks: 'Weeks 1–4',
    desc: 'Focus on hearing Croatian every day, even if you understand nothing. Your brain is mapping sounds.',
    goals: [
      'Learn greetings, numbers, colors, family (all in this app)',
      'Listen to CMC Radio or HRT Radio for 5 min/day — no comprehension required',
      'Watch one Croatian music video with lyrics',
      'Read: Glas Hrvatske English+Croatian side-by-side',
    ],
  ...
  },
  {
    ...
    title: 'First Sprouts',
    weeks: 'Weeks 5–12',
    desc: 'You recognize words and short phrases. Now start connecting exposure to your in-app lessons.',
    goals: [
      'Complete all vocabulary categories in Learn tab',
      'Read 5 headlines on 24sata.hr each morning',
      'Watch Easy Croatian street interview (YouTube) twice a week',
      'Start noticing case endings on signs and menus',
    ],
  ...
  },
  {
    ...
    weeks: 'Months 3–6',
    desc: 'You understand the main idea of most things. Immersion becomes genuinely enjoyable.',
    goals: [
      'Watch HRT 1 Dnevnik (nightly news) 3x/week',
      'Listen to one HRT Radio podcast episode/week on a topic you love',
      'Read one full Dnevnik.hr article per day',
      'Watch Easy Croatian interviews without subtitles first',
    ],
  ...
  },
  {
    ...
    title: 'Upper Slopes',
    weeks: 'Months 6–12',
    desc: 'Croatian media is mostly comprehensible. Focus on nuance, regional variation, and formal registers.',
    goals: [
      'Read Večernji list or Jutarnji list editorial section weekly',
      'Watch a full Croatian film without English subtitles',
      'Follow HNK Hajduk or Dinamo on social media',
      'Listen to HRT Radio history or culture podcast',
    ],
  ...
  },
  {
    ...
    title: 'The Summit',
    weeks: 'Year 2+',
    desc: 'You think in Croatian for familiar topics. Focus on vocabulary gaps and formal language.',
    goals: [
      'Read Jutarnji list opinion columns',
      'Watch Croatian political debates on HRT',
      'Write a diary entry in Croatian each week',
      'Find a Croatian language exchange partner',
    ],
  ...
  },
  {
    ...
    weeks: 'Ongoing',
    desc: 'Croatian is part of who you are. Maintain and deepen through ongoing immersion.',
    goals: [
      'Follow Croatian Twitter/Instagram accounts in Croatian',
      'Read Croatian novels or short stories',
      'Watch Croatian standup comedy (Škibby, Relja, Bare)',
      'Listen to Croatian talk radio without notes',
    ],
...
const SCHEDULES = [
  {
    time: '☀️ Morning (5 min)',
    items: [
      'HRT Radio or CMC Radio while getting ready',
      'Read 1 headline on 24sata.hr or Dnevnik.hr',
    ],
  },
  {
    time: '🌤️ Afternoon (10 min)',
    items: [
      'Vocabulary lesson or flashcards in the app',
      'Read 1 full news article — look up 3 unknown words',
    ],
  },
  {
    time: '🌙 Evening (20 min)',
    items: [
      'HRT 1 Dnevnik news (7:30pm Croatian time)',
      'OR a Croatian film / YouTube series episode',
    ],
  },
  {
    time: '🗓️ Weekly (1 hr)',
    items: [
      'One Croatian podcast on a topic you love',
      'Review all new words from the week in your Vocabulary Journal',
    ],
  },
];
...
const TIPS = [
  {
    icon: '🔁',
    title: 'Shadowing',
    tip: 'Play a Croatian sentence, pause, repeat it back immediately — out loud, same speed, same melody. Do this with HRT Radio. It trains accent and rhythm faster than anything.',
  },
  {
    icon: '📱',
    title: 'Change Your Phone to Croatian',
    tip: "Go to Settings → Language → Hrvatski. You already know what every icon does. Now you'll absorb 50+ words per day with zero effort.",
  },
  {
    icon: '🏷️',
    title: 'Label Your Home',
    tip: "Put sticky labels on everything in your house: 'hladnjak', 'vrata', 'prozor', 'stol'. Every time you touch something, you see the word.",
  },
  {
    icon: '🧠',
    title: 'Comprehensible Input (i+1)',
    tip: "Find content where you understand about 70-80% — not too easy, not too hard. That 20% you don't understand is where growth happens. Easy Croatian videos are ideal.",
  },
  {
    icon: '📝',
    title: 'One Sentence Diary',
    tip: "Every night, write one sentence in Croatian about your day. Even 'Danas sam radio u uredu.' This forces you to actively produce what you've been passively absorbing.",
  },
  {
    icon: '🎵',
    title: 'Find Your Song',
    tip: "Pick one Croatian song you love. Look up every word. Listen to it 50 times. You'll own those words forever. Try Oliver Dragojević's 'Cesarica' or Thompson's 'Lijepa li si'.",
  },
  {
    icon: '👥',
    title: 'Practice Real Conversations',
    tip: 'Use the AI Conversation Partner in this app to practice real Croatian dialogues. Even 15 min/week of active speaking accelerates everything else.',
  },
  {
    icon: '🔤',
    title: 'Read Aloud',
    tip: 'When you read Croatian text — news, labels, anything — say it out loud. Reading activates the eye. Speaking activates the mouth, ear, and brain simultaneously.',
  },
];
      ...
      {activeTab === 'journey' && (
        <div>
          ...
          <div
            role="button"
            tabIndex={0}
            onClick={() => setScr && setScr('aiconvo')}
            onKeyDown={(e) => {
              if (e.key === 'Enter' || e.key === ' ') {
                e.preventDefault();
                setScr && setScr('aiconvo');
              }
            }}
            style={{
              ...
              cursor: 'pointer',
              color: 'white',
              boxShadow: '0 6px 24px rgba(55,48,163,.25)',
              display: 'flex',
              gap: 14,
              alignItems: 'center',
            }}
            aria-label="Open AI Conversation Partner"
          >
            ...
            <div style={{ flex: 1 }}>
              ...
              <div style={{ fontSize: 12, opacity: 0.85, lineHeight: 1.5 }}>
                Practice real Croatian conversations with instant AI feedback and a personalised
                grammar report.
              </div>
          ...
          <div
            ...
            style={{
              marginBottom: 16,
              padding: '14px 16px',
              background: 'linear-gradient(135deg,rgba(14,116,144,.06),rgba(14,116,144,.12))',
      ...
      {activeTab === 'schedule' && (
        <div>
          ...
          >
            ...
            {[
              ['Mon', 'Grammar review in the app — one new concept'],
              ['Tue', 'CMC TV or music — passive listening'],
              ['Wed', 'HRT Radio or podcast — 20 min'],
              ['Thu', 'Read a news article — look up 5 unknown words'],
              ['Fri', 'Croatian film or series episode'],
              ['Sat', 'Practice speaking — role-play or language exchange'],
              ['Sun', 'Review your Vocabulary Journal — week reflection'],
            ].map(([d, t]) => (
              <div
                key={d}
      ...
      {activeTab === 'tips' && (
        <div>
          ...
          >
            ...
            >
              "The language you study and the language you acquire are not the same thing.
          ...
          >
            ...
            {[
              [
                'Number Agreement',
                '2, 3, 4 = Genitive singular (dva psa). 5+ = Genitive plural (pet pasa). Master this one rule.',
              ],
              [
                'Clitic Order',
                'Short pronouns cluster after the first word: "Dao sam mu ga." — always in this order: sam/si/je/smo/ste/su → me/ti/mu/nam/vam/im → ga/je/ih.',
              ],
              [
                'Conditional Mood',
                'bi + past verbal adjective: "Htio bih..." (I would like). Negative: "Ne bih htio."',
              ],
              [
                'Passive Voice',
                'biti + past passive participle: "Grad je osnovan 925. godine." (The city was founded in 925.)',
              ],
              [
                'Reported Speech',
                'Direct: Ana kaže: "Idem." → Indirect: Ana kaže da ide. The verb shifts but the tense is simpler than in English.',
              ],
            ].map(([g, d]) => (
              <div
                key={g}
