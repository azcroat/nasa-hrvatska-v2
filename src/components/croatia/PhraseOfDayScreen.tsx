...
const SEED_PHRASES = {
  greeting: {
    ...
    when_to_use:
      'A casual, warm greeting between male friends or acquaintances. Women sometimes use it too, but less commonly.',
    cultural_note:
      'In Croatia, "brate" (brother) is one of the most common terms of address between friends — even total strangers. It signals warmth and solidarity, not an actual family relationship.',
    example_dialogue: [
  ...
  work: {
    ...
    when_to_use:
      'When you want to express that you are very busy with work. Common in modern Croatian urban speech, especially in Zagreb offices.',
    cultural_note:
      '"Full" is an English loanword that has been fully adopted into colloquial Croatian as an intensifier. Younger Croatians use it constantly. It sits comfortably next to native Croatian words.',
    example_dialogue: [
    ...
    word_breakdown: [
      { word: 'imam', meaning: 'I have', note: '1st person singular of "imati"' },
      {
        ...
        note: 'English loanword used as intensifier',
      },
  ...
  travel: {
    ...
    when_to_use:
      'At train stations, bus terminals, ferry ports. Essential for navigating Croatian public transport.',
    cultural_note:
      'Croatian trains are famously scenic but slow. Split to Zagreb takes about 5-6 hours — but the mountain views are extraordinary. Locals say "vlak" (train) is for people with time; "bus" is for people with less.',
    example_dialogue: [
  ...
  food: {
    ...
    when_to_use:
      'When food is exceptionally delicious — at a home-cooked meal, a restaurant, or a market stall. A genuine compliment to the cook.',
    cultural_note:
      'Complimenting food is very important in Croatian culture. A host who has cooked for you expects — and truly needs — to hear that you enjoyed it. Silence is worse than criticism.',
    example_dialogue: [
  ...
  slang: {
    ...
    when_to_use:
      'When someone is being annoying. Slightly irritated, but not deeply offensive. Can be said with a smile among friends.',
    cultural_note:
      'Croatian has a rich tradition of expressive complaint. This phrase is perfectly acceptable in everyday speech. A stronger version exists, but this is the polite form you can use freely.',
    example_dialogue: [
    ...
    word_breakdown: [
      {
        word: 'daj',
        meaning: 'come on / give (imperative)',
        note: 'imperative of "dati", used as discourse particle',
      },
  ...
  love: {
    ...
    when_to_use:
      'When you miss someone — a partner, a close friend, or a family member far away. One of the most emotionally resonant phrases in Croatian.',
    cultural_note:
      'Croatian expresses "I miss you" from the perspective of absence rather than longing — it\'s literally "you are lacking to me." This reflects a deeper, more melancholic sense of loss. Diaspora Croatians abroad know this feeling well.',
    example_dialogue: [
    ...
    word_breakdown: [
      {
        word: 'nedostaješ',
        meaning: 'you are lacking / missing',
        note: '2nd person singular of "nedostajati"',
      },
  ...
  sports: {
    ...
    when_to_use:
      'At any Croatia national football match, sports bar, or wherever Croatians gather to watch the national team. Possibly the most emotionally loaded phrase in Croatian sports culture.',
    cultural_note:
      '"Vatreni" (The Fiery Ones) is the beloved nickname of Croatia\'s national football team. The name reflects the passion and fighting spirit Croatians believe defines their play. The 2018 World Cup final run united the diaspora worldwide in ways few events have.',
    example_dialogue: [
    ...
    word_breakdown: [
      {
        ...
        note: '1st person plural of "ići", used as encouragement',
      },
      {
        word: 'Vatreni',
        meaning: 'Fiery Ones',
        note: 'nominative plural of "vatren" (fiery), nickname of Croatian national team',
      },
    ],
  ...
  family: {
    ...
    when_to_use:
      'When explaining why family comes first, or why you stood by a family member despite disagreements. A proverb but used in real conversation.',
    cultural_note:
      "Family loyalty is foundational in Croatian culture. Extended family (rodbina) is not a separate social category — it's a primary one. Decisions are often made with family in mind first. This proverb captures that instinct precisely.",
    example_dialogue: [
  ...
  return (
    <div>
      ...
      >
        <div
          className="pod-skel"
          style={{ height: 14, width: '30%', background: 'rgba(255,255,255,.3)' }}
        />
        <div
          className="pod-skel"
          style={{ height: 36, width: '85%', background: 'rgba(255,255,255,.4)' }}
        />
        <div
          className="pod-skel"
          style={{ height: 18, width: '55%', background: 'rgba(255,255,255,.25)' }}
        />
        <div
          className="pod-skel"
          style={{ height: 14, width: '70%', background: 'rgba(255,255,255,.2)' }}
        />
      </div>
      {/* Detail skeletons */}
      {[90, 70, 85, 60].map((w, i) => (
        <div
          key={i}
          className="pod-skel"
          style={{ height: 14, width: `${w}%`, background: 'var(--card-b)', marginBottom: 10 }}
        />
      ))}
    </div>
  );
      ...
      {!loading && phraseData && (
        <>
            ...
            >
              ...
              <div
                style={{
                  ...
                  marginBottom: phraseData.literal ? 8 : 0,
                  lineHeight: 1.3,
                }}
              >
          ...
          {phraseData.when_to_use && (
            ...
            >
              <div
                style={{ fontSize: 12, fontWeight: 800, color: 'var(--subtext)', marginBottom: 6 }}
              >
                📌 WHEN TO USE
              </div>
          ...
          {phraseData.example_dialogue && phraseData.example_dialogue.length > 0 && (
            ...
            >
              <div
                style={{ fontSize: 12, fontWeight: 800, color: 'var(--subtext)', marginBottom: 10 }}
              >
                💬 EXAMPLE DIALOGUE
              </div>
                  ...
                  <tbody>
                    {phraseData.word_breakdown.map((row, i) => (
                      ...
                      >
                        ...
                        <td
                          style={{ padding: '8px 10px', color: 'var(--heading)', fontWeight: 600 }}
                        >
                          {row.meaning}
                        </td>
                        <td
