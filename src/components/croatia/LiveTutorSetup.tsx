  ...
  return (
    <div className="c" style={{ minHeight: '100vh', paddingBottom: 80 }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 12, padding: '16px 16px 0' }}>
        ...
        <div>
          <div style={{ fontSize: 'var(--text-lg)', fontWeight: 900, color: 'var(--heading)' }}>
            Live Croatian Tutor
          </div>
          <div style={{ fontSize: 'var(--text-xs)', color: 'var(--subtext)' }}>
            Speak Croatian with an adaptive AI tutor
          </div>
        </div>
      </div>
      ...
      >
        ...
        >
          I'll speak Croatian with you, adapt to your level, and help you break through
          comprehension gaps.
        </div>
      </div>
        ...
        >
          ...
          <div>
            ...
            <div style={{ fontSize: 'var(--text-xs)', color: 'var(--subtext)', lineHeight: 1.5 }}>
              To speak with Marija, allow microphone access in your browser's site settings, then
              reload the page. You can still practice by typing below.
            </div>
          </div>
        </div>
      )}
      ...
      {micPermission === 'prompt' && (
        ...
        >
          ...
          <div>
            ...
            <div style={{ fontSize: 'var(--text-xs)', color: 'var(--subtext)', lineHeight: 1.5 }}>
              When you start, your browser will ask to use your microphone. Tap{' '}
              <strong>Allow</strong> to speak with Marija.
            </div>
          </div>
        </div>
      )}
      ...
      {audioStatus === 'no-output' && (
        ...
        >
          ...
          <div>
            ...
            <div style={{ fontSize: 'var(--text-xs)', color: 'var(--subtext)', lineHeight: 1.5 }}>
              Check that your speaker or headphones are connected and your device volume is turned
              up. Marija's voice won't be audible otherwise.
            </div>
          </div>
        </div>
      )}
      {audioStatus === 'suspended' && (
        ...
        >
          ...
          <div>
            ...
            <div style={{ fontSize: 'var(--text-xs)', color: 'var(--subtext)', lineHeight: 1.5 }}>
              Tap anywhere on the page before starting — your browser requires a tap to enable audio
              playback.
            </div>
          </div>
        </div>
