    ...
    vocab: [
      {
        ...
        en: 'government',
        ph: 'vla-da',
        note: 'The executive — "Vlada Republike Hrvatske"',
      },
      { hr: 'premijer', en: 'prime minister', ph: 'pre-mi-yer', note: 'Head of government' },
      {
        ...
        en: 'president',
        ph: 'pred-syed-nik',
        note: 'Head of state — separate from premijer',
      },
      {
        hr: 'Sabor',
        en: 'Croatian parliament',
        ph: 'sa-bor',
        note: '151 seats. The legislative body.',
      },
      {
        hr: 'ministar',
        en: 'minister',
        ph: 'mi-ni-star',
        note: 'ministar financija = minister of finance',
      },
      ...
      { hr: 'gradonačelnik', en: 'mayor', ph: 'gra-do-na-chel-nik', note: null },
      {
        ...
        en: 'county governor',
        ph: 'zhu-pan',
        note: 'Croatia has 20 counties (županije)',
      },
    ],
  },
  {
    ...
    vocab: [
      ...
      { hr: 'glasanje', en: 'voting / election day', ph: 'gla-sa-nye', note: null },
      {
        ...
        en: 'elections',
        ph: 'iz-bo-ri',
        note: 'parlamentarni izbori = parliamentary elections',
      },
      {
        hr: 'stranka',
        en: 'political party',
        ph: 'stran-ka',
        note: 'HDZ and SDP are the two main parties',
      },
      {
        hr: 'koalicija',
        en: 'coalition',
        ph: 'ko-a-li-tsi-ya',
        note: 'Croatian governments are almost always coalitions',
      },
      { hr: 'oporba', en: 'opposition', ph: 'o-por-ba', note: null },
      { hr: 'referendum', en: 'referendum', ph: 're-fe-ren-dum', note: null },
      {
        hr: 'mandat',
        en: 'term of office / mandate',
        ph: 'man-dat',
        note: '4-year terms in Croatia',
      },
    ],
  },
  {
    ...
    vocab: [
      {
        hr: 'Europska unija',
        en: 'European Union',
        ph: 'eu-rop-ska u-ni-ya',
        note: 'Croatia joined in 2013',
      },
      {
        hr: 'euro',
        en: 'euro (currency since Jan 2023)',
        ph: 'eu-ro',
        note: 'Replaced the kuna (kn)',
      },
      {
        hr: 'kuna',
        en: 'the old Croatian currency',
        ph: 'ku-na',
        note: 'Older Croatians still mentally calculate in kune',
      },
      {
        hr: 'Schengen',
        en: 'Schengen area (Croatia joined Jan 2023)',
        ph: 'shen-gen',
        note: 'No passport checks for EU citizens entering Croatia',
      },
      {
        hr: 'Europski parlament',
        en: 'European Parliament',
        ph: 'eu-rop-ski par-la-ment',
        note: 'Croatia elects 12 MEPs',
      },
      {
        hr: 'fondovi EU',
        en: 'EU funds',
        ph: 'fon-do-vi e-u',
        note: 'A major topic in Croatian politics',
      },
      {
        hr: 'Europska komisija',
        en: 'European Commission',
        ph: 'eu-rop-ska ko-mi-si-ya',
        note: null,
      },
    ],
  },
  {
    ...
    vocab: [
      ...
      { hr: 'gospodarski rast', en: 'economic growth', ph: 'gos-po-dar-ski rast', note: null },
      {
        ...
        en: 'tourism',
        ph: 'tu-ri-zam',
        note: "Croatia's biggest industry — 25% of GDP",
      },
    ],
  },
];
...
const SAMPLE_HEADLINES = [
  {
    hr: 'Vlada odobrila novi proračun za iduću godinu.',
    en: 'Government approves new budget for next year.',
  },
  {
    hr: 'Predsjednik se sastao s premijerom u Saboru.',
    en: 'President met with the prime minister in Parliament.',
  },
  {
    hr: 'Izbori u listopadu — stranke počinju kampanju.',
    en: 'Elections in October — parties begin campaigns.',
  },
  {
    hr: 'Hrvatska prima europske fondove za obnovu.',
    en: 'Croatia receives European funds for reconstruction.',
  },
  {
    hr: 'Turizam ostvario rekordne prihode ove godine.',
    en: 'Tourism achieved record revenues this year.',
  },
];
...
export default function CivicScreen({ goBack }: CivicScreenProps) {
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
          {active.vocab.map((w, i) => (
            ...
            >
              <button
                onClick={() => speak(w.hr)}
                aria-label={`Play audio: ${w.hr} — ${w.en}`}
                style={{
                  width: '100%',
                  padding: '12px 14px',
                  background: 'none',
  ...
  return (
    <div>
      ...
      >
        Open any Croatian news site and you'll see these words. Learn them and current events become
        readable.
      </div>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 10, marginBottom: 24 }}>
        {CIVIC_SECTIONS.map((s) => (
          ...
          >
            ...
            <div style={{ flex: 1 }}>
              <div
                style={{ fontSize: 14, fontWeight: 800, color: 'var(--heading)', marginBottom: 2 }}
              >
                {s.title}
              </div>
              <div style={{ fontSize: 11, color: 'var(--subtext)', fontWeight: 600 }}>
                {s.vocab.length} words
              </div>
            </div>
      ...
      >
        ...
        <div style={{ flex: 1, textAlign: 'left' }}>
          <div style={{ fontSize: 14, fontWeight: 800, color: '#fff' }}>
            Practice: Read a Headline
          </div>
          <div style={{ fontSize: 11, color: 'rgba(255,255,255,.75)', marginTop: 1 }}>
            5 real-style Croatian news headlines
          </div>
        </div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 8, marginBottom: 20 }}>
          {SAMPLE_HEADLINES.map((h, i) => (
            <button
              key={i}
              onClick={() => speak(h.hr)}
              aria-label={`Play audio: ${h.hr} — ${h.en}`}
              style={{
                display: 'flex',
