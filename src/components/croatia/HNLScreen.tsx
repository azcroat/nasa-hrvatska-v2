...
const TEAMS_DETAIL = [
  ...
  },
  {
    ...
    achievements: [
      'Consistent top-5 finishers',
      'Developed many national team players',
      "Zagreb's oldest club (1914)",
    ],
...
const LIVE_LINKS = [
  ...
  {
    label: 'Sofascore',
    sub: 'Live scores & stats',
    url: 'https://www.sofascore.com/football/croatia/hnl',
    icon: '📊',
    color: '#0e7490',
  },
  {
    ...
    url: 'https://www.flashscore.com/football/croatia/hnl/',
    icon: '⚡',
    color: '#e85d04',
  },
  {
    label: 'National Team',
    sub: 'Vatreni — UEFA & FIFA',
...
export default function HNLScreen({ goBack }) {
  ...
  return (
    <div className="scr-wrap">
      ...
      <div
        style={{
          background: 'linear-gradient(135deg,#003da5 0%,#dc2626 100%)',
          borderRadius: 18,
      ...
      >
        <div style={{ position: 'absolute', right: 16, top: 12, fontSize: 48, opacity: 0.15 }}>
          ⚽
        </div>
        <div
          style={{
      ...
      {tab === 'standings' && (
        <>
          ...
          >
            ...
            <span>
              Indicative 2024/25 season table. Tap <strong>Official HNL ↗</strong> above for live
              standings.
            </span>
          </div>
          ...
          {/* Top Scorers */}
          <h3 className="sh" style={{ marginBottom: 10 }}>
            ⚽ Top Scorers
          </h3>
          <div
            style={{
          ...
          >
            ...
            <span>
              ...
              <button
                ...
                onClick={() =>
                  window.open(
                    'https://www.sofascore.com/football/croatia/hnl',
                    '_blank',
                    'noopener,noreferrer',
                  )
                }
          ...
          {/* Fixtures */}
          <h3 className="sh" style={{ margin: '20px 0 10px' }}>
            📅 Fixtures & Results
          </h3>
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 8 }}>
            {[
              {
                label: "This Week's Fixtures",
                icon: '📅',
                url: 'https://www.flashscore.com/football/croatia/hnl/',
                color: '#e85d04',
              },
              {
                label: 'Live Scores Now',
                icon: '🔴',
                url: 'https://www.sofascore.com/football/croatia/hnl',
                color: '#dc2626',
              },
              { label: 'HNL Match Videos', icon: '▶️', url: 'https://hnl.hr', color: '#003da5' },
              {
                ...
                icon: '📋',
                url: 'https://www.flashscore.com/football/croatia/hnl/results/',
                color: '#0e7490',
              },
            ].map((l) => (
              <button
        ...
        <>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
              ...
              <div>
                ...
                <div style={{ fontSize: 12, opacity: 0.85, marginTop: 2 }}>
                  FIFA Top 10 · 40M fans worldwide
                </div>
              </div>
            </div>
            <div
            ...
            >
              {[
                ...
                >
                  ...
                  <div style={{ fontSize: 10, opacity: 0.85 }}>{desc}</div>
                </div>
              ))}
            </div>
            <div style={{ marginTop: 12, fontSize: 12, opacity: 0.9, lineHeight: 1.6 }}>
              Known for tiki-taka midfield mastery. Modrić, Kovačić, Brozović — all from Croatia's
              production line. The chequered red-and-white jersey (<em>kockice</em>) is one of
              football's most iconic kits.
            </div>
          </div>
          ...
          {TEAMS_DETAIL.map((t, i) => (
            <div
              key={i}
              className="c"
              style={{ marginBottom: 14, borderLeft: '4px solid ' + t.color, padding: '14px 16px' }}
            >
