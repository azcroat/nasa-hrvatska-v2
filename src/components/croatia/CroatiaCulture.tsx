    ...
    <div className="scr-wrap">
      ...
      {TEXTING.map(function (t, i) {
        return (
          <button
            key={i}
            aria-label={`Play audio for ${t.slang}`}
            className="c"
...
export function FoodOrderScreen({ goBack }) {
  return (
    <div className="scr-wrap">
        ...
        return (
          <div key={si} className="c" style={{ marginBottom: 16 }}>
            ...
            <div style={{ borderTop: '1px solid var(--card-b)', paddingTop: 8 }}>
              {sec.phrases.map(function (p, i) {
                return (
                  <button
                    key={i}
                    aria-label={`Play audio for ${p}`}
                    style={{
                      display: 'block',
                      width: '100%',
                      fontSize: 13,
      ...
      {FOODORDER.restaurant.phrases.map(function (p, i) {
        return (
          <button
            key={i}
  ...
  return (
    <div className="scr-wrap">
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: 6 }}>
        {EMERGENCY.bodyParts.map(function (b, i) {
          return (
            <button
              key={i}
              className="c"
  ...
  return (
    <div className="scr-wrap">
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 6 }}>
        {FOOTBALL.vocab.map(function (w, i) {
          return (
            <button
              key={i}
              className="c"
            ...
            >
              ...
              {' — '}
              <span style={{ color: 'var(--subtext)', fontSize: 12 }}>{w[1]}</span>
            </button>
          );
        })}
      </div>
      ...
      {FOOTBALL.teams.map(function (t, i) {
        return (
          <div
            key={i}
            className="c"
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 6 }}>
        {FOOTBALL.waterPolo.map(function (w, i) {
          return (
            <button
              key={i}
              className="c"
            ...
            >
              ...
              {' — '}
              <span style={{ color: 'var(--subtext)' }}>{w[1]}</span>
            </button>
          );
        })}
      </div>
...
export function SchoolScreen({ goBack }) {
  return (
    <div className="scr-wrap">
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 6 }}>
        {SCHOOL.classroom.map(function (w, i) {
          return (
            <button
              key={i}
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 6 }}>
        {SCHOOL.subjects.map(function (w, i) {
          return (
            <button
              key={i}
              aria-label={`Play audio for ${w[0]}`}
      ...
      {SCHOOL.phrases.map(function (p, i) {
        return (
          <button
            key={i}
            aria-label={`Play audio for ${p[0]}`}
