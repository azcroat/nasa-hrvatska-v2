...
const CHAPTERS = [
  ...
  },
  {
    ...
    cultural: "Sunday lunch (nedjeljni ručak) is the most sacred family ritual in Croatia. Spit-roasted lamb (janjetina) is a hallmark of celebrations across Dalmatia, Herzegovina, Lika, and the Croatian inland — often started before dawn and eaten in the early afternoon.",
  },
  {
    id: 4,
  ...
  },
  {
    ...
    cultural: "Zagorje is the hilly region north of Zagreb, famous for its medieval castles (including Trakošćan, first documented in the 14th century (1334)), baroque Varaždin, and the Kajkavian dialect. Zagorski štrukli — baked or boiled pastry filled with cottage cheese — was added to Croatia's intangible cultural heritage list in 2007 and is one of the country's most beloved comfort foods.",
  },
  {
    id: 15,
