      ...
      >
        <button
          onClick={() => {
            if (
              messages.length > 0 &&
              !window.confirm('Leave this conversation? Your progress will be lost.')
            )
              return;
            onReset();
          }}
        ...
        <button
          onClick={onEndEvaluate}
          disabled={loading || userCount < 2 || !!chatError}
          style={{
            padding: '7px 13px',
            borderRadius: 10,
            border: '1.5px solid',
            ...
            background:
              userCount >= 2 && !chatError ? 'rgba(14,116,144,0.45)' : 'rgba(255,255,255,0.08)',
          ...
          return (
            <React.Fragment key={i}>
              ...
              >
                ...
                >
                  {!isUser ? (
                    <TappableMessage text={m.content} onWordClick={onWordClick} />
                  ) : (
                    m.content
                  )}
                  {!isUser && (
                    <span
                      style={{ fontSize: 'var(--text-xs)', opacity: 0.4, marginLeft: 5 }}
                      aria-hidden="true"
                    >
                      🔊
                    </span>
                  ...
                  {correction.echo && (
                    <div
                      style={{
                        ...
                        marginTop: 6,
                        paddingTop: 6,
                        borderTop: '1px solid var(--success-b)',
                        fontSize: 'var(--text-xs)',
                      }}
                    >
