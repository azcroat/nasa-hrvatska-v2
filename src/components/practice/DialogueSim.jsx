...
const SCENARIOS = [
  {
    ...
    turns:[
      ...
      { speaker:"Konobar", line:"S mlijekom ili bez?", en:"With milk or without?",
        ...
        answer:0, tip:"'S mlijekom' is correct — instrumental case. 'Sa' is used before consonant clusters (ml-, pl-, etc.) AND before words starting with s/š/z/ž. 'Mlijeko' → starts with 'ml-' cluster, so technically 'sa mlijekom' is also acceptable, but 's mlijekom' is standard. 📚 See: Instrumental Case (Lesson 4)" },
