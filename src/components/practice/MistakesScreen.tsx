...
function MistakeListItem({ mistake, onClear }: { mistake: any; onClear: (hr: string) => void }) {
  return (
    <div className="c" style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 8 }}>
      ...
      <button
        onClick={() => onClear(mistake.hr)}
        aria-label={`Remove ${mistake.hr} from mistakes`}
        style={{
          background: 'none',
          border: 'none',
          fontSize: 18,
        ...
        <>
          ...
          >
            ...
            <div style={{ display: 'flex', gap: 10 }}>
              <button className="b bp" style={{ flex: 1, fontSize: 14 }} onClick={startReview}>
