    ...
    <div className="scr-wrap">
          ...
          return (
            <button
              ...
              style={{
                ...
                fontWeight: 700,
                cursor: 'pointer',
                background: tab === t.id ? '#0e7490' : '#f1f5f9',
      ...
      {tab === 'rules' && (
        <div>
          ...
          >
            <strong>Key rule:</strong> SE is a <em>clitic</em> — it can never be the first word in a
            sentence and must follow strict ordering with other short words (sam/si/je/smo/ste/su).
          </div>
          {REFLEXIVE.rules.map(function (r, ri) {
            return (
              <div
                key={ri}
                style={{
      ...
      {tab === 'tenses' && (
        <div>
          ...
          >
            See how SE moves in <strong>present</strong>, <strong>past</strong>,{' '}
            <strong>future</strong> and <strong>negative</strong> sentences. Tap any sentence to
            hear it.
          </div>
          {REFLEXIVE.tenseExamples.map(function (ex, ei) {
            return (
              <div
                key={ei}
                style={{
      ...
      {tab === 'verbs' && (
        <div>
          {REFLEXIVE.verbs.map(function (v, vi) {
            return (
