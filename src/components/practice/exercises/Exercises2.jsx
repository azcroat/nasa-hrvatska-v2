        ...
        <div key={ti} className="c" style={{marginBottom:10,padding:"10px 14px"}}>
          ...
          <div style={{display:"flex",gap:8}}>
            <button style={{flex:1,padding:"8px",border:"2px solid #d6d3d1",borderRadius:10,background:"white",fontSize:12,cursor:"pointer",textAlign:"left"}}
              onClick={function(/** @type {any} */ e){e.target.textContent="✅ "+t.perf;e.target.style.background="#dcfce7";e.target.style.borderColor="#16a34a";speak(t.perf);if(typeof award==='function')award(3);e.target.closest&&e.target.closest("div")&&(e.target.closest("div").style.pointerEvents="none")}}>🔵 Perfekt?</button>
            <button style={{flex:1,padding:"8px",border:"2px solid #d6d3d1",borderRadius:10,background:"white",fontSize:12,cursor:"pointer",textAlign:"left"}}
              onClick={function(/** @type {any} */ e){e.target.textContent="❌ "+t.neg;e.target.style.background="#fee2e2";e.target.style.borderColor="#dc2626";speak(t.neg);if(typeof award==='function')award(3);e.target.closest&&e.target.closest("div")&&(e.target.closest("div").style.pointerEvents="none")}}>🔴 Negative?</button>
          </div>
        </div>
      );})}
    </div>
          ...
          <div style={{display:"flex",gap:6,flexWrap:"wrap"}}>
            {r.opts.map(function(o,oi){return (
              <button key={oi} style={{padding:"8px 16px",border:"2px solid #d6d3d1",borderRadius:12,background:"white",fontSize:13,fontWeight:600,cursor:"pointer"}}
                onClick={function(/** @type {any} */ e){e.target.style.background=o===r.answer?"#dcfce7":"#fee2e2";e.target.style.borderColor=o===r.answer?"#16a34a":"#dc2626";if(o===r.answer){if(typeof award==='function')award(5);speak(r.answer);}e.target.closest&&e.target.closest("div")&&(e.target.closest("div").style.pointerEvents="none")}}>{o}</button>
            );})}
          </div>
          ...
          <div style={{display:"flex",gap:6,flexWrap:"wrap"}}>
            {allOpts.map(function(o,oi){const isRight=lq.right.indexOf(o)>=0;return (
              <button key={oi} style={{padding:"8px 14px",border:"2px solid #d6d3d1",borderRadius:10,background:"white",fontSize:12,fontWeight:600,cursor:"pointer"}}
                onClick={function(/** @type {any} */ e){e.target.style.background=isRight?"#dcfce7":"#fee2e2";e.target.style.borderColor=isRight?"#16a34a":"#dc2626";if(isRight){if(typeof award==='function')award(3);speak(o);}e.target.closest&&e.target.closest("div")&&(e.target.closest("div").style.pointerEvents="none")}}>
                {o}
              </button>
            );})}
          </div>
          ...
          <div style={{display:"flex",gap:6}}>
            {q.opts.map(function(o,oi){return (
              <button key={oi} style={{padding:"6px 14px",border:"2px solid #d6d3d1",borderRadius:10,background:"white",fontSize:12,fontWeight:600,cursor:"pointer"}}
                onClick={function(/** @type {any} */ e){e.target.style.background=o===q.a?"#dcfce7":"#fee2e2";e.target.style.borderColor=o===q.a?"#16a34a":"#dc2626";if(o===q.a){if(typeof award==='function')award(3);speak("na "+q.a+" katu");}e.target.closest&&e.target.closest("div")&&(e.target.closest("div").style.pointerEvents="none")}}>
                {o}
              </button>
            );})}
          </div>
      ...
      {shMemo("rp",RELPRON.quiz).map(function(q,qi){return (
        <div key={qi} className="c" style={{marginBottom:8,padding:"10px 14px"}}>
          ...
          <div style={{display:"flex",gap:6}}>
            {q.opts.map(function(o,oi){return (
              <button key={oi} style={{padding:"6px 14px",border:"2px solid #d6d3d1",borderRadius:10,background:"white",fontSize:12,fontWeight:600,cursor:"pointer"}}
                onClick={function(/** @type {any} */ e){e.target.style.background=o===q.a?"#dcfce7":"#fee2e2";e.target.style.borderColor=o===q.a?"#16a34a":"#dc2626";if(o===q.a){if(typeof award==='function')award(3);speak(q.q.replace("_____",q.a).split("(")[0]);}e.target.closest&&e.target.closest("div")&&(e.target.closest("div").style.pointerEvents="none")}}>
                {o}
              </button>
            );})}
          </div>
            ...
            <div key={pi} style={{display:"flex",gap:8,marginBottom:6}}>
              {sh([correct,wrong]).map(function(o,oi){return (
                <button key={oi} style={{flex:1,padding:"8px",border:"2px solid #d6d3d1",borderRadius:10,background:"white",fontSize:13,fontWeight:600,cursor:"pointer"}}
                  onClick={function(/** @type {any} */ e){e.target.style.background=o===correct?"#dcfce7":"#fee2e2";e.target.style.borderColor=o===correct?"#16a34a":"#dc2626";if(o===correct){if(typeof award==='function')award(2);speak(eg.subj.split("...")[0]+" "+correct);}e.target.closest&&e.target.closest("div")&&(e.target.closest("div").style.pointerEvents="none")}}>
                  {o}
                </button>
              );})}
            </div>
          ...
          <div style={{display:"flex",gap:4}}>
            {sh([c2.lok,wrong]).map(function(o,oi){return (
              <button key={oi} style={{padding:"8px 14px",border:"2px solid #d6d3d1",borderRadius:10,background:"white",fontSize:11,fontWeight:600,cursor:"pointer"}}
                onClick={function(/** @type {any} */ e){e.target.style.background=o===c2.lok?"#dcfce7":"#fee2e2";e.target.style.borderColor=o===c2.lok?"#16a34a":"#dc2626";if(o===c2.lok){if(typeof award==='function')award(3);}e.target.closest&&e.target.closest("div")&&(e.target.closest("div").style.pointerEvents="none")}}>{o}</button>
            );})}
          </div>
        </div>
      );})}
    ...
    <div className="scr-wrap">
      ...
      {shMemo("af",AKUFOOD).map(function(f,i){return (
        <div key={i} style={{display:"flex",alignItems:"center",gap:8,marginBottom:6}}>
          ...
          <button style={{padding:"8px 14px",border:"2px solid #d6d3d1",borderRadius:10,background:"white",fontSize:12,cursor:"pointer"}}
            onClick={function(/** @type {any} */ e){e.target.textContent=f.aku;e.target.style.background="#dcfce7";e.target.style.borderColor="#16a34a";speak(f.q.replace("_____",f.aku));if(typeof award==='function')award(2);e.target.closest&&e.target.closest("div")&&(e.target.closest("div").style.pointerEvents="none")}}>Show</button>
        </div>
      );})}
      ...
      {shMemo("ac",AKUCLOTHES).map(function(cl,i){return (
        <div key={i} style={{display:"flex",alignItems:"center",gap:8,marginBottom:6}}>
          ...
          <button style={{padding:"8px 14px",border:"2px solid #d6d3d1",borderRadius:10,background:"white",fontSize:12,cursor:"pointer"}}
            onClick={function(/** @type {any} */ e){e.target.textContent=cl.aku;e.target.style.background="#dcfce7";e.target.style.borderColor="#16a34a";speak(cl.q.replace("_____",cl.aku));if(typeof award==='function')award(2);e.target.closest&&e.target.closest("div")&&(e.target.closest("div").style.pointerEvents="none")}}>Show</button>
        </div>
      );})}
    </div>
  );
