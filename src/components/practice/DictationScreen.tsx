...
const DATA = [
  ...
  {
    text: 'Možete li govoriti sporije, molim vas?',
  ...
  {
    text: 'Sutra ću ići na tržnicu kupiti povrće.',
    en: "Tomorrow I'll go to the market to buy vegetables.",
    level: 'B1',
  },
  {
    text: 'Mislim da je to jako važno pitanje.',
    en: 'I think that is a very important question.',
    level: 'B1',
  },
  {
    text: 'Sviđa mi se ovaj grad, posebno stari dio.',
    en: 'I like this city, especially the old part.',
    level: 'B1',
  },
  {
    text: 'Kad bih imao više vremena, naučio bih gitaru.',
    en: 'If I had more time, I would learn guitar.',
    level: 'B2',
  },
  {
    text: 'Preporučujem ti da pročitaš tu knjigu.',
    en: 'I recommend you read that book.',
    level: 'B2',
  },
  {
    text: 'Nije mi jasno zašto se tako ponaša.',
    en: "I don't understand why he behaves that way.",
    level: 'B2',
  },
  {
    text: 'Trebalo bi se više paziti na okoliš.',
    en: 'We should pay more attention to the environment.',
    level: 'B2',
  },
  {
    text: 'Koliko dugo živiš u ovom gradu?',
    en: 'How long have you been living in this city?',
    level: 'A2',
  },
  {
    text: 'Ne znam gdje sam stavio ključeve.',
    en: "I don't know where I put the keys.",
    level: 'B1',
  },
  {
    text: 'Možeš li mi preporučiti dobar restoran?',
    en: 'Can you recommend me a good restaurant?',
    level: 'A2',
  },
  {
    text: 'Hvala lijepa, jako ste ljubazni.',
        ...
        <div style={{ textAlign: 'center', padding: '32px 16px' }}>
          ...
          <div style={{ fontSize: 13, color: '#78716c', marginBottom: 16 }}>
            {pct >= 0.8
              ...
              : pct >= 0.6
                ? 'Good progress! Keep listening to build fluency.'
                : 'Try again — listening improves faster than you think!'}
          </div>
        ...
        <div style={{ marginBottom: 8 }}>
          ...
          {aiExplain && aiExplain !== 'loading' && (
            ...
            >
              ...
              <div style={{ fontSize: 12, color: 'var(--heading)', lineHeight: 1.6 }}>
