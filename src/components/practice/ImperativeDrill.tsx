...
const DATA = [
  ...
  { q:"'Be quiet!' (informal, biti tih)", opts:["Budi tih!","Budite tih!","Budi tiho!","Budi tiha!"], answer:"Budi tiho!", en:"Be quiet! (neuter/command)", tip:"biti → budi (sg) / budite (pl). 'tiho' is the adverb form here" },
  { q:"'Go home!' (informal, ići)", opts:["Idi kući!","Idite kući!","Idem kući!","Idi doma!"], answer:"Idi kući!", en:"Go home! (to one person)", tip:"ići → irregular: idi (sg) / idite (pl)" },
  { q:"'Listen to me!' (plural, slušati)", opts:["Slušajte me!","Slušaj me!","Slušate me!","Slušajući me!"], answer:"Slušajte me!", en:"Listen to me! (to a group)", tip:"slušati → slušaj (sg) / slušajte (pl)" },
  { q:"'Take this!' (informal, uzeti)", opts:["Uzmi ovo!","Uzmite ovo!","Uzimaj ovo!","Uzeo ovo!"], answer:"Uzmi ovo!", en:"Take this! (to one person)", tip:"uzeti → irregular: uzmi (sg) / uzmite (pl)" },
  { q:"'Don't worry!' (informal, brinuti se)", opts:["Nemoj se brinuti!","Ne brini se!","Ne briniš se!","Nemoj brinuti!"], answer:"Nemoj se brinuti!", en:"Don't worry!", tip:"Negative: nemoj + infinitive (nemoj se brinuti) is preferred" },
  { q:"'Open the door!' (informal, otvoriti)", opts:["Otvori vrata!","Otvorite vrata!","Otvaranje vrata!","Otvaraj vrata!"], answer:"Otvori vrata!", en:"Open the door! (to one person)", tip:"otvoriti (pf) → stem 'otvori' + i → 'otvori'" },
  ...
  return (
    <div className="scr-wrap">
      ...
      <div className="c" style={{ marginTop: 16 }}>
        <div style={{ fontSize: 13, color: "#64748b", marginBottom: 6, fontWeight: 600, textTransform: "uppercase", letterSpacing: 1 }}>Choose the correct imperative</div>
        <div style={{ fontSize: 18, fontWeight: 700, color: "#0e7490", lineHeight: 1.5 }}>{cur.q}</div>
