...
export default function PracticeTab({
  ...
  const EXERCISES = [
    ...
    { id:'dialogue',     label:'Dialogue Sim',         icon:'💬', desc:'Real turn-based conversations',       category:'advanced', cefr:'B1',  duration:'~10 min', action: () => { setScr("dialogue"); sCurEx("dialogue"); } },
