...
import SprintModelPhase from './SprintModelPhase.jsx';
import SprintFeedbackPhase from './SprintFeedbackPhase.jsx';
  ...
  if (phase === 'speaking' && currentPrompt) {
    return (
      <SprintSpeakingPhase
        ...
        onDoneSpeaking={() => { stopMic(); handleUserDone(transcriptRef.current || textInput); }}
        onSkip={() => { stopMic(); setUserTranscript(''); setPhase('model'); loadTTS(currentPrompt.model_response); }}
      />
    );
  }
