...
const SentenceBuilderScreen = lazyWithReload(() => import("./practice/exercises/SentenceBuilderScreen"));
...
const RelativePronounsScreen = lazyWithReload(() => import("./practice/exercises/RelativePronounsScreen"));
const EmotionGenderScreen = lazyWithReload(() => import("./practice/exercises/EmotionGenderScreen"));
...
const AccusativeDrillScreen = lazyWithReload(() => import("./practice/exercises/AccusativeDrillScreen"));
const ColorAgreementScreen = lazyWithReload(() => import("./practice/exercises/ColorAgreementScreen"));
const PossessivesScreen = lazyWithReload(() => import("./practice/exercises/PossessivesScreen"));
const QuestionWordsScreen = lazyWithReload(() => import("./practice/exercises/QuestionWordsScreen"));
const NegationScreen = lazyWithReload(() => import("./practice/exercises/NegationScreen"));
const SibilarizationScreen = lazyWithReload(() => import("./practice/exercises/SibilarizationScreen"));
const RestaurantScreen = lazyWithReload(() => import("./practice/exercises/RestaurantScreen"));
const ProfessionGenderScreen = lazyWithReload(() => import("./practice/exercises/ProfessionGenderScreen"));
...
const ListeningComprehensionScreen = lazyWithReload(() => import("./practice/ListeningComprehensionScreen"));
const PronunciationAssessScreen = lazyWithReload(() => import("./practice/PronunciationAssessScreen"));
...
export default function AppRouter(props) {
  ...
  return (
    <AnimatePresence mode="wait">
      ...
      {currentScreen==="past_tense_lesson"&&<ScreenErrorBoundary key="past_tense_lesson" name="past_tense_lesson"><PastTenseLessonScreen goBack={goBack} award={award} /></ScreenErrorBoundary>}
