...
`;
  ...
  console.log(`[generate-content-etags] wrote ${Object.keys(stories).length} stories + ${Object.keys(grammarUnits).length} grammar units + grammar(${grammar.slice(0, 8)}...) + ${LESSONS.length} lessons(${lessons.slice(0, 8)}...)`);
}
