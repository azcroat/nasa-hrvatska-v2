 ...
 *   4. SpeedChallenge — Practice tab (serial, mutates localStorage)
 *
 * AIListeningScreen + VideoLessonScreen tests were removed in the AI-Tutor
 * consolidation — those surfaces now launch only from the AI Tutor tab.
 */
